...
int func_24(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_53(bParam2), bParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_53(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
void func_41(var uParam0)
{
	...
	iVar0 = PED::_GET_PED_REGISTER_PROP(Global_35, "bait01", 0);
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_53(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_53(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_78(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_53(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_79(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_53(bParam4), bParam0, iParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
struct<4> func_80(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_53(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
int func_118(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_53(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_53(bParam6), bParam0, iParam8);
	}
	return iVar0;
}
...
int func_123(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar0 = (iVar0 + func_152(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1));
	}
	if (bParam3)
	{
...
int func_150(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_53(bParam1), bParam0, iParam3);
}
