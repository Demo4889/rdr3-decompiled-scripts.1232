...
int func_40(int iParam0)
{
	...
	if (func_72(6) && !func_73(6))
	{
		...
		{
			iLocal_31 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-1612834106, 1448.551f, 374.271f, 90.332f, 0f, 0f, -0.353f, 11.5f, 12.211f, 2.918f);
			VOLUME::_0x5B23DFF8E0948BB2(iLocal_31, 1);
			VOLUME::_0xBE551C2CC421185D(iLocal_31, 1);
		}
	}
	else if (VOLUME::DOES_VOLUME_EXIST(iLocal_31))
	{
...
int func_101(int iParam0, bool bParam1)
{
	...
	{
		func_162(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_161(iParam0)));
		if (func_45() == -1)
		{
...
void func_106(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_181(iParam0, 2))
	{
