		...
		if (MISC::GET_GAME_TIMER() > iLocal_100)
		{
			...
			switch (iLocal_99)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_101));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_101)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_101 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_101 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_13()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_29, 1328.412f, -1292.11f, 77.3881f, 0f, 0f, -25.26236f, 6.60765f, 6.448709f, 2.912f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_29, 1324.871f, -1290.512f, 77.3881f, 0f, 0f, -24.32128f, 1.455032f, 6.472947f, 2.912f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_29, 1322.556f, -1291.914f, 77.3881f, 0f, 0f, -24.88738f, 1.644745f, 1.92852f, 2.912f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_29, 1323.714f, -1288.983f, 79.01204f, 0f, 0f, -25.93809f, 1.384575f, 4.53235f, 5.744565f);
	if (func_45() == -1)
	{
		iLocal_30 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Rhodes - m_volGeneralOwner_US Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_30, 1325.331f, -1288.039f, 80.02451f, 0f, 0f, -24.26809f, 3.071211f, 1.555256f, 3.603793f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_30, 1327.144f, -1291.541f, 80.54637f, 0f, 0f, -24.82035f, 9.622256f, 6.45655f, 2.668802f);
		...
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_30, iLocal_34);
		iLocal_81 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Rhodes - m_volWhiteSlumsDogOwner");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_81, 1305.094f, -1133.663f, 88.6923f, 0f, 0f, -36.09979f, 10.1341f, 7.94723f, 19.78896f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_81, 1314.041f, -1132.649f, 85.41996f, 0f, 0f, -20.04774f, 27.60419f, 10.62754f, 11.45993f);
	}
	else
	{
		iLocal_30 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Rhodes - m_volGeneralOwner_US");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_30, 1328.336f, -1290.497f, 77.16785f, 0f, 0f, -24.13627f, 1.689458f, 2.836409f, 2.356988f);
	...
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_31, iLocal_30);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_37, 1327.031f, -1325.331f, 78.1557f, 0f, 0f, -15.04306f, 4.545384f, 2.596381f, 2.523224f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_37, 1322.495f, -1325.072f, 78.156f, 0f, 0f, -15.42848f, 4.452f, 4.786f, 2.523224f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_37, 1327.033f, -1327.818f, 78.156f, 0f, 0f, -15.42848f, 5.936f, 1.823f, 2.523f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_37, 1319.863f, -1324.946f, 78.156f, 0f, 0f, -15.42848f, 0.878f, 3.682f, 2.523f);
	iLocal_38 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Rhodes - m_volGunsmith_PARENT Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_38, 1325.168f, -1323.554f, 75.611f, 0f, 0f, -14.722f, 8.334f, 8.863f, 8.591f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_38, 1328.794f, -1328.319f, 75.86505f, 0f, 0f, -15.43357f, 2.198632f, 1.86921f, 6.623033f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_38, 1320.511f, -1325.132f, 75.86505f, 0f, 0f, -15.43357f, 2.198632f, 3.677522f, 6.623033f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_25, 1228.472f, -1296.871f, 77.554f, 0f, 0f, 46f, 3.38f, 6.503f, 4.035f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_25, 1226.197f, -1297.297f, 77.554f, 0f, 0f, 46f, 1.222f, 3.986f, 3.92f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_25, 1231.745f, -1300.01f, 77.554f, 0f, 0f, 46f, 2.894f, 2.755f, 3.92f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_25, 1225.236f, -1293.672f, 77.554f, 0f, 0f, 46f, 2.894f, 2.686f, 3.92f);
	iLocal_26 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Rhodes - m_volPostOfficePrompt Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_26, 1225.436f, -1293.831f, 77.78244f, 0f, 0f, -44.04891f, 1.531311f, 2.322421f, 3.736468f);
	...
	iLocal_45 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-1612834106, 1297.474f, -1277.489f, 75.905f, 0f, 0f, 56.654f, 2.137f, 3.011f, 2.48f);
	VOLUME::_0xBE551C2CC421185D(iLocal_45, 1);
	VOLUME::_0x5B23DFF8E0948BB2(iLocal_45, 0);
	VOLUME::_0xB469CFD9E065EB99(iLocal_43, 10098);
	iLocal_82 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-1612834106, 1295.792f, -1278.091f, 75.254f, 0f, 0f, -121.549f, 2.024f, 1.461f, 2.48f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_74, 1365f, -1205f, 70f, 0f, 0f, 56f, 200f, 50f, 40f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_74, 1412.5f, -1290f, 70f, 0f, 0f, 98f, 300f, 100f, 40f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_74, 1330f, -1350f, 70f, 0f, 0f, 138f, 275f, 100f, 40f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_74, 1327.5f, -1225f, 70f, 0f, 0f, 94f, 225f, 160f, 40f);
	func_55(iLocal_74);
	func_56();
	func_57();
...
void func_100(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_74))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_74);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_74);
	}
	if (bLocal_84)
	{
		func_177(1);
...
int func_116(int iParam0, bool bParam1)
{
	...
	{
		func_190(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_189(iParam0)));
		if (func_45() == -1)
		{
			if (func_182(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_191(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_191(iParam0)))
	{
...
void func_124(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_210(iParam0, 2))
	{
...
void func_178(int iParam0, bool bParam1)
{
	...
	{
		VOLUME::SET_VOLUME_RELATIONSHIP(iParam0, 623901053);
	}
	if (bParam1->f_4)
	{
...
int func_183(int iParam0, bool bParam1)
{
	...
	func_241(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_191(iParam0));
	func_190(iParam0, 0);
	return 1;
}
...
int func_212(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1131373->f_7) && !func_257(12, func_256(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
