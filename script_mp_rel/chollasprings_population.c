...
void func_3()
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_11() && !func_12())
		{
			...
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -3960.03f, -2122.22f, -4.99f, 0f, 0f, 51f, 4.85f, 7.96f, 13.94f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -3955.38f, -2127.12f, -4.19f, 0f, 0f, 51f, 7.61f, 7.5f, 12.32f);
			...
			VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -3962.87f, -2135.84f, -5.32f, 0f, 0f, 0f, 27f, 27f, 20f);
			VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -3934.91f, -2138.85f, -5.32f, 0f, 0f, 0f, 10f, 10f, 20f);
			...
			VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3959.88f, -2132.15f, -5.32f, 0f, 0f, 0f, 50f, 50f, 20f);
			sLocal_27 = "TWIN_ROCKS";
			LAW::_CREATE_GUARD_ZONE(sLocal_27);
			LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_27, iLocal_20);
			LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_27, iLocal_21);
			LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_27, iLocal_21);
			LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_27, iLocal_22);
		}
	}
}
...
void func_5()
{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar3) && func_13(-154581735))
		{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar2) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_14(-154581735);
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar1) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_14(-154581735);
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar0) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_14(-154581735);
		...
		else if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar0) && !func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_15(-154581735);
