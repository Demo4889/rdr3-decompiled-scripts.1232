...
int func_13()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -1095.52f, -576.564f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -1094.093f, -574.7371f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
...
int func_93(int iParam0, bool bParam1)
{
	...
	{
		func_150(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_149(iParam0)));
		if (func_45() == -1)
		{
			if (func_143(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_116(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_116(iParam0)))
	{
...
void func_98(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_169(iParam0, 2))
	{
...
bool func_115(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_116(iParam0));
}
...
int func_144(int iParam0, bool bParam1)
{
	...
	func_204(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_116(iParam0));
	func_150(iParam0, 0);
	return 1;
}
...
int func_173(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1131373->f_7) && !func_219(12, func_218(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
