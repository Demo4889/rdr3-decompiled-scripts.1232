		...
		if (MISC::GET_GAME_TIMER() > iLocal_39)
		{
			...
			switch (iLocal_38)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_40));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_40)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_40 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_40 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_87(int iParam0)
{
	...
	while (iVar0 < iLocal_30)
	{
		...
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_VOLUME(&(iLocal_30[iVar0]));
...
int func_98(int iParam0, bool bParam1)
{
	...
	{
		func_159(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_158(iParam0)));
		if (func_45() == -1)
		{
			if (func_153(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_160(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_160(iParam0)))
	{
...
void func_106(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_180(iParam0, 2))
	{
...
int func_154(int iParam0, bool bParam1)
{
	...
	func_209(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_160(iParam0));
	func_159(iParam0, 0);
	return 1;
}
