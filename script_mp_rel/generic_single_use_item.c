...
int func_29(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	Var9.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_71(bParam2), &Var5, &Var9, 15, 1))
	{
		return 0;
	}
	Var24.f_9 = -1591664384;
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_71(bParam2), &Var5, &Var24, true))
	{
		return 0;
	}
...
int func_217(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_71(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_71(bParam6), bParam0, iParam8);
	}
	return iVar0;
}
...
int func_253(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_71(bParam1), bParam0, iParam3);
}
...
struct<17> func_286(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_71(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
