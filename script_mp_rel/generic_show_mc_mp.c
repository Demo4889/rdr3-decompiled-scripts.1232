...
int func_6(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_127) && VOLUME::_0x666C2F53ABEFC952(uParam0->f_127) != 5)
		{
			VOLUME::SET_VOLUME_RELATIONSHIP(uParam0->f_127, 623901053);
		}
		...
		if (func_25(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157), 1) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157)))
		{
...
void func_7(var uParam0)
{
	...
	{
		if ((VOLUME::DOES_VOLUME_EXIST(Global_1268116->f_23) && func_23(Global_35, Global_1268116->f_23, 1, 0)) && func_14(&(uParam0->f_144)) >= 15000)
		{
			func_30(1, 1);
		}
	}
	...
	switch (uParam0->f_8)
	{
		...
		case 2:
			if (func_49(uParam0))
			{
				...
				{
					iVar11 = iVar12;
					if (!VOLUME::DOES_VOLUME_EXIST(&(uParam0->f_121[iVar11])))
					{
						Var0 = { func_50(iVar11) };
				...
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157), 0))
				{
		...
		case 7:
			...
			break;
		case 8:
			if (func_52(uParam0) && !ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155)))
			{
...
void func_19(var uParam0, var uParam1, var uParam2)
{
	...
	switch (((*uParam1)[uParam2->f_1 /*3*/])->f_1)
	{
		...
		case 2:
			...
			break;
		case 6:
			VOLUME::SET_VOLUME_RELATIONSHIP(uParam0->f_127, func_62(func_61()));
			if (uParam0->f_8 > 6)
			{
		...
		case 8:
			...
			{
				if ((func_25(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 1) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155))) && ANIMSCENE::_0xD8254CB2C586412B(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 0))
				{
...
void func_28(var uParam0)
{
	...
	{
		iVar1 = iVar0;
		if (VOLUME::DOES_VOLUME_EXIST(&(uParam0->f_121[iVar1])))
		{
			VOLUME::DELETE_VOLUME(&(uParam0->f_121[iVar1]));
		}
		iVar0++;
	}
}
...
void func_43(var uParam0)
{
	switch (uParam0->f_11)
	{
		case 0:
			...
			break;
		case 1:
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[2]))))
			{
			...
			break;
		case 2:
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[3]))))
			{
...
int func_52(var uParam0)
{
	...
	switch (uParam0->f_10)
	{
		...
		case 1:
			...
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 0))
			{
			...
			return 0;
		case 2:
			if (ANIMSCENE::GET_ANIM_SCENE_PHASE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155)) > 0.5f)
			{
		...
		case 3:
			...
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 0) && uParam0->f_22 == 1)
			{
				uParam0->f_22 = 0;
		...
		case 8:
			...
			return 0;
		case 9:
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[3]))) && ANIMSCENE::IS_ANIM_SCENE_LOADED(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[3])), 1, 0))
			{
				if (uParam0->f_22 == 0)
				{
					uParam0->f_4++;
				...
				else if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 0))
				{
					uParam0->f_22 = 0;
		...
		case 10:
			...
			if (ANIMSCENE::GET_ANIM_SCENE_PHASE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155)) > 0.98f)
			{
				if (uParam0->f_4 >= uParam0->f_129)
				{
		...
		case 11:
			...
			if (uParam0->f_22 && ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 0))
			{
				uParam0->f_22 = 0;
...
void func_54(var uParam0)
{
	...
	switch (uParam0->f_6)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(iVar0, func_98(1)))
			{
		...
		case 4:
			...
			break;
		case 5:
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(iVar0, func_98(2)))
			{
...
void func_57(var uParam0, var uParam1)
{
	...
	if (bVar0)
	{
		if (bVar1)
		{
			...
			{
				if (CAM::_0xDD0B7C5AE58F721D(&(uParam1->f_258)) && !CAM::_IS_CAMERA_AVAILABLE(&(uParam1->f_258)))
				{
		...
		if (bVar2)
		{
			if (!func_84(uParam1->f_251, 8388608) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_159))
			{
				if (CAM::_0xDD0B7C5AE58F721D(&(uParam1->f_274)) && !CAM::_IS_CAMERA_AVAILABLE(&(uParam1->f_274)))
				{
...
int func_64(var uParam0, var uParam1, var uParam2)
{
	switch (((*uParam1)[uParam2->f_1 /*3*/])->f_2)
	{
		...
		case 3:
			...
			func_114(&(uParam0->f_159));
			if ((uParam0->f_22 && uParam0->f_10 == 3) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), 0))
			{
				func_168(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_155), uParam0->f_159, uParam0->f_158);
			}
			if (uParam0->f_10 >= 4)
		...
		case 4:
			...
			if (uParam0->f_10 >= 6)
			{
				if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[0]))) && ANIMSCENE::IS_ANIM_SCENE_LOADED(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[0])), 1, 0)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[0]))))
				{
		...
		case 7:
			...
			return 0;
		case 8:
			if ((func_25(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[2])), 1) && ANIMSCENE::IS_ANIM_SCENE_LOADED(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[2])), 1, 0)) && ANIMSCENE::_0xD8254CB2C586412B(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[2])), 0))
			{
				ANIMSCENE::_DELETE_ANIM_SCENE(NETWORK::_0xD7F6781A0ABAF6FB(&(uParam0->f_150[2])));
			}
			if (uParam0->f_10 >= 9)
...
int func_91(var uParam0, var uParam1, char* sParam2, char* sParam3, bool bParam4)
{
	...
	iVar0 = 0;
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(*uParam0)) && ANIMSCENE::IS_ANIM_SCENE_LOADED(NETWORK::_0xD7F6781A0ABAF6FB(*uParam0), 1, 0))
	{
		func_20(uParam1, 1);
		return 1;
	}
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT() && ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(*uParam0)))
	{
		NETWORK::_NETWORK_REQUEST_CONTROL_OF_ANIM_SCENE(NETWORK::_0xD7F6781A0ABAF6FB(*uParam0));
	}
	if ((!func_84(*uParam1, 1) && !ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(*uParam0))) && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (bParam4)
		{
	...
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADING(NETWORK::_0xD7F6781A0ABAF6FB(*uParam0), 1))
	{
...
int func_99(int iParam0, char* sParam1, char[4] cParam2)
{
	...
	if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iVar0, sParam1) || (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iVar0, sParam1) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(iVar0)))
	{
		ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iVar0, sParam1);
	}
	if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iVar0, sParam1))
	{
	}
	if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iVar0, sParam1))
	{
		return 0;
	}
	return 1;
...
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157)))
	{
		if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157), func_98(2)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157)) > 0.413f)
		{
			return 1;
		}
		if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_157), func_98(0)))
		{
			return 1;
		}
	}
...
void func_119(int iParam0, char* sParam1, char[4] cParam2)
{
	...
	iVar0 = NETWORK::_0xD7F6781A0ABAF6FB(iParam0);
	if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iVar0, sParam1) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(iVar0))
	{
		ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iVar0, sParam1);
	}
}
