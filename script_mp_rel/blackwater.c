		...
		if (MISC::GET_GAME_TIMER() > iLocal_113)
		{
			...
			switch (iLocal_112)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_114));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_114)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_114 /*36*/])->f_12);
							}
							Jump @832; //curOff = 809
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_114 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_107(int iParam0)
{
	...
	func_213();
	func_214();
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_99))
	{
		PATHFIND::REMOVE_NAVMESH_BLOCKING_VOLUME(iLocal_99);
		VOLUME::DELETE_VOLUME(iLocal_99);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_90))
	{
...
int func_132(int iParam0, bool bParam1)
{
	...
	{
		func_232(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_231(iParam0)));
		if (func_45() == -1)
		{
			if (func_216(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_165(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_165(iParam0)))
	{
...
void func_138(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_250(iParam0, 2))
	{
...
bool func_164(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_165(iParam0));
}
...
int func_217(int iParam0, bool bParam1)
{
	...
	func_289(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_165(iParam0));
	func_232(iParam0, 0);
	return 1;
}
