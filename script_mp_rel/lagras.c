...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_155(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_154(iParam0)));
		if (func_45() == -1)
		{
			if (func_148(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_124(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_124(iParam0)))
	{
...
bool func_123(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_124(iParam0));
}
...
int func_149(int iParam0, bool bParam1)
{
	...
	func_206(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_124(iParam0));
	func_155(iParam0, 0);
	return 1;
}
...
int func_189(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1131373->f_7) && !func_225(12, func_224(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
