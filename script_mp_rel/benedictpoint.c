...
int func_96(int iParam0, bool bParam1)
{
	...
	{
		func_165(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_164(iParam0)));
		if (func_45() == -1)
		{
			if (func_158(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_132(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_132(iParam0)))
	{
...
void func_101(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_184(iParam0, 2))
	{
...
bool func_131(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_132(iParam0));
}
...
int func_159(int iParam0, bool bParam1)
{
	...
	func_221(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_132(iParam0));
	func_165(iParam0, 0);
	return 1;
}
