...
void func_11(var uParam0)
{
	...
	{
		if (HUD::TEXT_BLOCK_IS_LOADED(func_51(func_50(uParam0, iVar0))))
		{
			HUD::_TEXT_BLOCK_DELETE(func_51(func_50(uParam0, iVar0)));
		}
		iVar0++;
	}
}
...
void func_14(var uParam0)
{
	...
	PED::_UNRESERVE_AMBIENT_PEDS(func_52(uParam0));
}
	...
	while (iVar0 <= (func_54(uParam0) - 1))
	{
		...
		switch (func_55(uParam0, iVar2))
		{
			...
			case joaat("pin"):
				...
				{
					ENTITY::_UNPIN_MAP_ENTITY(func_65(uParam0, iVar2));
...
void func_27(var uParam0)
{
	...
	while (iVar0 <= (func_49(uParam0) - 1))
	{
		HUD::TEXT_BLOCK_REQUEST(func_51(func_50(uParam0, iVar0)));
		iVar0++;
	}
}
...
void func_39(var uParam0, var uParam1)
{
	...
	switch (func_137(uParam0, iVar0))
	{
		...
		case 4:
			...
			else if (!TASK::DOES_SCENARIO_POINT_EXIST(func_143(uParam0, iVar0)))
			{
				func_138(uParam0, uParam1, iVar0, 3);
			}
		else
...
int func_78(int iParam0)
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(func_194()))
	{
		return 0;
	}
...
{
	PED::_RESERVE_AMBIENT_PEDS(func_52(uParam0));
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	iVar12 = ENTITY::PIN_CLOSEST_MAP_ENTITY(func_56(uParam0, iParam2), Var0.f_6, 15);
...
int func_142(var uParam0, var uParam1, int iParam2)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(func_143(uParam0, iParam2)))
	{
		return 1;
	}
...
void func_268(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	iVar0 = func_57(uParam0, iParam2);
	if (TASK::IS_PED_SCENARIO_REACT_LOOKING(iVar0, 1) && !bParam6)
	{
		return;
	}
...
bool func_269(var uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_57(uParam0, iParam1);
	return TASK::IS_PED_SCENARIO_REACT_LOOKING(iVar0, iParam2);
}
...
void func_272(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	iVar0 = func_57(uParam0, iParam2);
	if (!TASK::IS_PED_SCENARIO_REACT_LOOKING(iVar0, 0))
	{
		return;
	}
...
{
	*uParam0 = func_363(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
}
