...
void __EntryFunction__()
{
	...
	while (!ENTITY::IS_ENTITY_DEAD(Global_35) && func_5(&Local_13))
	{
		...
		if (!WEAPON::_IS_WEAPON_BINOCULARS(func_8(Global_35, 1, 0, 1)))
		{
		...
		if (func_6() > 0 && !WEAPON::_IS_WEAPON_BINOCULARS(func_8(Global_35, 1, 0, 1)))
		{
			func_11(&Local_13, 8);
		}
		...
		switch (func_6())
		{
			...
			case 2:
				...
				if (WEAPON::_IS_WEAPON_BINOCULARS(func_8(Global_35, 1, 0, 0)))
				{
					func_17(1);
					func_18(506, 0);
					func_19(&Local_13);
			...
			case 7:
				...
				func_11(&Local_13, 8);
				if (WEAPON::_IS_WEAPON_BINOCULARS(func_28(Global_35, 0)))
				{
...
int func_5(int* iParam0)
{
	...
	if ((!func_32(joaat("weapon_kit_binoculars"), 1) && !func_32(1652431022 /* GXTEntry: "Refined Binoculars" */, 1)) && !WEAPON::_IS_WEAPON_BINOCULARS(func_8(Global_35, 1, 0, 1)))
	{
		return 0;
	}
	if (func_33())
...
bool func_34(int iParam0)
{
	...
	return PED::IS_PED_INCAPACITATED(PLAYER::GET_PLAYER_PED(&(Global_1273882->f_154[iParam0])));
}
...
int func_54(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_80(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_80(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_80(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_91(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_80(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_104(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_80(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_80(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_108(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_80(bParam1), iParam0, iParam3);
}
