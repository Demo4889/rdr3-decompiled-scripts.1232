	...
	while (!func_2(0, 0) && !bVar236)
	{
		switch (Var0.f_192)
		{
			...
			case 2:
				...
				{
					Var0.f_229 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, Var0.f_230, 0f, 0f, 0f, 0.3f, 0.3f, 2f);
				}
				func_7(&(Var0.f_192), 3);
				break;
			case 3:
...
int func_12(var uParam0, bool bParam1)
{
	...
	switch (uParam0->f_142)
	{
		...
		case 5:
			...
			HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(2011163970);
		...
		case 7:
			...
			if ((((func_77(uParam0, uParam0->f_144) || !TASK::PED_HAS_USE_SCENARIO_TASK(Global_35)) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1)) || FIRE::IS_ENTITY_ON_FIRE(Global_35)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 0))
			{
				AUDIO::_0x0F2A2175734926D8("cook_meat_sizzle_loop", "Player_Campfire_Sounds");
				func_76(-1199896558 /* GXTEntry: "Coffee" */, 1, 1, -142743235);
				func_43(&(uParam0->f_49), 1, 1);
				ATTRIBUTE::_0xD962F8579D702DB5();
				if (((!TASK::PED_HAS_USE_SCENARIO_TASK(Global_35) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1)) || FIRE::IS_ENTITY_ON_FIRE(Global_35)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 0))
				{
		...
		case 9:
			...
			else if (!TASK::IS_PED_EXITING_SCENARIO(Global_35, 1))
			{
				func_81(uParam0);
			}
			break;
...
int func_35(var uParam0)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(iVar0) && !TASK::IS_PED_EXITING_SCENARIO(Global_35, 1))
	{
		iVar1 = 0;
		while (iVar1 < 4)
		{
...
void func_43(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (HUD::_DOES_TEXT_BLOCK_EXIST(&(uParam0->f_18)))
	{
		HUD::_TEXT_BLOCK_DELETE(&(uParam0->f_18));
	}
	if (uParam0->f_23)
	{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_59))
	{
		ANIMSCENE::_DELETE_ANIM_SCENE(uParam0->f_59);
	}
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_61))
	{
		ANIMSCENE::_DELETE_ANIM_SCENE(uParam0->f_61);
	}
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_62))
	{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_64))
	{
...
int func_58(bool bParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		...
		{
			if (((TASK::_PED_IS_IN_SCENARIO_BASE(Global_35) || (bParam0 && TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0))) || (TASK::IS_TASK_MOVE_NETWORK_ACTIVE(Global_35) && TASK::GET_TASK_MOVE_NETWORK_EVENT(Global_35, "SCENARIO_POINT_TRANS_COMPLETE"))) || (func_54(16777216) && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336)))
			{
				return 1;
			}
		}
...
{
	if ((((!TASK::PED_HAS_USE_SCENARIO_TASK(Global_35) && uParam0->f_163) && !PED::IS_PED_CARRYING_SOMETHING(Global_35)) && !func_54(4)) && !WEAPON::_0x0DE0944ECCB3DF5D(Global_35))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_141))
		{
		...
		switch (iVar0)
		{
			...
			case 3:
				...
				if (((func_54(16777216) || uParam0->f_189) || func_132(684307653, &iVar1)) || func_132(562107429, &iVar1))
				{
					...
					if (bVar2)
					{
						PED::_GIVE_PED_HASH_COMMAND(Global_35, -1955932021, 3f);
					}
...
int func_74(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		if (((func_157() || TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 1)) || !PED::IS_PED_ON_FOOT(Global_35))
		{
			return 0;
		}
		switch (bParam0)
			...
			case -727924611: /* GXTEntry: "Wardrobe" */
				...
				else
				{
					...
					if (bVar31 && !bVar30)
					{
						...
						MAP::BLIP_ADD_MODIFIER(Global_17095, 673950256);
					...
					else
					{
						...
						if (!func_15(Global_1956162->f_1, 1) || func_15(Global_1956162->f_1, 512))
						{
							if (func_160(-1838434463 /* GXTEntry: "Camp" */))
							{
								...
								else
								{
									...
									func_181(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
								}
							}
						...
						if (!WEAPON::_IS_WEAPON_BINOCULARS(func_36(Global_35, 1, 0, 0)))
						{
...
int func_94(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_73(bParam2), bParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_73(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
int func_133(int iParam0)
{
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(Global_35, &bVar0, true, iParam0, false))
	{
		if (func_90(bVar0, 0))
		{
			if (WEAPON::_IS_WEAPON_TWO_HANDED(bVar0) || func_250(bVar0))
			{
				return 1;
			}
		}
...
int func_190(var uParam0)
{
	...
	if (func_54(268435456) && uParam0->f_138 < 9)
	{
		...
		if ((MISC::GET_GAME_TIMER() - uParam0->f_165) > 1000 && func_380(&(uParam0->f_49)))
		{
			...
			if (PED::_GIVE_PED_SCENARIO_PROP(Global_35, uParam0->f_147, "p_meatChunks01x_PH_L_HAND", 0, 0, 1))
			{
			}
	...
	switch (uParam0->f_138)
	{
		...
		case 11:
			...
			{
				if ((((func_136(&(uParam0->f_149[4]), 0) && (func_259(&(uParam0->f_149[4]), 1) || PAD::IS_CONTROL_PRESSED(0, joaat("INPUT_GAME_MENU_OPTION")))) || uParam0->f_180) || func_112(Global_35, 0)) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1))
				{
					func_47(16);
					uParam0->f_180 = 0;
					ATTRIBUTE::_0xD962F8579D702DB5();
...
int func_197(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		STATS::STAT_ID_INCREMENT_INT(&Var30, iVar0);
	}
	func_443(bParam0);
	if (fParam6 > 0f)
	{
...
int func_264(var uParam0)
{
	...
	uParam0->f_144 = func_59();
	iVar0 = func_35(uParam0);
	if ((((uParam0->f_145 == -1 || iVar0 == uParam0->f_145) && (uParam0->f_146 == 0 || func_488(uParam0->f_144, uParam0->f_146))) || (uParam0->f_145 == -1 && func_488(uParam0->f_144, uParam0->f_146))) && !(PED::_IS_PED_DOING_SCENARIO_TRANSITION(Global_35) || PED::_0x2DC0E8DCBD3546E9(Global_35)))
	{
		uParam0->f_143 = iVar0;
		return 1;
	}
...
int func_271(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_73(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_325(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_73(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_73(bParam6), bParam0, iParam8);
	}
	return iVar0;
}
...
void func_331()
{
	PAD::_SET_CONTROL_CONTEXT(4, 666989068);
}
...
void func_379(var uParam0)
{
	if (HUD::_DOES_TEXT_BLOCK_EXIST(&(uParam0->f_18)))
	{
		HUD::TEXT_BLOCK_REQUEST(&(uParam0->f_18));
	}
...
int func_380(var uParam0)
{
	...
	{
		if (!HUD::TEXT_BLOCK_IS_LOADED(&(uParam0->f_18)))
		{
			return 0;
		}
	}
...
void func_392(var uParam0, int iParam1)
{
	...
	if (uParam0->f_54)
	{
		HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(-469828803);
	}
	...
	switch (func_389(uParam0))
	{
		...
		case 12:
			...
			{
				if (!PED::_GET_IS_PED_COMMAND_HASH_PRESENT(Global_35, 1335077954))
				{
					PED::_GIVE_PED_HASH_COMMAND(Global_35, 1335077954, 6f);
					PED::_ADD_SCENARIO_TRANSITION(Global_35);
				}
				return;
			}
			if (iVar8 != -715814988)
			{
				if ((PED::_IS_PED_DOING_SCENARIO_TRANSITION(Global_35) || PED::_0x2DC0E8DCBD3546E9(Global_35)) && !ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 1944546609))
				{
					return;
				}
				if (iVar7 == -518407211 || iVar7 == 1662215698)
				{
					if (!PED::_GET_IS_PED_COMMAND_HASH_PRESENT(Global_35, 653141085))
					{
						PED::_GIVE_PED_HASH_COMMAND(Global_35, 653141085, 6f);
						PED::_ADD_SCENARIO_TRANSITION(Global_35);
					}
					return;
				}
				...
				if (((((((((iVar8 == 414472632 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_59, 1, 0)) || (iVar8 == -1136843638 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_62, 1, 0))) || (uParam0->f_85 != 0 && !STREAMING::HAS_MODEL_LOADED(uParam0->f_85))) || (iVar8 == -732326901 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_64, 1, 0))) || (iVar8 == 786205940 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_63, 1, 0))) || (iVar8 == -1141771998 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_65, 1, 0))) || (iVar8 == 364689687 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_66, 1, 0))) || (iVar8 == -842117252 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_67, 1, 0))) || (iVar8 == -1610298873 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_68, 1, 0)))
				{
					return;
				}
			...
			{
				if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_61, 1, 0) || (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0)))
				{
					return;
				}
				else if (uParam0->f_60)
				...
				if (iVar7 != -518407211 && iVar7 != 1662215698)
				{
					if (uParam0->f_28)
					{
						...
						if (!PED::_GET_IS_PED_COMMAND_HASH_PRESENT(Global_35, 796456488))
						{
							PED::_GIVE_PED_HASH_COMMAND(Global_35, 796456488, 2f);
							PED::_ADD_SCENARIO_TRANSITION(Global_35);
						}
						return;
					}
		...
		case 13:
			...
			else if (func_124(uParam0[4], 1))
			{
				...
				func_98(&(uParam0->f_79), &(uParam0->f_80));
				func_98(&(uParam0->f_83), &(uParam0->f_84));
				iVar10 = PED::_GET_ACTIVE_DYNAMIC_SCENARIO(Global_35);
		...
		case 14:
			...
			if ((iVar13 == 0 || (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iVar13) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(iVar13, 0))) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336))
			{
				func_98(&(uParam0->f_81), &(uParam0->f_82));
				func_98(&(uParam0->f_79), &(uParam0->f_80));
				func_98(&(uParam0->f_83), &(uParam0->f_84));
				iVar14 = PED::_GET_ACTIVE_DYNAMIC_SCENARIO(Global_35);
		...
		case 17:
			if (!func_390(uParam0->f_22))
			{
				...
				else
				{
					...
					PED::_GIVE_PED_HASH_COMMAND(Global_35, -752808711, 1f);
					func_634(uParam0);
...
void func_401()
{
	HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(func_636(2));
	HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(func_636(0));
	HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(func_636(1));
	HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(func_637(2));
	HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(func_637(0));
	HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(func_637(1));
}
...
int func_424(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (func_78(0))
	{
		...
		func_425(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
int func_464(int iParam0, var uParam1)
{
	...
	iVar0 = NETSHOPPING::_CASHINVENTORY_TRANSACTION_VALIDATE_ITEM(iParam0, uParam1);
...
int func_520()
{
	...
	if (iVar1 == joaat("weapon_unarmed"))
	{
		...
		else if ((((WEAPON::IS_WEAPON_VALID(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0)) && !func_250(bVar0)) && !PED::_IS_PED_GETTING_INTO_A_MOUNT_SEAT(Global_35, true)) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_35, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((WEAPON::IS_WEAPON_VALID(bVar0) && func_250(bVar0)) || WEAPON::_IS_WEAPON_LASSO(bVar0))
		{
			return 1;
		}
		else
...
int func_578(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		iVar0 = (iVar0 + func_749(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1));
	}
	if (bParam3)
	{
...
int func_582(var uParam0, var uParam1)
{
	...
	{
		if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(*uParam1, 1, 0))
		{
...
int func_604(var uParam0)
{
	...
	if (uParam0->f_25)
	{
		Global_1913156->f_1576 = 0;
		uParam0->f_51 = 0;
		iVar0 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
...
void func_617(char* sParam0, char* sParam1, int iParam2)
{
	...
	if (iVar0 != -1)
	{
		AUDIO::_PLAY_SOUND_FRONTEND_WITH_SOUND_ID(iVar0, sParam0, sParam1, iParam2);
...
void func_632(bool bParam0)
{
	...
	func_809(iVar14, Var0, func_808(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))));
}
...
void func_633(var uParam0)
{
	...
	if (iVar0 == PLAYER::PLAYER_ID())
	{
		...
		func_813(func_812(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())), uParam0);
	}
	else
	{
		func_632(0);
...
int func_649(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_73(bParam1), bParam0, iParam3);
}

int func_650()
{
	if (((((!ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_35)) && !func_819(Global_35, 1369124074)) && !func_819(Global_35, 713668775)) && !TASK::IS_PED_RUNNING_TASK_ITEM_INTERACTION(Global_35)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		return 1;
	}
	return 0;
...
int func_674(bool bParam0, int iParam1)
{
	...
	iVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_73(0), &Var5, 0);
	return iVar9;
}
...
int func_687(int iParam0, var uParam1, int iParam2, var uParam3, bool bParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (bParam7)
	{
		bVar0 = (_NAMESPACE26::_0xD6F6ACF4392187FB(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) && _NAMESPACE26::_0x0F99F6436528A089(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())));
		bParam7 = bVar0;
	}
...
int func_694(int iParam0, bool bParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return func_749(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1);
	}
	return 0;
}
		...
		*iParam2 = func_696(*iParam0, bParam1, *iParam2, 1, iParam5);
		if (*iParam2 > 0)
		{
			if (func_845(bParam1))
			{
				...
				{
					ENTITY::_SET_ENTITY_CARRYING_FLAG(*iParam0, 31, true);
				}
				else
				{
					ENTITY::_SET_ENTITY_CARRYING_FLAG(*iParam0, 31, false);
				}
...
int func_749(int iParam0, bool bParam1)
{
	...
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(iParam0, &Var0, 0);
	return iVar4;
}
...
void func_789(var uParam0, bool bParam1)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_10))
	{
...
int func_812(int iParam0)
{
	...
	if (iParam0 == _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))
	{
...
void func_814(var uParam0)
{
	...
	Var0.f_12 = uParam0;
	func_809(16, Var0, func_808(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))));
}
...
{
	return func_940(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1, iParam2, bParam3, iParam4);
}
...
struct<28> func_877(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	Var28.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_73(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<25> func_879(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_73(bParam4), &uParam0, &Var25, 24, 1))
	{
		return Var0;
	}
...
struct<17> func_881(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_73(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
