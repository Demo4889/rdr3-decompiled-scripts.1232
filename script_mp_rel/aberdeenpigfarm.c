		...
		if (MISC::GET_GAME_TIMER() > iLocal_23)
		{
			...
			switch (iLocal_22)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_24));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_24)))
					{
						...
						else
						{
							...
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_24 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_24 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_34()
{
	...
	{
		VEHICLE::_SET_HORSE_TRAFFIC_GROUPING_DISTRIBUTION(Global_1893575->f_182, Global_1893575->f_183, Global_1893575->f_184, Global_1893575->f_185);
	}
}
...
int func_49(bool bParam0, bool bParam1)
{
	...
	if (SCRIPTS::NETWORK_SESSION_IS_TRANSITIONING())
	{
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_119(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_118(iParam0)));
		if (func_45() == -1)
		{
			if (func_111(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_120(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_120(iParam0)))
	{
...
int func_112(int iParam0, bool bParam1)
{
	...
	func_144(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_120(iParam0));
	func_119(iParam0, 0);
	return 1;
}
...
void func_117(int iParam0)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_155(iParam0, 2))
	{
