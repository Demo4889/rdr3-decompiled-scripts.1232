...
void func_81(int iParam0)
{
	if (!func_111(iParam0, 1))
	{
		if (VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2((Global_1182978->f_1[iParam0 /*26*/])->f_9.f_1))
		{
			VOLUME::RELEASE_LOCK_VOLUME((Global_1182978->f_1[iParam0 /*26*/])->f_9.f_1);
		}
...
void func_88(int iParam0)
{
	...
	{
		Var14.f_6 = _NAMESPACE26::NETWORK_GET_GANG_ID(Var14.f_5);
	}
	iVar24 = 1024;
...
int func_135(int iParam0, int iParam1)
{
	switch (iParam1)
	{
		...
		case 13:
		case 14:
			return Global_1273882->f_15 == _NAMESPACE26::NETWORK_GET_GANG_ID(iParam0);
		default:
			break;
	}
	return 1;
