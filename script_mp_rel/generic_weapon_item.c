...
void func_3()
{
	...
	HUD::_DISABLE_HUD_CONTEXT(-1847602092);
...
int func_32(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_47(bParam2), bParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_47(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
int func_81(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_47(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_88(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_47(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_47(bParam6), bParam0, iParam8);
	}
	return iVar0;
}
...
int func_113(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		iVar0 = (iVar0 + func_122(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1));
	}
	if (bParam3)
	{
...
int func_115(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_47(bParam1), bParam0, iParam3);
}
