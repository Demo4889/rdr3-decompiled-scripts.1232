...
void func_41()
{
	...
	Local_16.f_6 = func_73(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(iVar0)));
	func_90(256);
...
void func_61()
{
	...
	TASK::DELETE_SCENARIO_POINT(Local_204.f_18.f_24);
	iVar5 = 0;
	while (iVar5 < 8)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST((Local_204.f_18.f_130[iVar5 /*3*/])->f_2))
		{
			TASK::DELETE_SCENARIO_POINT((Local_204.f_18.f_130[iVar5 /*3*/])->f_2);
		}
		iVar5++;
	}
	func_142();
...
int func_172(int iParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	if (!PED::IS_PED_READY_TO_RENDER((Local_204.f_18.f_11[iParam0 /*2*/])->f_1))
	{
		return 0;
	}
	return 1;
...
void func_197(struct<2> Param0)
{
	...
	else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_236(Param0)))
	{
...
void func_220()
{
	...
	{
		if (((!func_294(16384) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(&(Local_16.f_7.f_8[0]))) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar0)) && PED::IS_PED_READY_TO_RENDER(iVar0))
		{
			if (Local_204.f_4 == 0)
			{
...
void func_221()
{
	...
	if (!TASK::IS_PED_SCENARIO_REACT_LOOKING(iVar0, 1))
	{
...
void func_224()
{
	...
	if (LAW::IS_LAW_INCIDENT_ACTIVE(iVar1))
	{
...
void func_287(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	...
	if (!MAP::DOES_BLIP_EXIST(&(Local_204.f_18.f_11[iParam0 /*2*/])))
	{
		Local_204.f_18.f_11[iParam0 /*2*/] = MAP::BLIP_ADD_FOR_ENTITY(iParam1, func_189(iParam0));
	...
	if (iParam2 != 0)
	{
		MAP::BLIP_ADD_MODIFIER(&(Local_204.f_18.f_11[iParam0 /*2*/]), iParam2);
	}
}
...
void func_322(int iParam0)
{
	...
	if (!MAP::DOES_BLIP_EXIST((Local_204.f_18.f_130[iParam0 /*3*/])->f_1))
	{
		(Local_204.f_18.f_130[iParam0 /*3*/])->f_1 = MAP::BLIP_ADD_FOR_COORDS(408396114, func_420(iParam0));
...
void func_324(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		if (!TASK::DOES_SCENARIO_POINT_EXIST((Local_204.f_18.f_130[iParam0 /*3*/])->f_2) && !&Local_204.f_18.f_130[iParam0 /*3*/])
		{
	...
	else if (TASK::DOES_SCENARIO_POINT_EXIST((Local_204.f_18.f_130[iParam0 /*3*/])->f_2))
	{
		TASK::DELETE_SCENARIO_POINT((Local_204.f_18.f_130[iParam0 /*3*/])->f_2);
	}
}
...
int func_401(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_497(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_497(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
void func_404(struct<2> Param0)
{
	...
	{
		STATS::STATSTRACKER_DEED_STARTED(func_236(Param0), Global_265331->f_124445.f_70.f_17);
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_497(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_497(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_540(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_497(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_558(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_497(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_497(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
int func_569(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_497(bParam1), bParam0, bParam3);
}
