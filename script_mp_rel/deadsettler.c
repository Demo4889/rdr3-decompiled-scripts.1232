...
int func_40(int iParam0)
{
	...
	{
		case 0:
			if ((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_unicorpse_01")) && PED::_0x5E420FF293EE5472()) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_20)) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_20, 1, 0)) && !func_62())
			{
				iLocal_21 = 1;
			}
			break;
...
void func_69()
{
	...
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_20))
	{
		return;
	}
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_20, 1, 0))
	{
		return;
	}
	iVar0 = 0;
...
void func_104(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		PED::SET_PED_LASSO_HOGTIE_FLAG(*uParam0, 1, 0);
...
void func_138(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_183(iParam0, 2))
	{
