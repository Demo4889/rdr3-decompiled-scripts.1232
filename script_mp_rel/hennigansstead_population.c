...
void func_4()
{
	...
	if (((((!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar0) || !_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar1)) || !_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar2)) || !_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar3)) || !_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar4)) || !_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar5))
	{
		return;
	}
	if (((((_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar0) && _NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar1)) && _NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar2)) && _NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar3)) && _NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar4)) && _NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar5))
	{
