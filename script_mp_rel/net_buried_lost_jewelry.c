...
void __EntryFunction__()
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(Local_18.f_9))
	{
		func_5(&Local_18);
	}
...
void func_5(var uParam0)
{
	...
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(uParam0->f_39))
	{
...
int func_8(var uParam0)
{
	...
	switch (func_36(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_11, 1, 0))
			{
		...
		case 6:
			...
			break;
		case 7:
			if (((func_64(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) == joaat("weapon_unarmed") && func_64(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 1, 1, 0) == joaat("weapon_unarmed")) && !PED::IS_PED_ON_MOUNT(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()))) && !PED::IS_PED_CARRYING_SOMETHING(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID())))
			{
				func_25(uParam0);
		...
		case 8:
			...
			break;
		case 9:
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_11, 0))
			{
				func_41(uParam0, 10);
			}
			break;
		case 10:
			if ((ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_11, 0) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_11, 0)) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_35, "mech_pickup@mp_treasure@chest_01", "exit", 1))
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
				{
		...
		case 14:
			...
			if (TASK::DOES_SCENARIO_POINT_EXIST(TASK::_0xD04241BBF6D03A5E(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()))))
			{
...
void func_33(var uParam0)
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_8))
	{
		VOLUME::DELETE_VOLUME(uParam0->f_8);
	}
}
...
void func_47(int iParam0)
{
	if (func_42(iParam0))
	{
		...
		else if (!PED::IS_PED_CARRYING_SOMETHING(Global_1273882->f_8))
		{
...
int func_103(int iParam0)
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(func_139()))
	{
		return 0;
	}
	Var0 = func_139();
...
int func_133(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_160(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_160(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_160(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_166(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_160(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_176(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_160(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_160(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_160(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_200(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_160(bParam1), bParam0, bParam3);
}
