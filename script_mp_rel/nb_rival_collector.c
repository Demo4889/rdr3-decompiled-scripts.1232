...
void func_41()
{
	...
	Local_13.f_6 = func_73(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(iVar0)));
	func_90(256);
...
void func_123()
{
	...
	ENTITY::_SET_ENTITY_CARRYING_FLAG(func_177(1), 9, false);
}
...
void func_183(struct<2> Param0)
{
	...
	else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_201(Param0)))
	{
...
void func_283(struct<2> Param0)
{
	...
	{
		STATS::STATSTRACKER_DEED_STARTED(func_201(Param0), Global_265331->f_124445.f_70.f_17);
