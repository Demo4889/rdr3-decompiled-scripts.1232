...
int func_13()
{
	...
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_23, -131.6045f, -34.30135f, 102.2093f, 0f, 0f, -24.47213f, 46.71921f, 37.52021f, 13.16044f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_23, -117.99f, -66.781f, 100f, 0f, 0f, 94f, 16.719f, 19.52f, 13.16044f);
...
int func_89(int iParam0, bool bParam1)
{
	...
	{
		func_136(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_135(iParam0)));
		if (func_45() == -1)
		{
			if (func_129(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_137(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_137(iParam0)))
	{
...
void func_94(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_157(iParam0, 2))
	{
...
int func_130(int iParam0, bool bParam1)
{
	...
	func_184(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_137(iParam0));
	func_136(iParam0, 0);
	return 1;
}
...
int func_161(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1131373->f_7) && !func_200(12, func_199(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
