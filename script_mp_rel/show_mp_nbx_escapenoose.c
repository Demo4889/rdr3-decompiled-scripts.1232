...
int func_3(var uParam0)
{
	...
	if (SCRIPTS::GET_THREAD_EXIT_REASON() != 0)
	{
		return 1;
	}
	return 0;
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 10:
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376)) && !func_13(uParam0->f_1358, 512))
			{
				func_18(&(uParam0->f_1358), -2147483648);
				func_18(&(uParam0->f_1358), 512);
			}
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)))
			{
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0))
				{
					func_20(uParam0, 11);
				}
			}
		...
		case 11:
			...
			{
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0) && ANIMSCENE::GET_ANIM_SCENE_PHASE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) > func_40())
				{
...
void func_5(var uParam0, var uParam1, var uParam2)
{
	...
	switch (((*uParam1)[uParam2->f_1 /*18*/])->f_14)
	{
		...
		case 8:
			...
			if ((func_59(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 1) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0)) && !func_13(((*uParam1)[uParam2->f_1 /*18*/])->f_1, 128))
			{
				ANIMSCENE::START_ANIM_SCENE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374));
				func_18(&(((*uParam1)[uParam2->f_1 /*18*/])->f_1), 128);
			}
			if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376)))
			{
			}
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376), func_60(1)))
			{
			}
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376), func_60(1)))
			{
		...
		case 11:
			...
			if (!uParam0->f_1357 && func_13(uParam0->f_26, -2147483648))
			{
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376)))
				{
...
void func_22(var uParam0, var uParam1)
{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) && !ANIMSCENE::IS_ANIM_SCENE_LOADED(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 1, 0))
	{
...
int func_24(var uParam0)
{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)))
	{
		if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 1, 0))
		{
			return 0;
		}
	}
...
void func_32(var uParam0, int iParam1)
{
	...
	switch (*uParam0)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_9, 0))
			{
				return;
			}
			func_103(uParam0, 4);
			break;
		case 4:
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_9, func_111(iParam1, 1)) || !ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_9, func_111(iParam1, 1)))
			{
				return;
			}
			func_103(uParam0, 5);
...
void func_39(var uParam0, var uParam1, var uParam2)
{
	...
	fVar0 = ANIMSCENE::GET_ANIM_SCENE_PHASE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374));
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
...
void func_56(var uParam0, var uParam1, int iParam2)
{
	...
	switch (*uParam1)
	{
		...
		case 1:
			...
			break;
		case 3:
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_9) && ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_9, 1, 0)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9))
			{
		...
		case 4:
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_9) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9)) && uParam0->f_10)
			{
				...
				{
					if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_9, func_111(iParam2, 1)))
					{
			...
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_9, func_111(iParam2, 1)) || !ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_9, func_111(iParam2, 1)))
			{
				return;
			}
			func_136(uParam1, 5);
...
void func_70(var uParam0, var uParam1)
{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)))
	{
...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_17))
	{
		...
		{
			iLocal_16 = PHYSICS::_ADD_ROPE_2(2546.724f, -1309.638f, 50.76665f, 0f, 0f, 0f, 0.3f, 1, 0, -1, -1082130432);
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 33:
			...
			break;
		case 34:
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0) && ANIMSCENE::GET_ANIM_SCENE_PHASE(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) > func_162())
			{
