		...
		if (MISC::GET_GAME_TIMER() > iLocal_57)
		{
			...
			switch (iLocal_56)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_58));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_58)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_58 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_58 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_13()
{
	...
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_21, 12519, 18432, 0, -1, -1, 2);
	POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_21, 12775, 18432, 0, -1, -1, 0);
