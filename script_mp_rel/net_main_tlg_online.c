...
void func_80(bool bParam0)
{
	...
	if (func_230())
	{
		if (((!func_82(8) && !STREAMING::IS_LOAD_SCENE_ACTIVE()) && !func_231(-1562607865)) || bParam0)
		{
			func_232(-1562607865);
			func_83(8);
		}
...
void func_117()
{
	...
	iVar0 = PLAYER::GET_PLAYER_PED(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())));
...
Vector3 func_127(int iParam0, bool bParam1)
{
	...
	{
		vVar0 = { VOLUME::GET_VOLUME_COORDS(((*Global_1887327)[iParam0 /*36*/])->f_4) };
		if (bParam1)
		{
...
void func_141(bool bParam0)
{
	...
	{
		MAP::BLIP_ADD_MODIFIER(iVar0, -600115211);
		MAP::BLIP_REMOVE_MODIFIER(iVar0, -706674318);
	}
	else if (func_270(PLAYER::PLAYER_ID(), 1) && !bParam0)
	{
		MAP::BLIP_REMOVE_MODIFIER(iVar0, -600115211);
		MAP::BLIP_ADD_MODIFIER(iVar0, -706674318);
	}
	else
	{
		MAP::BLIP_REMOVE_MODIFIER(iVar0, -600115211);
...
void func_154()
{
	...
	{
		if (!NETWORK::NETWORK_IS_SCRIPT_ACTIVE_BY_HASH(((*Global_1268274)[&Global_1273882 /*20*/])->f_10, ((*Global_1268274)[&Global_1273882 /*20*/])->f_11, ((*Global_1268274)[&Global_1273882 /*20*/])->f_1 & 4 != 0, 0))
		{
			func_284(2);
	...
	{
		if (!NETWORK::NETWORK_IS_SCRIPT_ACTIVE_BY_HASH(((*Global_1268274)[&Global_1273882 /*20*/])->f_10, ((*Global_1268274)[&Global_1273882 /*20*/])->f_11, 1, 0))
		{
			func_284(16);
			((*Global_1268274)[&Global_1273882 /*20*/])->f_10 = 0;
			((*Global_1268274)[&Global_1273882 /*20*/])->f_11 = -1;
	...
	{
		if (!NETWORK::NETWORK_IS_SCRIPT_ACTIVE_BY_HASH(((*Global_1268274)[&Global_1273882 /*20*/])->f_12, ((*Global_1268274)[&Global_1273882 /*20*/])->f_13, ((*Global_1268274)[&Global_1273882 /*20*/])->f_2 & 16 != 0, 0))
		{
			func_285(8);
										...
										else
										{
											...
											else
											{
												...
												else
												{
													...
													if (!MISC::IS_STRING_NULL_OR_EMPTY_OR_SPACES(func_331(Var1)))
													{
...
char* func_214()
{
	if (func_459())
	{
		return HUD::GET_TEXT_SUBSTRING_2(&Global_26288, HUD::GET_LENGTH_OF_LITERAL_STRING(&Global_26288));
	}
	return "";
}
...
char* func_219()
{
	return HUD::GET_TEXT_SUBSTRING_2(&(((*Global_262996)[&Global_1273882 /*70*/])->f_1.f_27), HUD::GET_LENGTH_OF_LITERAL_STRING(&(((*Global_262996)[&Global_1273882 /*70*/])->f_1.f_27)));
}
...
struct<19> func_234(bool bParam0)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_472(1), &Var19, &Var23, 17, 1))
	{
		return Var0;
	}
...
int func_308()
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED((Global_1070355->f_26934[29 /*4*/])->f_3))
	{
		return 0;
	}
	return 1;
...
void func_315(int iParam0)
{
	...
	iVar11 = _NAMESPACE26::NETWORK_GET_GANG_ID(iVar9);
	iVar10 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(iVar11);
	iVar1 = _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(iVar11);
...
void func_345()
{
	...
	iVar0 = _NAMESPACE26::NETWORK_GET_GANG_ID(Global_1273882->f_10);
...
void func_353()
{
	...
	{
		if (_NAMESPACE71::UI_FEED_GET_CURRENT_MESSAGE(1) == iVar0)
		{
			return;
		}
		iVar1 = func_638();
...
bool func_372()
{
	...
	return _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(iVar0) <= 1;
}
...
int func_376(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_472(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_472(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
{
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(&(Global_1198018->f_1099[iParam0 /*3*/])))
	{
...
void func_402(int iParam0, int iParam1)
{
	...
	{
		if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(Global_1273422->f_23[iParam0 /*3*/]))
		{
		...
		SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(Global_1273422->f_23[iParam0 /*3*/], iParam1);
	}
	else
	{
...
void func_403(var uParam0)
{
	...
	if (SCRIPTS::_0x72B2E00C9BAC6789(&(uParam0->f_2), Global_1273516->f_69))
	{
		...
		{
			SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&(uParam0->f_4), Global_1273516->f_69);
		}
	}
...
void func_405(var uParam0, int iParam1)
{
	...
	if (SCRIPTS::_0x72B2E00C9BAC6789(&(uParam0->f_2), Global_1273516->f_69))
	{
		...
		{
			SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&(uParam0->f_5), Global_1273516->f_69);
		}
	}
	if (SCRIPTS::_IS_ANY_PLAYER_BIT_SET(&(uParam0->f_2)))
	{
...
struct<4> func_471(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_472(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
bool func_535(int iParam0)
{
	...
	return (iVar0 == iParam0 && _NAMESPACE71::_UI_FEED_GET_MESSAGE_STATE(iVar0) <= 4);
}
...
void func_603(int iParam0)
{
	...
	iVar4 = _NAMESPACE26::NETWORK_GET_GANG_ID(iVar0);
	if (func_466(iVar1))
	{
...
void func_607()
{
	...
	if (func_807() != _NAMESPACE26::NETWORK_GET_GANG_ID(iVar8) && (func_808() == 4 || (bVar4 && !func_809(255))))
	{
		if (bVar4)
		{
			if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	...
	if (((((!bVar5 && ((bVar7 && bVar6) || !bVar7)) && func_807() != _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) && bVar3) && !bVar0) && func_808() != 2)
	{
		func_810();
		return;
	}
...
void func_612()
{
	...
	if (_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()) != func_832())
	{
		func_833();
		return;
	}
...
void func_615()
{
	...
	if (PLAYER::PLAYER_ID() == Global_1099293->f_341)
	{
		...
		while (iVar8 <= 6)
		{
			if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(&(Global_1099293->f_342[iVar8])))
			{
			}
...
int func_630(int iParam0, int iParam1, int iParam2)
{
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1835011)[iParam0 /*72*/])->f_28))
	{
		...
		{
			((*Global_1835011)[iParam0 /*72*/])->f_28 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_868(iParam0));
		}
		else
		{
			((*Global_1835011)[iParam0 /*72*/])->f_28 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_869(iParam0));
		}
...
void func_667(int iParam0, int iParam1, int iParam2)
{
	...
	if ((!PED::IS_SCENARIO_BLOCKING_AREA_VALID(&(Global_1198018->f_1099[iParam0 /*3*/])) || (Global_1198018->f_1099[iParam0 /*3*/])->f_1 != iParam1) || (Global_1198018->f_1099[iParam0 /*3*/])->f_2 != iParam2)
	{
		func_400(iParam0);
...
void func_680(var uParam0)
{
	*uParam0 = 0;
	...
	if (uParam0->f_326 != 0)
	{
		_NAMESPACE71::UI_FEED_CLEAR_HELP_TEXT_FEED(uParam0->f_326, 0);
		uParam0->f_326 = 0;
	}
}
...
void func_844(int iParam0, int iParam1, var uParam2, int iParam3, struct<2> Param4, int iParam6, var uParam7, var uParam8, var uParam9, int iParam10)
{
	...
	Var0.f_6 = iParam0;
	Var0.f_5 = iParam1;
	Var0.f_11 = _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
	Var0.f_4 = 3;
	Var0.f_9 = iParam3;
	Var0.f_14 = uParam2;
	Var0.f_7 = { Param4 };
...
void func_874(struct<2> Param0, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (func_350(Param0) == 3 || (func_350(Param0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_1034(Param0))))
	{
		if (iParam3 != -1)
		{
...
void func_875(struct<2> Param0)
{
	...
	else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_1034(Param0)))
	{
...
int func_878()
{
	if (_NAMESPACE71::UI_FEED_GET_CURRENT_MESSAGE(1) != 0)
	{
		return 0;
	}
	if (!CAM::IS_SCREEN_FADED_IN())
	...
	switch (iVar2)
	{
		...
		case 1:
			if (!MAP::DOES_BLIP_EXIST(iVar3))
			{
				...
				MAP::BLIP_ADD_MODIFIER(iVar3, -244815569);
				func_639(iVar3);
			}
...
void func_961(int iParam0, int iParam1)
{
	...
	switch (func_1077(iParam0, iParam1))
	{
		...
		case 3:
			...
			break;
		case 4:
			if (!NETWORK::NETWORK_IS_SCRIPT_ACTIVE_BY_HASH(iVar0, iVar1, 1, 0))
			{
...
void func_963(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 4:
			...
			if (!VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(func_1093(iParam0, iParam1)))
			{
...
void func_964(int iParam0, int iParam1)
{
	...
	switch (iVar3)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (!func_1101(iParam0, iParam1, 0) && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE_BY_HASH(iVar0, iVar1, 0, 0))
			{
...
void func_968(int iParam0, int iParam1)
{
	...
	(Global_1184672->f_2505[iParam0 /*6*/])->f_4 = _NAMESPACE26::NETWORK_GET_GANG_ID(iParam1);
...
void func_973(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar0))
	{
		iVar2 = _NAMESPACE26::NETWORK_GET_GANG_ID(iVar0);
		if ((Global_1184672->f_2505[iParam0 /*6*/])->f_4 != iVar2)
		{
			if ((_NAMESPACE26::_0xD6F6ACF4392187FB((Global_1184672->f_2505[iParam0 /*6*/])->f_4) && _NAMESPACE26::_0x93A91A351A07360E((Global_1184672->f_2505[iParam0 /*6*/])->f_4)) && _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS((Global_1184672->f_2505[iParam0 /*6*/])->f_4) > 0)
			{
...
void func_993()
{
	...
	Var0.f_10 = PLAYER::PLAYER_ID();
	Var0.f_11 = _NAMESPACE26::NETWORK_GET_GANG_ID(Var0.f_10);
	Var0.f_4 = 9;
	func_423();
	func_1006(&Var0, uVar31);
}
...
int func_1082(int iParam0, int iParam1)
{
	...
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE_BY_HASH(iVar1, iVar0, 1, 0))
	{
		return 0;
	}
	if (func_768(iParam0, 8))
...
void func_1096(int iParam0, int iParam1)
{
	...
	if (!VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(iVar0))
	{
		func_1158(iParam0, iParam1, 0);
		return;
	}
	VOLUME::RELEASE_LOCK_VOLUME(iVar0);
	func_1158(iParam0, iParam1, 0);
	func_962(iParam0, iParam1);
}
...
void func_1144(struct<2> Param0)
{
	...
	{
		STATS::STATSTRACKER_DEED_STARTED(func_1034(Param0), Global_265331->f_124445.f_70.f_17);
...
{
	if (!VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(iParam2))
	{
