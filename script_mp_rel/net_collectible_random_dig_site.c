...
void __EntryFunction__()
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(Local_18.f_7))
	{
		func_5(&Local_18);
	}
...
void func_5(var uParam0)
{
	...
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(uParam0->f_25))
	{
...
int func_8(var uParam0)
{
	...
	switch (func_31(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_9, 1, 0))
			{
		...
		case 6:
			...
			break;
		case 7:
			if (((func_59(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) == joaat("weapon_unarmed") && func_59(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 1, 1, 0) == joaat("weapon_unarmed")) && !PED::IS_PED_ON_MOUNT(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()))) && !PED::IS_PED_CARRYING_SOMETHING(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID())))
			{
				func_23(uParam0);
		...
		case 9:
			...
			break;
		case 10:
			if (ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_9, 0) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_9, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23))
				{
...
int func_95(int iParam0)
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(func_123()))
	{
		return 0;
	}
	Var0 = func_123();
...
int func_117(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_138(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_138(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_138(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_138(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_154(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_138(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_169(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_138(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_138(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
int func_173(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_138(bParam1), bParam0, bParam3);
}
