...
int func_5(int iParam0)
{
	...
	if (!func_11(iParam0->f_1))
	{
		...
		{
			_NAMESPACE71::UI_FEED_CLEAR_HELP_TEXT_FEED(iParam0->f_15, 0);
		}
	}
...
void func_31(struct<2> Param0, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (func_71(Param0) == 3 || (func_71(Param0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_72(Param0))))
	{
		if (iParam3 != -1)
		{
		...
		if ((((BUILTIN::VDIST(Global_36, iParam0->f_3) < fVar0 && ENTITY::DOES_ENTITY_EXIST(Global_35)) && !ENTITY::IS_ENTITY_DEAD(Global_35)) && !PED::IS_PED_DEAD_OR_DYING(Global_35, true)) && !func_102())
		{
			...
			else if (func_20(128))
			{
				...
				else if (_NAMESPACE26::_0x424B17A7DC5C90BC(PLAYER::PLAYER_ID()))
				{
					...
					iVar113 = _NAMESPACE26::_0xD1BF325C8252A982(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()), &Var62);
					iVar112 = 0;
					while (iVar112 <= (iVar113 - 1))
					{
						iVar115 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(Var62[iVar112 /*7*/]);
						if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar115) || PLAYER::IS_PLAYER_DEAD(iVar115))
						{
						}
						else
						{
					...
					else if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > func_111(iParam0->f_2))
					{
...
int func_200(int iParam0)
{
	...
	else if (PED::IS_PED_HOGTIED(Global_35))
	{
		return 0;
	}
...
void func_248(struct<2> Param0)
{
	...
	{
		STATS::STATSTRACKER_DEED_STARTED(func_72(Param0), Global_265331->f_124445.f_70.f_17);
...
{
	if (((PED::IS_PED_IN_COMBAT(Global_35, 0) || PED::IS_PED_IN_MELEE_COMBAT(Global_35)) || func_131(iParam1, 1024)) && PED::COUNT_PEDS_IN_COMBAT_WITH_TARGET_WITHIN_RADIUS(Global_35, Global_36, fParam0, iParam1) > 0)
	{
		return 1;
	}
	return 0;
