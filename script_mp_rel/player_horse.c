...
void func_21(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11)
{
	if (Param0.f_1)
	{
		if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(Param0))
		{
		...
		if (vVar1.z)
		{
			if (func_141(vVar1.x, Global_35, 1, 1) > func_79(5) && !ENTITY::IS_ENTITY_ON_SCREEN(vVar1.x))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar13))
				{
					...
					if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(iVar13))
					{
...
void func_51()
{
	...
	{
		iVar2 = func_78(0);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar2, 31, 2, bVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar2, 32, 2, bVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar2, 33, 2, bVar1);
	}
	if (func_66(1))
	{
		iVar3 = func_78(1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar3, 31, 2, bVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar3, 32, 2, bVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar3, 33, 2, bVar1);
	}
}
				...
				else
				{
						...
						if (((Global_40.f_277.f_1[iParam0 /*431*/])->f_15[iVar199 /*95*/])->f_1 != 0)
						{
							if (((Global_40.f_277.f_1[iParam0 /*431*/])->f_15[iVar199 /*95*/])->f_1 != Var1.f_1)
							{
								...
								if (Var1.f_1 != 0)
								{
									...
									{
										func_225(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar0), Var1.f_1, 1);
									}
					...
					else
					{
						if (STREAMING::IS_MODEL_A_PED(Var1))
						{
							...
							if (MISC::_IS_PED_DECOMPOSED(iVar198))
							{
								TASK::TASK_DUMP_CARRIABLE_FROM_PARENT(Global_35, iVar0, iVar196);
								ENTITY::_SET_ENTITY_CARRYING_FLAG(iVar196, 2, false);
								MISC::SET_PED_DECOMPOSED(iVar198, 1);
...
void func_61(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == PLAYER::_0xB48050D326E9A2F3(PLAYER::PLAYER_ID()) && bVar3)
		{
			...
			{
				((*Global_1903006)[iParam0 /*43*/])->f_26 = MAP::BLIP_ADD_FOR_ENTITY(-515518185, iVar0);
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1903006)[iParam0 /*43*/])->f_25))
	{
		((*Global_1903006)[iParam0 /*43*/])->f_25 = MAP::BLIP_ADD_FOR_ENTITY(iVar5, iVar0);
	...
	if (iVar17 != 0)
	{
		...
		MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, iVar17);
		if (iVar17 == -401963276)
		{
			MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, 231194138);
		}
	}
	if (iVar18 != 0)
	{
		MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, iVar18);
	}
	if ((PLAYER::_0xB48050D326E9A2F3(PLAYER::PLAYER_ID()) == iVar0 && bVar3) && !bVar9)
	{
		MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, 673950256);
	}
	else
	{
		MAP::BLIP_REMOVE_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, 673950256);
	}
	if (func_256(iVar0) && !bVar9)
	{
		...
		MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, iVar20);
	}
	else
	{
		MAP::BLIP_REMOVE_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, 561559387);
		MAP::BLIP_REMOVE_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, -201249929);
	}
...
void func_62()
{
	...
	{
		Global_1903006->f_379.f_1 = MAP::BLIP_ADD_FOR_ENTITY(-515518185, iVar0);
...
int func_179(int iParam0, int iParam1)
{
	...
	if (iParam1 != -1)
	{
		if (VOLUME::DOES_VOLUME_EXIST(((*Global_1887327)[iParam1 /*36*/])->f_5))
		{
	...
	while (iVar1 < Global_1893575->f_161)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(((*Global_1887327)[iVar0 /*36*/])->f_5))
		{
		}
...
void func_207(struct<5> Param0, var uParam5, var uParam6)
{
	...
	iVar4 = MAP::BLIP_ADD_FOR_COORDS(168093330, vVar1);
...
{
	return func_472(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1, bParam2, bParam3, iParam4);
}
...
int func_224(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (func_473(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam2) < iVar0)
	{
		return 1;
	}
	return 0;
...
void func_252(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_487(func_486(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_488())
	{
...
struct<4> func_263(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_514(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_265(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_514(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_514(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
void func_314(int iParam0)
{
	...
	if (MAP::DOES_BLIP_EXIST(((*Global_1903006)[iParam0 /*43*/])->f_25))
	{
		if (((*Global_1903006)[iParam0 /*43*/])->f_24 == 2)
		{
			MAP::BLIP_REMOVE_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, -1814032670);
			MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, -1814032670);
		}
		else if (((*Global_1903006)[iParam0 /*43*/])->f_24 == 1)
		{
			MAP::BLIP_REMOVE_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, -272772079);
			MAP::BLIP_ADD_MODIFIER(((*Global_1903006)[iParam0 /*43*/])->f_25, -272772079);
		}
	}
}
...
struct<4> func_379(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		Var29 = { func_618() };
		if (func_619() && INVENTORY::_INVENTORY_IS_GUID_VALID(&Var29))
		{
			Var0 = { Var29 };
		}
...
char* func_486(int iParam0)
{
	...
	if (iParam0 == 255)
	{
		...
		{
			return HUD::GET_TEXT_SUBSTRING_2(&(Global_1099293->f_12), HUD::GET_LENGTH_OF_LITERAL_STRING(&(Global_1099293->f_12)));
		}
		else
		{
	...
	if (func_692(39, iParam0))
	{
		return HUD::GET_TEXT_SUBSTRING_2(&(((*Global_1097609)[iParam0 /*51*/])->f_12), HUD::GET_LENGTH_OF_LITERAL_STRING(&(((*Global_1097609)[iParam0 /*51*/])->f_12)));
	}
...
int func_596(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_514(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_514(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
void func_602(int iParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(PLAYER::_0xAD03B03737CE6810(iParam0)))
	{
		return;
	}
	iVar6 = 23;
...
int func_652(bool bParam0, int iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_514(bParam6), iParam1, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
struct<28> func_720(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	Var28.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_514(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<25> func_722(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_514(bParam4), &uParam0, &Var25, 24, 1))
	{
		return Var0;
	}
...
struct<17> func_724(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_514(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
...
int func_747(struct<4> Param0, struct<4> Param4, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (!INVENTORY::_INVENTORY_FITS_SLOT_ID(Var0.f_4, bParam8))
	{
		return 0;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_514(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_785(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_514(bParam4), bParam0, bParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_514(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_828(int iParam0, int iParam1)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_514(0), iParam0, iParam1, 29, 1))
	{
		return 0;
	}
	return 1;
...
void func_856(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (PED::IS_PED_HUMAN(iParam0))
	{
		if (bParam6)
		{
			WEAPON::_GIVE_WEAPON_COLLECTION_TO_PED(iParam0, WEAPON::_0xD42514C182121C23(iParam1));
		}
...
bool func_880(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		bVar0 = (bVar0 + func_473(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1));
	}
	if (bParam3)
	{
...
int func_922(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_514(bParam1), bParam0, bParam3);
}
