...
void func_2(var uParam0)
{
	...
	Local_0.f_12 = _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
...
int func_3()
{
	...
	if (Local_0.f_12 != 0 && _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()) != Local_0.f_12)
	{
		return 1;
	}
	return 0;
...
void func_15()
{
	...
	{
		if (PED::IS_PED_HOGTIED(Local_0.f_13) && PED::_0x3D9F958834AB9C30(Local_0.f_13) == Global_35)
		{
			func_11(1);
			return;
		}
	...
	while (iVar0 < SCRIPTS::GET_NUMBER_OF_EVENTS(1))
	{
		switch (SCRIPTS::GET_EVENT_AT_INDEX(1, iVar0))
		{
			case -1315570756:
				...
				return _NAMESPACE26::NETWORK_GET_GANG_ID(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var1.f_1))) == _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
		}
		iVar0++;
	}
	return 0;
...
int func_35()
{
	...
	while (iVar0 <= 31)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1) && _NAMESPACE26::NETWORK_GET_GANG_ID(iVar1) == Local_0.f_12)
		{
