...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (((PED::IS_PED_FALLING(Global_35) || PED::_0x3E592D0486DEC0F6(Global_35)) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::GET_PLAYER_INDEX(), true)) || PED::IS_PED_HOGTIED(Global_35))
		{
			func_5(0);
		}
...
int func_21(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		if (((func_84() || TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 1)) || !PED::IS_PED_ON_FOOT(Global_35))
		{
			return 0;
		}
		switch (bParam0)
			...
			case -727924611: /* GXTEntry: "Wardrobe" */
				...
				else
				{
					...
					else
					{
						...
						if (!func_101(Global_1956162->f_1, 1) || func_101(Global_1956162->f_1, 512))
						{
							if (func_88(-1838434463 /* GXTEntry: "Camp" */))
							{
								...
								else
								{
									...
									func_107(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
								}
							}
						...
						if (!WEAPON::_IS_WEAPON_BINOCULARS(func_108(Global_35, 1, 0, 0)))
						{
...
struct<4> func_112(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_145(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
bool func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		bVar0 = (bVar0 + func_330(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1));
	}
	if (bParam3)
	{
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_145(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_188(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_145(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_145(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
int func_198(bool bParam0)
{
	...
	if (PED::IS_PED_CARRYING_SOMETHING(PLAYER::_0xF49F14462F0AE27C(PLAYER::PLAYER_ID())))
	{
...
int func_213(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_145(bParam4), bParam0, bParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
int func_214(bool bParam0, int iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_145(bParam6), iParam1, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_264(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_145(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_145(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_145(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_367(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_145(bParam1), bParam0, bParam3);
}
...
int func_453()
{
	...
	if (iVar1 == joaat("weapon_unarmed"))
	{
		...
		else if ((((WEAPON::IS_WEAPON_VALID(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0)) && !func_607(bVar0)) && !PED::_IS_PED_GETTING_INTO_A_MOUNT_SEAT(Global_35, true)) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_35, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((WEAPON::IS_WEAPON_VALID(bVar0) && func_607(bVar0)) || WEAPON::_IS_WEAPON_LASSO(bVar0))
		{
			return 1;
		}
		else
...
struct<28> func_509(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	Var28.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_145(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<25> func_511(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_145(bParam4), &uParam0, &Var25, 24, 1))
	{
		return Var0;
	}
...
struct<17> func_513(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_145(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
...
int func_541(int iParam0, bool bParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return func_330(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1);
	}
	return 0;
}
...
{
	*iParam2 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(iParam0, uParam1, bParam3);
	if (*iParam2 >= 0)
	{
		return 1;
	}
...
{
	return func_799(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1, bParam2, bParam3, iParam4);
}
...
int func_777()
{
	if (((((!ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_35)) && !func_867(Global_35, 1369124074)) && !func_867(Global_35, 713668775)) && !TASK::IS_PED_RUNNING_TASK_ITEM_INTERACTION(Global_35)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		return 1;
	}
	return 0;
