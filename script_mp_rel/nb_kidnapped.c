...
void func_41()
{
	...
	Local_0.f_6 = func_73(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(iVar0)));
	func_90(256);
...
int func_101()
{
	...
	while (iVar2 <= 3)
	{
		...
		if (!PED::IS_PED_READY_TO_RENDER(NETWORK::NET_TO_PED(&(Local_0.f_7.f_7[iVar2 /*2*/]))))
		{
			return 0;
		}
		iVar2++;
	...
	while (iVar3 <= 2)
	{
		...
		if (!PED::IS_PED_READY_TO_RENDER(NETWORK::NET_TO_PED(&(Local_0.f_7.f_16[iVar3 /*2*/]))))
		{
			return 0;
		}
		iVar3++;
...
bool func_114()
{
	...
	sVar3 = func_195();
	sVar4 = "OREKID";
	if (HUD::_DOES_TEXT_BLOCK_EXIST(sVar4))
	{
		HUD::TEXT_BLOCK_REQUEST(sVar4);
		if (!HUD::TEXT_BLOCK_IS_LOADED(sVar4))
		{
			iVar0 = 0;
		}
	}
	if (HUD::_DOES_TEXT_BLOCK_EXIST(sVar3))
	{
		HUD::TEXT_BLOCK_REQUEST(sVar3);
		if (!HUD::TEXT_BLOCK_IS_LOADED(sVar3))
		{
			iVar0 = 0;
		}
	}
...
void func_228()
{
	...
	while (iVar0 <= 3)
	{
		...
		else if (func_206(iVar0) && PED::IS_PED_HOGTIED(iVar1))
		{
...
int func_319()
{
	...
	if (iVar1 == 0 && !PED::IS_PED_HOGTIED(iVar0))
	{
		return 1;
	}
	return 0;
...
void func_323()
{
	...
	{
		ENTITY::_SET_ENTITY_CARRYING_FLAG(func_190(0), 1, true);
	}
	func_417();
	if (!func_254(13))
	{
...
void func_351(struct<2> Param0)
{
	...
	{
		STATS::STATSTRACKER_DEED_STARTED(func_237(Param0), Global_265331->f_124445.f_70.f_17);
...
void func_398(int iParam0)
{
	...
	Local_809.f_18.f_1[iParam0 /*3*/] = MAP::BLIP_ADD_FOR_ENTITY(iVar0, iVar1);
	if (!MAP::DOES_BLIP_EXIST(&(Local_809.f_18.f_1[iParam0 /*3*/])))
	{
		return;
	}
...
int func_399(int iParam0)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(&(Local_809.f_18.f_69[iParam0])))
	{
