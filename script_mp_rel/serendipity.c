		...
		if (MISC::GET_GAME_TIMER() > iLocal_53)
		{
			...
			switch (iLocal_52)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_54));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_54)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_54 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_54 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_132(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_131(iParam0)));
		if (func_45() == -1)
		{
			if (func_124(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_133(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_133(iParam0)))
	{
...
int func_125(int iParam0, bool bParam1)
{
	...
	func_173(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_133(iParam0));
	func_132(iParam0, 0);
	return 1;
}
