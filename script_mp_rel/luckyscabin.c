		...
		if (MISC::GET_GAME_TIMER() > iLocal_35)
		{
			...
			switch (iLocal_34)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_36));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_36)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_36 /*36*/])->f_12);
							}
							Jump @850; //curOff = 827
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_36 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
