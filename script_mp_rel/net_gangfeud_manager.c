...
void func_34(var uParam0)
{
	...
	if (((Global_1264800->f_16 != 255 && !PED::IS_PED_HOGTIED(Global_35)) && !func_57()) || (Global_1264800->f_16 != 255 && !NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1264800->f_16)))
	{
	...
	if (uParam0->f_98 != Global_1273882->f_15)
	{
		...
		if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(Global_1273882->f_15) > 1 && !_NAMESPACE26::_0x424B17A7DC5C90BC(Global_1273882->f_10))
		{
			func_58(uParam0);
		}
		else
	...
	if (!_NAMESPACE26::_0xD6F6ACF4392187FB(uParam0[Global_1264800->f_30 /*3*/]) || _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(uParam0[Global_1264800->f_30 /*3*/]) < 1)
	{
...
int func_39()
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1264800->f_75))
	{
		return 0;
	}
...
bool func_41()
{
	...
	if (Global_1099293->f_26.f_141.f_5)
	{
		...
		Var0.f_7 = _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
		Var0.f_8 = _NAMESPACE26::NETWORK_GET_GANG_ID(Global_1264800->f_15);
		func_70(&Var0);
	}
...
void func_56()
{
	...
	if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(&(Global_1261405->f_1[Global_1264800->f_80 /*4*/])) && !NETWORK::NETWORK_IS_PLAYER_CONNECTED(&(Global_1261405->f_1[Global_1264800->f_80 /*4*/])))
	{
		(Global_1261405->f_1[Global_1264800->f_80 /*4*/])->f_1 = 255;
		Global_1261405->f_1[Global_1264800->f_80 /*4*/] = 255;
		return;
	}
	if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID((Global_1261405->f_1[Global_1264800->f_80 /*4*/])->f_1) && !NETWORK::NETWORK_IS_PLAYER_CONNECTED((Global_1261405->f_1[Global_1264800->f_80 /*4*/])->f_1))
	{
		(Global_1261405->f_1[Global_1264800->f_80 /*4*/])->f_1 = 255;
		Global_1261405->f_1[Global_1264800->f_80 /*4*/] = 255;
		return;
...
void func_82(var uParam0)
{
	...
	uParam0->f_4 = 1;
	SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&uVar0, uParam0->f_9);
	uParam0->f_9 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(uParam0->f_9));
	uParam0->f_10 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(uParam0->f_10));
	iVar2 = -1;
	iVar1 = 0;
	while (iVar1 <= 31)
	{
...
void func_112(int iParam0, var uParam1)
{
	...
	Var19.f_4 = 85;
	SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&fVar18, iParam0);
	Var19 = 1;
	...
	SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&fVar18, PLAYER::PLAYER_ID());
	Var0.f_6 = PLAYER::PLAYER_ID();
	Var0.f_8 = { func_129(1, func_128(uVar41)) };
	Var0.f_7 = fVar18;
	Var0.f_11 = _NAMESPACE26::NETWORK_GET_GANG_ID(iParam0);
	Var0.f_1 = iParam0;
	Var0.f_17 = 1;
...
void func_113(int iParam0)
{
	...
	Global_1264800->f_18 = _NAMESPACE26::NETWORK_GET_GANG_ID(iParam0);
	func_40(2);
}
...
void func_115(int iParam0, int iParam1, var uParam2)
{
	...
	if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(&fVar20))
	{
		return;
	}
	Var0.f_6 = PLAYER::PLAYER_ID();
...
void func_134(float fParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 32)
	{
		...
		else if (_NAMESPACE26::NETWORK_GET_GANG_ID(iVar2) != iParam1)
		{
		}
		else if (bParam2)
		{
...
int func_136(int iParam0)
{
	...
	if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(iParam0) == 0)
	{
		return 0;
	}
	return 1;
...
int func_156(int iParam0)
{
	...
	iVar3 = _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
	switch (iParam0)
	{
		case 4:
			if (iVar3 > 2)
...
int func_157()
{
	...
	if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > 1)
	{
		return 1;
	}
	return 0;
...
int func_159(int iParam0)
{
	...
	if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) < 2)
	{
		return 0;
	}
	if (iParam0 == 8)
	{
		...
		{
			iVar2 = PLAYER::INT_TO_PLAYERINDEX(iVar0);
			if ((!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar2) || !NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar2)) || !_NAMESPACE26::_0x9BE7DCB22D32CCBE(Global_1273882->f_15, iVar2))
			{
			}
			else
			{
...
void func_161(float fParam0, bool bParam1)
{
	...
	while (iVar2 < 32)
	{
		...
		else if (_NAMESPACE26::NETWORK_GET_GANG_ID(iVar1) != iVar0)
		{
		}
		else
		{
...
int func_174()
{
	...
	while (iVar3 <= 31)
	{
		...
		if ((!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar4) || !NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar4)) || !_NAMESPACE26::_0x9BE7DCB22D32CCBE(Global_1273882->f_15, iVar4))
		{
		}
...
char* func_185(int iParam0)
{
	...
	switch (iParam0)
	{
		case 4:
			...
			else if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) <= 2)
			{
		...
		case 8:
			...
			else if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) <= 1)
			{
...
int func_193(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_216(iParam0) == -785841056)
	{
		...
		iVar0 = _NAMESPACE26::NETWORK_GET_GANG_ID(iParam1);
				...
				if (func_225(iParam0, iVar20) == -1 && func_199(iParam0, iVar20) == 0)
				{
					...
					while (iVar21 <= 31)
					{
						if (SCRIPTS::_0x72B2E00C9BAC6789(&uVar19, iVar21))
						{
							...
							if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar22) && !_NAMESPACE26::_0x9BE7DCB22D32CCBE(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()), iVar22))
							{
								fVar17 = (fVar17 + 1f);
							}
						}
...
int func_207(int iParam0)
{
	...
	{
		case 4:
			return _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > 2;
		case 5:
			return _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > 1;
		case 6:
			return _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > 1;
		case 7:
			return _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > 1;
