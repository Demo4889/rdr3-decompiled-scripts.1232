		...
		if (MISC::GET_GAME_TIMER() > iLocal_26)
		{
			...
			switch (iLocal_25)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_27));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_27)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_27 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_27 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_13()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -1987.5f, -1619.5f, 119f, 0f, 0f, 108f, 13f, 7.5f, 3.3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -1993.957f, -1616.896f, 119f, 0f, 0f, 108f, 4f, 3.2f, 3.3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -1993.276f, -1625.02f, 118.1032f, 0f, 0f, 18.70994f, 6.771215f, 10.15464f, 4.094861f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -1979.72f, -1641.667f, 118.1032f, 0f, 0f, 18.70994f, 18.24065f, 21.29219f, 4.094861f);
	iLocal_23 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Manzanita - m_volArtistOwner Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_23, -1978.791f, -1668.522f, 118.1032f, 0f, 0f, 144.4009f, 7.96674f, 8.658496f, 4.094861f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_23, -1975.129f, -1655.416f, 118.1032f, 0f, 0f, 106.1859f, 3.915041f, 4.647958f, 4.094861f);
