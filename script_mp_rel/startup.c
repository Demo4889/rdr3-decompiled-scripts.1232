...
void func_61(char* sParam0)
{
	...
	if (sParam0->f_60 == 0 || (sParam0->f_62 && (_NAMESPACE71::_UI_FEED_GET_MESSAGE_STATE(sParam0->f_60) == 6 || bVar2)))
	{
		Var3.f_12.f_8 = -1;
		Var3.f_12.f_8.f_1 = -1;
...
void func_180()
{
	...
	if (!PED::IS_PED_CARRYING_SOMETHING(Global_1273882->f_8) && !func_307(Global_1273882->f_8, -208384378))
	{
		func_201(14);
	}
	else if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !func_307(Global_35, -208384378))
	{
		iVar0 = PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(Global_1273882->f_8);
...
void func_191(char* sParam0, char[4] cParam1, bool bParam2)
{
	...
	{
		if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(sParam0->f_12.f_16.f_14) && NETWORK::NETWORK_IS_PLAYER_ACTIVE(sParam0->f_12.f_16.f_14))
		{
...
void func_332(int iParam0, bool bParam1)
{
	...
	if (func_464(_NAMESPACE26::NETWORK_GET_GANG_ID(iParam0)))
	{
		bVar0 = func_465(iParam0);
	}
	else
	{
		bVar0 = _NAMESPACE26::_0xC0474C8BCF6787AD(_NAMESPACE26::NETWORK_GET_GANG_ID(iParam0));
	}
	if (bParam1)
	{
		if (!bVar0)
...
void func_356(char* sParam0, var uParam1, int iParam2, char* sParam3, bool bParam4)
{
	...
	switch (iParam2)
	{
		...
		case 8:
			...
			break;
		case 20:
			if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(sParam0->f_49)) == 1)
			{
...
int func_414(int iParam0)
{
	...
	if (_NAMESPACE26::_0x0F99F6436528A089(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())))
	{
		...
		{
			if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) > (func_525(func_387(iParam0)) - 1))
			{
				return 5;
			}
		}
...
int func_465(int iParam0)
{
	...
	if (_NAMESPACE26::_0x0F99F6436528A089(_NAMESPACE26::NETWORK_GET_GANG_ID(iParam0)) && _NAMESPACE26::_0x7933754F260B428A(iParam0) > 0)
	{
		return 0;
	}
		...
		if (POSSE::_0xC084FF658B2E71DA(&Var0, iVar106, &Var7))
		{
			if (Var7.f_9 == 1 && Var7 != 0)
			{
				...
				else if (Var7.f_17 < 10)
				{
					...
					Global_1180694->f_14.f_9 = _NAMESPACE26::NETWORK_GET_GANG_ID(iParam0);
					func_553(6);
					func_554(32);
					func_551(2);
					if (_NAMESPACE26::_0x0F99F6436528A089(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())))
...
int func_510()
{
	...
	while (iVar0 <= 3)
	{
		if (_NAMESPACE71::_UI_FEED_GET_MESSAGE_STATE((Global_1070355->f_14.f_356[iVar0 /*64*/])->f_60) == 6)
		{
...
struct<4> func_661(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_698(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_700(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_698(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_698(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
int func_737(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_698(bParam1), bParam0, bParam3);
}
