...
void func_23()
{
	...
	if (bVar5 || SCRIPTS::_0x179A6F0EE2E79026(&(Global_1070355->f_19683.f_260)))
	{
		iVar0 = 0;
		while (iVar0 <= 31)
		{
...
void func_29(var uParam0)
{
	...
	if (bVar0)
	{
		...
		if (uParam0->f_11 && !uParam0->f_12)
		{
			...
			if (bVar1)
			{
				WEAPON::_0x94A3C1B804D291EC(uParam0->f_8, 0, 0, 1, 0);
			}
		}
	}
...
void func_41()
{
	...
	if (func_294())
	{
		...
		{
			func_375(func_373(), 4);
			if (MAP::_0x662D364ABF16DE2F(func_374(func_373()), -1186550032))
			{
			}
		}
		func_376();
					...
					if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar5))
					{
						if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar5))
						{
							...
							if (func_710(iVar5))
							{
								...
								if (func_711(iVar7) || PED::_0xA911EE21EDF69DAF(iVar7))
								{
									func_366(582, 0);
								}
								else
...
void func_156()
{
	...
	else if (CAM::_0xA24C1D341C6E0D53(1, 0, 0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != 0)
	{
		func_775(65536);
		CAM::_DISABLE_FIRST_PERSON_CAM_THIS_FRAME();
	}
...
int func_188()
{
	...
	if ((Global_1099293->f_4[Global_1100046[0 /*2*/]] && ((*Global_1100046)[0 /*2*/])->f_1) == ((*Global_1100046)[0 /*2*/])->f_1)
	{
		...
		PAD::_0x2804658EB7D8A50B(4, -1692506095);
	...
	if (bVar2)
	{
		PAD::_0x2804658EB7D8A50B(4, 3678691);
	}
