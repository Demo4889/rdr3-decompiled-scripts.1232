		...
		if (MISC::GET_GAME_TIMER() > iLocal_27)
		{
			...
			switch (iLocal_26)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_28));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_28)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_28 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_28 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_13()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5193.958f, -2150.221f, 14.60039f, 0f, 0f, 43.94339f, 30.9764f, 20.35678f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5183.694f, -2097.742f, 14.60039f, 0f, 0f, 44.16594f, 20.21152f, 34.85038f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5158.286f, -2115.092f, 14.60039f, 0f, 0f, 47.64177f, 8.714133f, 1.633199f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5230.49f, -2124.006f, 14.60039f, 0f, 0f, 44.16594f, 15.32629f, 8.306676f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5157.303f, -2119.695f, 14.60039f, 0f, 0f, 44.16594f, 12.39145f, 8.306676f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5213.393f, -2110.535f, 14.60039f, 0f, 0f, 44.16594f, 34.53635f, 13.98279f, 20.57744f);
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, -67.73256f, -399.212f, 72.24845f, 0f, 0f, 52.56716f, 42.4006f, 47.27523f, 14.85572f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, -5186.615f, -2154.339f, 14.60039f, 0f, 0f, 46.12168f, 36.16204f, 4.894577f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, -5194.527f, -2122.047f, 14.60039f, 0f, 0f, 43.94178f, 70.70334f, 56.27375f, 20.57744f);
		...
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_14, iLocal_15);
...
int func_90(int iParam0, bool bParam1)
{
	...
	{
		func_124(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_123(iParam0)));
		if (func_45() == -1)
		{
