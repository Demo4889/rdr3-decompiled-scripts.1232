...
int func_89(int iParam0, bool bParam1)
{
	...
	{
		func_123(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_122(iParam0)));
		if (func_45() == -1)
		{
...
void func_119(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_159(iParam0, 2))
	{
