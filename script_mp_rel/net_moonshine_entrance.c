...
void func_4()
{
	...
	switch (Local_21)
	{
		...
		case 3:
			...
			break;
		case 8:
			if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(Local_21.f_84) || !_NAMESPACE26::_NETWORK_IS_IN_MY_GANG(Local_21.f_84))
			{
				func_13(33);
			}
			func_23(0);
		...
		case 5:
			...
			else
			{
				...
				if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(Local_21.f_6) && ANIMSCENE::_0xD8254CB2C586412B(Local_21.f_6, 0)) && Local_21.f_4 == 5)
				{
					func_42(0);
					func_41();
					func_25(1);
				...
				else
				{
					...
					func_59();
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(Local_21.f_6) && ANIMSCENE::_0xD8254CB2C586412B(Local_21.f_6, 0))
					{
						func_41();
						func_43();
					...
					{
						func_63(1);
						func_64(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())));
						func_58(32);
						func_58(64);
					}
...
void func_5()
{
	...
	while (iVar0 <= 1)
	{
		if (VOLUME::DOES_VOLUME_EXIST(&(Local_21.f_89[iVar0])))
		{
			VOLUME::DELETE_VOLUME(&(Local_21.f_89[iVar0]));
		}
		iVar0++;
	}
	if (func_71(1, 8))
...
int func_18()
{
	...
	bVar26 = (_NAMESPACE26::_0x424B17A7DC5C90BC(PLAYER::PLAYER_ID()) && _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(Global_1273882->f_15) > 1);
	iVar27 = 0;
	while (iVar27 < 4)
	{
		if (!VOLUME::DOES_VOLUME_EXIST((Local_21.f_34[iVar27 /*4*/])->f_2))
		{
...
void func_22(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			while (iVar0 < 4)
			{
				if (!VOLUME::DOES_VOLUME_EXIST((Local_21.f_34[iVar0 /*4*/])->f_2))
				{
				}
...
int func_24(bool bParam0)
{
	...
	if (PED::IS_PED_INCAPACITATED(Global_35))
	{
		return 1;
	}
	...
	if (PED::IS_PED_HOGTIED(Global_35) || PED::_0xD453BB601D4A606E(Global_35))
	{
		return 1;
	}
...
int func_32()
{
	...
	if (!func_68(1024) && STREAMING::IS_LOAD_SCENE_ACTIVE())
	{
		STREAMING::_0x5A8B01199C3E79C3();
		return 0;
	}
...
int func_33()
{
	...
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(Local_21.f_6))
	{
		Local_21.f_6 = ANIMSCENE::_CREATE_ANIM_SCENE(sVar0, 0, sVar1, false, true);
	}
	bVar2 = true;
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(Local_21.f_6, 1, 0))
	{
		bVar2 = false;
	}
...
void func_34()
{
	...
	if (Local_21.f_9 <= 0)
	{
		...
		{
			Local_21.f_9 = _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(Global_1273882->f_15);
...
void func_39()
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_21.f_6, 0) && !func_68(1))
	{
	...
	fVar1 = ANIMSCENE::GET_ANIM_SCENE_PHASE(Local_21.f_6);
	if (fVar1 > 0.9f)
	{
	...
	switch (Local_21.f_4)
	{
		case 1:
			...
			break;
		case 2:
			if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(Local_21.f_6) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_21.f_6, 0))
			{
			}
			else
			{
...
int func_40()
{
	...
	if (iVar0 == PLAYER::PLAYER_ID() && _NAMESPACE26::NETWORK_GET_GANG_ID(iVar0) != Global_1273882->f_15)
	{
		return 1;
	}
	if ((iVar0 != PLAYER::PLAYER_ID() && _NAMESPACE26::NETWORK_GET_GANG_ID(iVar0) != Global_1273882->f_15) && (Global_1275117->f_1 == 2 || Global_1275117->f_1 == 1))
	{
		Local_21.f_3 = 3;
		return 1;
	}
...
void func_59()
{
	...
	fVar0 = ANIMSCENE::GET_ANIM_SCENE_PHASE(Local_21.f_6);
	if (fVar0 > 0.9f)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_35))
		{
...
void func_66()
{
	...
	while (iVar0 < 4)
	{
		if (VOLUME::DOES_VOLUME_EXIST((Local_21.f_34[iVar0 /*4*/])->f_2))
		{
			VOLUME::DELETE_VOLUME((Local_21.f_34[iVar0 /*4*/])->f_2);
		}
		if (func_92(&(Local_21.f_34[iVar0 /*4*/])))
		{
...
{
	if (_NAMESPACE26::NETWORK_GET_GANG_ID(iParam0) != Global_1273882->f_15 && !func_233())
	{
		return 636925055;
	}
	return -963477619;
