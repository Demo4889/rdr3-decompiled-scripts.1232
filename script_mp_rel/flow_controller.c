...
void func_16(int iParam0)
{
	...
	{
		if (((Global_1273882->f_16 != &Global_1273882 && Global_1273882->f_16 >= 0) && Global_1273882->f_16 < 32) && NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(&(Global_1273882->f_154[Global_1273882->f_16])))
		{
			func_24();
			Global_1878407->f_5++;
			*iParam0 = 0;
		...
		case 0:
			if (VOLUME::_0x397769175A7DBB30(vVar0, fVar3, 0, 0, 0))
			{
				if (func_39(&uVar4, iParam0))
				{
					...
					if (VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(uVar13))
					{
						return 1;
					}
				}
					...
					else
					{
						...
						switch (iVar14)
						{
							...
							case 3:
								...
								if (!VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(func_45(iParam0)))
								{
									func_41(iParam0, 0);
									return 0;
								}
	...
	switch (func_38(iParam0))
	{
		case 0:
			if (func_39(&uVar0, iParam0))
			{
				...
				if (VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(iVar9))
				{
		...
		case 3:
			if (VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(func_45(iParam0)))
			{
				VOLUME::RELEASE_LOCK_VOLUME(func_45(iParam0));
			}
			func_41(iParam0, 0);
			break;
	}
...
void func_106(struct<2> Param0, bool bParam2, int iParam3, int iParam4)
{
	...
	if (func_172(Param0) == 3 || (func_172(Param0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_171(Param0))))
	{
		if (iParam3 != -1)
		{
...
int func_109(int iParam0, int iParam1, int iParam2)
{
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1835011)[iParam0 /*72*/])->f_28))
	{
		...
		{
			((*Global_1835011)[iParam0 /*72*/])->f_28 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_186(iParam0));
		}
		else
		{
			((*Global_1835011)[iParam0 /*72*/])->f_28 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_187(iParam0));
		}
...
int func_158(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_226(bParam1), iParam0, iParam3);
}
...
{
	return VOLUME::IS_VOLUME_LOCK_REQUEST_VALID_2(func_45(iParam0));
}
...
int func_228()
{
	switch (func_267())
	{
		case 0:
			...
			return 0;
		case 1:
			if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(func_269()))
			{
				return 0;
			}
			if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(func_270()))
			{
				return 0;
			}
			func_271(func_269());
...
int func_394(int iParam0, int iParam1, int iParam2, vector3 vParam3, bool bParam6, bool bParam7, int iParam8, float fParam9)
{
	...
	if (func_431(iParam2))
	{
		iVar11 = func_432(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())));
		if (!func_433(iVar11))
		{
			return 13;
		}
	...
	if (func_385(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))))
	{
		return 15;
	}
	if (bParam6)
...
int func_444(var uParam0)
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(uVar0))
	{
		return 0;
	}
