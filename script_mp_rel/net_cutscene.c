...
void func_39(var uParam0, bool bParam1)
{
	...
	{
		func_93(1);
		WEAPON::_HIDE_PED_WEAPONS(Global_1273882->f_8, 2, 1);
											...
											else if (MISC::IS_BIT_SET((uParam0->f_8[iVar0 /*40*/])->f_1, 4))
											{
												switch (func_48())
												{
													...
													else
													{
														...
														if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(uParam0->f_229[iVar0 /*27*/]))
														{
														}
														else
														{
			...
			if (MISC::IS_BIT_SET((uParam0->f_8[iVar0 /*40*/])->f_1, 3))
			{
				...
				else
				{
					...
					if (MISC::IS_BIT_SET((uParam0->f_8[iVar0 /*40*/])->f_1, 4))
					{
						...
						else if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(uParam0->f_8[iVar0 /*40*/]), 0))
						{
...
bool func_75(var uParam0)
{
	...
	if (bVar0)
	{
		...
		else if (CAM::IS_SCREEN_FADED_OUT())
		{
			...
			while (iVar7 < 2)
			{
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(uParam0->f_8[iVar7 /*40*/]), 0))
				{
...
int func_89(var uParam0)
{
	...
	PED::_UNRESERVE_AMBIENT_PEDS(iVar1);
	return 1;
}
...
int func_117(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_305, 0))
	{
		...
		PED::_RESERVE_AMBIENT_PEDS(iVar2);
			...
			if (&uParam0->f_89[iVar0 /*15*/] != 0 && STREAMING::IS_MODEL_VALID(&(uParam0->f_89[iVar0 /*15*/])))
			{
				...
				else
				{
					...
					else
					{
						...
						PED::SET_PED_LASSO_HOGTIE_FLAG((uParam0->f_89[iVar0 /*15*/])->f_1, 0, 0);
								...
								else
								{
									...
									else
									{
										...
										if (!MISC::IS_BIT_SET((uParam0->f_8[iVar0 /*40*/])->f_1, 1))
										{
											...
											else if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uParam0->f_8[iVar0 /*40*/]), 0, 0))
											{
											}
											else
											{
												if (*uParam0 != 4)
												{
													if (*uParam0 == 5)
													{
														...
														else
														{
															...
															{
																if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uParam0->f_8[iVar0 /*40*/]), (uParam0->f_8[iVar0 /*40*/])->f_11[iVar2 /*3*/]))
																{
																}
																else
																{
...
bool func_131(var uParam0)
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_297))
	{
...
bool func_149(var uParam0, int iParam1, int iParam2)
{
	...
	return PED::IS_PED_READY_TO_RENDER(&((uParam0->f_229[iParam1 /*27*/])->f_1[iParam2 /*6*/]));
}
...
int func_152(int iParam0, var uParam1, bool bParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_247(*uParam1, 2))
	{
		...
		else if ((func_251(bParam2, 128) && ENTITY::DOES_ENTITY_EXIST(PED::_0x4C8B59171957BCF7(iParam0))) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(PED::_0x4C8B59171957BCF7(iParam0))))
		{
...
int func_368(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_474(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_474(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
int func_380(bool bParam0, int iParam1)
{
	...
	iVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_474(0), &Var5, false);
	return iVar9;
}
...
struct<4> func_392(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_474(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_421(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_474(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_474(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_474(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_544(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_474(bParam1), bParam0, bParam3);
}
...
struct<25> func_551(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_474(bParam4), &uParam0, &Var25, 24, 1))
	{
		return Var0;
	}
