...
void __EntryFunction__()
{
	fLocal_16 = 1f;
	fLocal_17 = 1f;
	Local_21.f_3 = BRAIN::_GET_SCRIPT_BRAIN_ENTITY();
	...
	func_1();
	while (!func_2(1, 1) && (ENTITY::DOES_ENTITY_EXIST(Local_21.f_3) && BRAIN::_GET_SCRIPT_BRAIN_ENTITY() == Local_21.f_3))
	{
...
void func_5(var uParam0, int iParam1)
{
	...
	if (func_6(uParam0, 5))
	{
		...
		if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_18))
		{
		...
		if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar0))
		{
			...
			if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar6) && NETWORK::NETWORK_IS_PLAYER_CONNECTED(iVar6))
			{
				iVar7 = iVar0;
				iVar8 = iVar6;
	...
	else if (func_6(uParam0, 6))
	{
		...
		if (bVar9)
		{
			if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar0))
			{
				iVar10 = PLAYER::_GET_PLAYER_OWNER_OF_VEHICLE(uParam0->f_20);
				if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar10))
				{
					iVar10 = uParam0->f_19;
				}
				if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar10) && NETWORK::NETWORK_IS_PLAYER_CONNECTED(iVar10))
				{
					iVar11 = iVar0;
					iVar12 = iVar10;
	...
	if (func_6(uParam0, 7))
	{
		...
		{
			if (PLAYER::_GET_VEHICLE_OWNED_BY_PLAYER(iVar0) == uParam0->f_20)
			{
	...
	if (Global_1903928->f_485[95] && PLAYER::_GET_VEHICLE_OWNED_BY_PLAYER(iVar0) == uParam0->f_20)
	{
		if (bVar3)
		{
			SCRIPTS::TERMINATE_THIS_THREAD();
	...
	if (func_6(uParam0, 6))
	{
		...
		while (iVar13 < 4)
		{
			...
			else
			{
				...
				if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(&(uParam0->f_21[iVar13])))
				{
				}
	...
	if (func_6(uParam0, 5))
	{
		...
		func_22(uParam0, func_6(uParam0, 11));
		ENTITY::_SET_ENTITY_CARRYING_FLAG(uParam0->f_18, 33, true);
		if (func_6(uParam0, 11) || func_6(uParam0, 17))
		{
			iVar14 = AITRANSPORT::_GET_PED_IN_TRANSPORT_SEAT(uParam0->f_18, 0);
	...
	else
	{
		...
		if (func_6(uParam0, 11))
		{
			VEHICLE::_FADE_AND_DESTROY_VEHICLE(&(uParam0->f_20));
		}
		else
		{
...
void func_8(var uParam0, int* iParam1)
{
	...
	uParam0->f_19 = iVar3;
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(iParam1->f_7)))
	{
		func_7(uParam0, 1);
	}
	if (ENTITY::IS_ENTITY_A_PED(uParam0->f_3))
...
void func_10(var uParam0, int* iParam1)
{
	...
	if (iParam1->f_11 == Global_1268935->f_513.f_46)
	{
		PLAYER::_SET_PLAYER_OWNS_VEHICLE(PLAYER::PLAYER_ID(), uParam0->f_20);
		if (&Global_1903928->f_485[95])
		{
			BRAIN::_0xA6AC35DB4A7957A8(99999);
		}
...
void func_32(var uParam0, int iParam1, int iParam2)
{
	...
	VEHICLE::GET_DRAFT_ANIMAL_COUNT(uParam0->f_20, &iVar4, &iVar3);
	if (iVar4 == 0)
	{
		if (iVar3 == 0)
		{
		...
		while (iVar1 < iVar3)
		{
			...
			else
			{
				...
				else
				{
					...
					if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(&(uParam0->f_21[iVar2])) || !ENTITY::DOES_THREAD_OWN_THIS_ENTITY(&(uParam0->f_21[iVar2])))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(&(uParam0->f_21[iVar2]), true, true);
					}
					PED::SET_PED_OWNS_ANIMAL(PLAYER::GET_PLAYER_PED(iParam2), &(uParam0->f_21[iVar2]), 0);
...
void func_53(var uParam0)
{
	...
	iVar2 = PED::_GET_ACTIVE_ANIMAL_OWNER(uParam0->f_18);
	if (iVar2 == iVar1)
	{
		return;
	}
	PED::SET_PED_OWNS_ANIMAL(iVar1, uParam0->f_18, 0);
}
...
void func_58(var uParam0, int* iParam1)
{
	...
	if (func_6(uParam0, 2))
	{
		...
		else
		{
			...
			{
				ENTITY::_SET_ENTITY_CARRYING_FLAG(uParam0->f_18, 33, false);
			}
		}
	}
	else if (bVar1 || bVar0)
	...
	else
	{
		...
		if (iVar7 != 0)
		{
			if (func_125(uParam0, &uVar0))
			{
				if (!SCRIPTS::_0x72B2E00C9BAC6789(&(((*Global_1268274)[iVar5 /*20*/])->f_15), iVar6))
				{
					SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&(((*Global_1268274)[iVar5 /*20*/])->f_15), iVar6);
				}
			}
...
void func_61(var uParam0)
{
	...
	if (MAP::DOES_BLIP_EXIST(uParam0->f_16))
	{
		if (PAD::IS_CONTROL_PRESSED(0, joaat("INPUT_WHISTLE")))
		{
			...
			MAP::BLIP_REMOVE_MODIFIER(uParam0->f_16, -272772079);
			MAP::BLIP_ADD_MODIFIER(uParam0->f_16, -272772079);
		}
		...
		{
			MAP::BLIP_ADD_MODIFIER(uParam0->f_16, 430539302);
		}
		else
		{
			MAP::BLIP_REMOVE_MODIFIER(uParam0->f_16, 430539302);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			MAP::BLIP_REMOVE_MODIFIER(uParam0->f_16, 453356795);
			return;
		}
		...
		if (func_129(iVar1, 0))
		{
			MAP::BLIP_ADD_MODIFIER(uParam0->f_16, 453356795);
		}
		else
		{
			MAP::BLIP_REMOVE_MODIFIER(uParam0->f_16, 453356795);
	...
	uParam0->f_16 = MAP::BLIP_ADD_FOR_ENTITY(uParam0->f_17, uParam0->f_3);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1268935->f_11.f_457)))
	{
		MAP::_SET_BLIP_NAME(uParam0->f_16, &(Global_1268935->f_11.f_457));
	}
	else
	{
		MAP::SET_BLIP_NAME_FROM_TEXT_FILE(uParam0->f_16, func_130(uParam0->f_4));
	}
	MAP::BLIP_ADD_MODIFIER(uParam0->f_16, 580546400);
}
...
void func_63(var uParam0, int iParam1)
{
	...
	if (func_131(255) == 1)
	{
		if (func_51(16384, iParam1))
		{
			...
			{
				NETWORK::KEEP_NETWORK_ID_IN_FAST_INSTANCE(NETWORK::_0xF260AF6F43953316(uParam0->f_3), 1, 256);
				func_7(uParam0, 16);
			}
		...
		{
			NETWORK::KEEP_NETWORK_ID_IN_FAST_INSTANCE(NETWORK::_0xF260AF6F43953316(uParam0->f_3), 0, 256);
			func_39(uParam0, 16);
		}
	}
	else
...
void func_64(var uParam0, int iParam1)
{
	...
	{
		if (!PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 33, 1))
		{
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 33, 1, true);
			PED::SET_PED_CONFIG_FLAG(uParam0->f_18, 26, true);
		}
	}
	else if (PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 33, 1))
	{
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 33, 1, false);
		PED::SET_PED_CONFIG_FLAG(uParam0->f_18, 26, false);
	}
	if (&Global_1903928->f_485[61])
	{
		if (!PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 45, 1))
		{
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 45, 1, true);
		}
	}
	else if (PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 45, 1))
	{
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 45, 1, false);
	}
	if (&Global_1903928->f_485[62])
	{
		if (!PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 46, 1))
		{
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 46, 1, true);
		}
	}
	else if (PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 46, 1))
	{
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 46, 1, false);
	}
	if (&Global_1903928->f_485[63])
	{
		if (!PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 28, 1))
		{
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 28, 1, true);
		}
	}
	else if (PLAYER::GET_PLAYER_UI_PROMPT_FOR_PED_IS_ENABLED(iVar0, uParam0->f_18, 28, 1))
	{
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, uParam0->f_18, 28, 1, false);
	}
}
...
void func_65(var uParam0, int* iParam1, int iParam2)
{
	...
	AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(uParam0->f_3, 0, iVar2);
	iVar4 = 0;
	AITRANSPORT::_GET_TRANSPORT_USAGE_FLAGS(uParam0->f_3, &iVar3);
	...
	if (iVar4 != 0)
	{
		AITRANSPORT::_SET_TRANSPORT_USAGE_FLAGS(uParam0->f_3, iVar4);
	}
}
...
void func_66(var uParam0, int* iParam1, int iParam2)
{
	...
	{
		if (AITRANSPORT::_GET_PED_IN_TRANSPORT_SEAT(uParam0->f_18, -1) == PLAYER::PLAYER_PED_ID())
		{
...
void func_70(var uParam0)
{
	...
	iVar0 = PLAYER::_GET_PLAYER_OWNER_OF_VEHICLE(uParam0->f_20);
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar0))
	{
		func_39(uParam0, 19);
		return;
...
void func_89(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!bVar0)
	{
		ENTITY::_SET_ENTITY_CARRYING_FLAG(iParam0, 2, false);
		ENTITY::_SET_ENTITY_CARRYING_FLAG(iParam0, 27, true);
	}
...
int func_134(var uParam0, int* iParam1, int iParam2)
{
	...
	{
		if (_NAMESPACE26::NETWORK_GET_GANG_ID(iVar2) == _NAMESPACE26::NETWORK_GET_GANG_ID(iVar0))
		{
			return 0;
		}
	}
...
void func_147(var uParam0, var uParam1)
{
	...
	if (AITRANSPORT::_GET_PED_IN_TRANSPORT_SEAT(uParam0->f_18, -2) == func_210())
	{
		return;
	}
	func_135(uParam0->f_18);
...
void func_149(var uParam0, var uParam1)
{
	...
	{
		TASK::CLEAR_PED_TASKS(uParam0->f_18, 1, 0);
		if (ENTITY::DOES_ENTITY_EXIST(PED::_GET_ACTIVE_ANIMAL_OWNER(uParam0->f_18)))
		{
			FLOCK::_0xFF1E339CE40EAAAF(uParam0->f_18, 0);
		}
...
int func_194(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		if ((Global_1070355->f_20209[iParam0 /*18*/])->f_9 == 0)
		{
			...
			return ((func_232(&Global_1273882, iParam0) && PED::_IS_PED_VISIBILITY_TRACKED(iVar1)) && PED::_IS_TRACKED_PED_VISIBILITY_PERCENTAGE_NOT_LESS_THAN(iVar1, fVar2));
		}
...
void func_229(int iParam0)
{
	...
	while (bVar107 < iVar1)
	{
		if (!INVENTORY::_INVENTORY_GET_ITEM_FROM_COLLECTION_INDEX(iVar0, bVar107, &Var69))
		{
		}
...
int func_232(int iParam0, int iParam1)
{
	...
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(&(Global_1273882->f_154[iParam1])))
	{
		return 0;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_158(bParam4), sParam0, iParam3, bParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_158(bParam3), uParam0, bParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
