...
int func_198(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_256(bParam6), &Var1, bParam8);
	}
	else
	{
...
struct<4> func_230(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_256(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_249(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_256(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
{
	return func_229(bParam0) == joaat("horse");
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_256(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
