...
void func_30()
{
	if (MISC::IS_BIT_SET(iLocal_395, 4))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_545))
		{
			if (!bLocal_548)
			{
				iLocal_547 = ENTITY::PIN_CLOSEST_MAP_ENTITY(988533890, -561.1321f, -3694.189f, 81.9117f, 15);
				bLocal_548 = true;
			}
			else if (ENTITY::IS_MAP_ENTITY_PINNED(iLocal_547))
			{
				iLocal_545 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_GET_PINNED_MAP_ENTITY(iLocal_547));
		...
		case 0:
			switch (iLocal_390)
			{
				...
				case 3:
					...
					if (STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(iLocal_243, vLocal_234))
					{
						bVar0 = true;
					}
...
int func_78()
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_232, 1, 0) && !ANIMSCENE::_0x95531A4A20CCE7BC(iLocal_232, 0))
	{
	...
	switch (iLocal_400)
	{
		case 0:
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1070355->f_27136.f_19.f_4)))
			{
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_401))
				{
		...
		case 1:
			...
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_401, 1, 0) && bVar0)
			{
				func_193(0);
				CAM::DO_SCREEN_FADE_IN(0);
			...
			break;
		case 2:
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_401, 0))
			{
				CAM::DO_SCREEN_FADE_OUT(0);
				func_192(3);
			}
...
void func_113()
{
	...
	while (iVar0 <= 31)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_405[iVar0])))
		{
			...
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(&(uLocal_405[iVar0]), true, true);
		}
		if (ENTITY::DOES_ENTITY_EXIST(&(Global_1048684->f_22[iVar0 /*10*/])))
		{
			PED::DELETE_PED(Global_1048684->f_22[iVar0 /*10*/]);
...
void func_114(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar1 = _NAMESPACE26::NETWORK_GET_GANG_ID(iLocal_402);
...
int func_115()
{
	...
	if (func_202())
	{
		...
		if (bVar0)
		{
			if (iLocal_232 != -1)
			{
				if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_232, 0))
				{
...
int func_117()
{
	...
	fVar0 = ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_232);
	if (fVar0 > 0.92f)
	{
		return 1;
	}
	if (ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(iLocal_232) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(iLocal_232, 0))
	{
		return 1;
	}
...
void func_120()
{
	...
	if ((NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar0) && !MISC::IS_STRING_NULL_OR_EMPTY(Local_286[0 /*18*/])) && MISC::ARE_STRINGS_EQUAL(Local_286[0 /*18*/], sVar1))
	{
		...
		STATS::STAT_ID_INCREMENT_INT(&Var2, true);
...
void func_194(int iParam0, bool bParam1)
{
	if (MISC::IS_BIT_SET(iLocal_549, iParam0) || bParam1)
	{
		...
		HUD::_DISABLE_HUD_CONTEXT(func_256(iParam0));
	}
}
...
void func_261()
{
	...
	while (iVar0 <= (Global_1048684->f_376 - 1))
	{
		if (!PED::IS_PED_READY_TO_RENDER(&(uLocal_405[iVar0])) && ENTITY::DOES_ENTITY_EXIST(&(uLocal_405[iVar0])))
		{
			return;
		}
		iVar0++;
...
char* func_267(int iParam0)
{
	...
	return HUD::GET_TEXT_SUBSTRING_2(&cVar1, HUD::GET_LENGTH_OF_LITERAL_STRING(&cVar1));
}
...
{
	if (_NAMESPACE26::NETWORK_GET_GANG_ID(iParam0) != Global_1273882->f_15 && !func_367())
	{
		return 636925055;
	}
	return -963477619;
