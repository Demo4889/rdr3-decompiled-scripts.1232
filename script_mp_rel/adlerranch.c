...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_134(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
		if (func_45() == -1)
		{
...
void func_132(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_175(iParam0, 2))
	{
