		...
		if (MISC::GET_GAME_TIMER() > iLocal_29)
		{
			...
			switch (iLocal_28)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_30));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_30)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_30 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_30 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_13()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_22, iLocal_23);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_23, -2397.539f, -2380.358f, 63.54964f, 0f, 0f, 69.87277f, 10.05736f, 10.47319f, 16.92971f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2455.174f, -2384.14f, 35f, 0f, 0f, 25.5349f, 24.66208f, 30.76534f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2412.317f, -2374.972f, 63.25839f, 0f, 0f, -32.90815f, 13.07416f, 14.51878f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2432.721f, -2360.609f, 66.342f, 0f, 0f, -59.51217f, 44.12811f, 56.53022f, 19.75536f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2428.935f, -2393.028f, 64.86296f, 0f, 0f, 30.36721f, 35.19614f, 20.94381f, 14.33946f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2405.119f, -2471.914f, 63.25839f, 0f, 0f, 16.82132f, 13.84418f, 7.762568f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2418.961f, -2436.719f, 63.54964f, 0f, 0f, 22.63921f, 15.31493f, 15.94952f, 16.92971f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2407.512f, -2449.14f, 64.5022f, 0f, 0f, 48.91291f, 13.99343f, 21.49771f, 12.90299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2416.311f, -2452.443f, 64.20742f, 0f, 0f, 3.371748f, 14.65324f, 19.53584f, 12.77374f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2399.068f, -2464.15f, 64.86296f, 0f, 0f, 18.69488f, 16.30252f, 23.22957f, 14.33946f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2414.51f, -2467.064f, 61.83258f, 0f, 0f, -78.00346f, 14.14975f, 15.2253f, 17.07607f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_22, -2397.539f, -2380.358f, 63.54964f, 0f, 0f, 69.87277f, 10.05736f, 10.47319f, 16.92971f);
		iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacFarlanes' Ranch - m_volRancherWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_20, iLocal_22);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2407.745f, -2461.009f, 63.25839f, 0f, 0f, 21.61882f, 21.58509f, 25.8055f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2418.961f, -2436.719f, 63.54964f, 0f, 0f, 22.63921f, 19.83966f, 22.38591f, 16.92971f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2395.625f, -2381.142f, 35f, 0f, 0f, 29.59317f, 9.273087f, 11.13545f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2424.377f, -2394.976f, 35f, 0f, 0f, 122.1515f, 8.7505f, 40.19938f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2409.492f, -2351.147f, 35f, 0f, 0f, 29.59317f, 9.273087f, 29.27413f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2466.104f, -2392.814f, 35f, 0f, 0f, 29.59317f, 12.03543f, 28.7101f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2450.099f, -2347.51f, 35f, 0f, 0f, 122.1515f, 8.311909f, 37.10839f, 39.15789f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -2395.549f, -2409.981f, 35f, 0f, 0f, -2f, 115f, 87f, 50f);
		sLocal_19 = "MACFARLANES_RANCH";
		LAW::_CREATE_GUARD_ZONE(sLocal_19);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_19, iLocal_18);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_19, iLocal_21);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_19, iLocal_23);
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_19, iLocal_22);
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_19, iLocal_20);
...
void func_64()
{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar0) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar1) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			return;
		}
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar2) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			return;
		}
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar3) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			return;
		}
	}
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar4))
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar4) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			return;
		}
	}
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar5))
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar5) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
		}
		else if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar5) && !TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
...
int func_92(int iParam0, bool bParam1)
{
	...
	{
		func_127(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_126(iParam0)));
		if (func_45() == -1)
		{
			if (func_119(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_59(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_59(iParam0)))
	{
...
bool func_93(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_59(iParam0));
}
...
int func_120(int iParam0, bool bParam1)
{
	...
	func_152(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_59(iParam0));
	func_127(iParam0, 0);
	return 1;
}
...
void func_125(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_163(iParam0, 2))
	{
