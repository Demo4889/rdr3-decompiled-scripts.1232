...
void func_35(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	Var0.f_13 = _NAMESPACE26::NETWORK_GET_GANG_ID(uParam2->f_7);
...
void func_37(var uParam0, var uParam1)
{
	...
	{
		WEAPON::_HOLSTER_PED_WEAPONS(uParam0->f_7.f_2.f_9, 0, 0, 1, 0);
	}
}
...
int func_58(var uParam0)
{
	...
	if (!DATAFILE::PARSEDDATA_IS_FILE_LOADED(func_110()))
	{
		return 0;
	}
	*uParam0 = func_110();
...
struct<6> func_69(var uParam0, int iParam1)
{
	...
	while (iVar57 <= (iVar56 - 1))
	{
		...
		if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar59))
		{
		}
	...
	if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(uParam0->f_7.f_2.f_6))
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(uParam0->f_7.f_2.f_6))
		{
			...
			else
			{
				...
				if (_NAMESPACE26::_NETWORK_IS_IN_MY_GANG(uParam0->f_7.f_2.f_6))
				{
					func_72(&(uParam0->f_7.f_2.f_2), 64);
				}
...
int func_226(var uParam0, var uParam1)
{
	...
	BOUNTY::BOUNTY_GET_BOUNTY_ON_PLAYER(&Var0, &iVar7);
...
void func_229(var uParam0, var uParam1, int iParam2)
{
	...
	_NAMESPACE71::UI_FEED_CLEAR_HELP_TEXT_FEED(iVar0, 0);
...
int func_233(var uParam0, var uParam1)
{
	...
	iVar0 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(uParam0->f_7));
...
void func_234(var uParam0, var uParam1)
{
	...
	if (_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(iVar1)) != iVar1)
	{
		return;
	}
...
int func_254(var uParam0, var uParam1, int iParam2)
{
	...
	WEAPON::_HOLSTER_PED_WEAPONS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 0, 0, 0);
...
int func_264(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_414(uParam0))
	{
		TELEMETRY::TELEMETRY_SHOP_ENTRY(func_415(25), func_417(func_416(uParam1)), func_419(func_418(), 0), Global_36);
...
void func_354(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_486(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))))
	{
...
void func_363(var uParam0, var uParam1, int iParam2)
{
	...
	iVar4 = (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(iVar3) - 1);
...
int func_435(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	iVar6 = 0;
	iVar7 = 0;
	if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar108))
	{
...
void func_504(int iParam0, int iParam1)
{
	...
	if (MAP::BLIP_ADD_MODIFIER(iVar0, iParam1))
	{
	}
}
...
void func_577(var uParam0, var uParam1, int iParam2)
{
	...
	if (_NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) >= iVar1)
	{
		return;
	}
	iVar2 = func_307(uParam0, uParam1, iVar0);
...
int func_608(var uParam0, int iParam1, int iParam2)
{
	...
	uVar354 = 3;
	func_628(&uVar8, 62, 1);
	iVar360 = _NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
...
int func_676(int iParam0, var uParam1, int iParam2, vector3 vParam3, bool bParam6, bool bParam7, int iParam8, float fParam9)
{
	...
	if (func_808(iParam2))
	{
		iVar11 = func_809(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())));
		if (!func_810(iVar11))
		{
			return 13;
		}
...
bool func_690()
{
	return func_857(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
}
...
struct<4> func_747(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_822(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_844(bool bParam0, int iParam1)
{
	...
	iVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_822(0), &Var5, false);
	return iVar9;
}
...
int func_845(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_822(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
{
	return _NAMESPACE26::NETWORK_GET_NUM_GANG_MEMBERS(iParam0) > 4;
}
...
int func_921(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_822(bParam6), &Var1, bParam8);
	}
	else
	{
...
{
	return func_746(bParam0) == joaat("weapon");
}
...
struct<28> func_1046(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	Var28.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_822(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<25> func_1048(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_822(bParam4), &uParam0, &Var25, 24, 1))
	{
		return Var0;
	}
...
struct<17> func_1050(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_822(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_822(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_822(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
