			...
			switch (func_19(&Var0))
			{
				...
				case 7:
					if (func_28(Global_1273882->f_8) && (ENTITY::HAS_ANIM_EVENT_FIRED(Global_1273882->f_8, 174961811) || (Global_1184669->f_1 && func_29(Var0.f_18))))
					{
						...
						if (TASK::DOES_SCENARIO_POINT_EXIST(Global_1184669->f_2))
						{
...
int func_23(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_29(iParam1) && TASK::DOES_SCENARIO_POINT_EXIST(iParam2))
	{
	...
	if (iLocal_18 < 4)
	{
		if (!func_52(*(vLocal_26[iLocal_18 /*3*/])))
		{
			if (!&Global_1915117)
			{
				...
				{
					uParam0->f_28[iLocal_18] = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(*(vLocal_26[iLocal_18 /*3*/]), 0.37f, 4, 27, 0);
				}
				if (uParam0->f_18 == 38)
				{
...
int func_42(var uParam0, var uParam1, bool bParam2, var uParam3)
{
	switch (*uParam0)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(*uParam1, 1, 0) && ANIMSCENE::_0x95531A4A20CCE7BC(*uParam1, 0))
			{
			...
			break;
		case 5:
			if ((!ANIMSCENE::IS_ANIM_SCENE_RUNNING(*uParam1, 0) || PED::IS_PED_FALLING(Global_35)) || ENTITY::IS_ENTITY_IN_WATER(Global_35))
			{
				if (PED::IS_PED_MALE(Global_35))
				{
...
int func_148(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_216(bParam2), bParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_216(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_216(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_216(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_256(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_216(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
int func_298(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_216(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_216(bParam6), bParam0, iParam8);
	}
	return iVar0;
}
...
int func_313(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_216(bParam1), bParam0, iParam3);
}
