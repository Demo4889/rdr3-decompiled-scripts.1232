...
struct<4> func_63(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_93(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_93(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_78(bool bParam0)
{
	...
	if (!WEAPON::_0x705BE297EEBDB95D(bParam0) && !WEAPON::IS_WEAPON_BOW(bParam0))
	{
		return 0;
	}
	return 1;
...
int func_96(int iParam0)
{
	...
	Var0.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_93(0), iParam0, &Var0, 22, 1))
	{
		return 2;
	}
	iVar22 = Var0.f_14;
...
int func_105(bool bParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_93(1), bParam0, false) > 1)
	{
...
int func_137(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_93(bParam1), bParam0, bParam3);
}
...
int func_153(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_93(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_93(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
