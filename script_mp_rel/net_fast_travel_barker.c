...
void func_4(var uParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_23))
	{
		VOLUME::DELETE_VOLUME(uParam0->f_23);
	}
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_24))
	{
		PATHFIND::REMOVE_NAVMESH_BLOCKING_VOLUME(uParam0->f_24);
		VOLUME::DELETE_VOLUME(uParam0->f_24);
	}
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_25))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(uParam0->f_25);
		VOLUME::DELETE_VOLUME(uParam0->f_25);
	}
...
void func_10(var uParam0)
{
	...
	{
		iVar1 = func_25(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
		if (iVar1 >= 0)
		{
	...
	PATHFIND::_ADD_NAVMESH_BLOCKING_VOLUME(uParam0->f_24, 7);
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(uParam0->f_25, 2238463, 0, 0, -1, -1, 0);
	uParam0->f_26 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE((Global_1070355->f_22101.f_366[uParam0->f_4 /*272*/])->f_2, 1f, 1, 4, 0);
	uParam0->f_20 = -1;
	func_30(uParam0, 4);
	func_30(uParam0, 2);
	func_30(uParam0, 8);
...
void func_11(var uParam0)
{
	...
	{
		if (!VOLUME::IS_POINT_IN_VOLUME(uParam0->f_23, ENTITY::GET_ENTITY_COORDS(iVar1, false, true)))
		{
			func_18();
		}
	}
	...
	else if (PED::IS_PED_INCAPACITATED(iVar1))
	{
	...
	else if (PED::IS_PED_CARRYING_SOMETHING(iVar1))
	{
...
void func_13(var uParam0)
{
	...
	{
		iVar2 = func_25(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
...
int func_65(int iParam0, bool bParam1)
{
	...
	if (iParam0 == 14)
	{
		if (!func_25(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) >= 0)
		{
			return 5;
		}
	}
...
void func_186(var uParam0)
{
	...
	else if (!func_25(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())) >= 0)
	{
		bVar19 = false;
	}
	if (func_60(func_64(0, uParam0), &bVar21))
...
int func_207(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_204(bParam4), bParam0, bParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
struct<4> func_209(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_204(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_210(bool bParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_204(bParam6), uParam1, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_204(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_310(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_204(bParam1), bParam0, bParam3);
}
