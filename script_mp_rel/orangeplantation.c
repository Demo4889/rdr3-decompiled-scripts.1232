		...
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				...
				case 2:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_33));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_33)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_33 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1887327)[iLocal_33 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_13()
{
	...
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 69.6883f, 50.95198f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 49.04269f, 28.47917f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583631f, 30.73095f, 51.93652f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76538f, 38.38671f, 59.01843f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 38.38671f, 37.38729f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 11.55689f, 14.41201f, 15.9332f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644386f, 138.1747f, 21.08713f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 8.372574f, 17.93935f, 18.54283f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_13, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 15.22373f, 31.89837f, 18.54283f);
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2065.472f, -851.4658f, 42.55719f, 0f, 0f, 0f, 19.02366f, 13.64085f, 16.67954f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2019.272f, -774.1213f, 41.40026f, 0f, 0f, 37.13808f, 9.83179f, 10.20259f, 16.67954f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2013.173f, -774.8469f, 41.40026f, 0f, 0f, 37.13808f, 4.350712f, 4.302257f, 16.67954f);
		iLocal_14 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volRestricted Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_14, iLocal_16);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 36.89741f, 35.70032f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76539f, 36.89741f, 57.33146f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 10.22549f, 13.5511f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 1998.531f, -853.2407f, 44.706f, 0f, 0f, 0f, 45.40543f, 35.23671f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 6.372574f, 15.93935f, 16.54283f);
		iLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_15, iLocal_14);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 68.19901f, 49.26501f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583632f, 29.24165f, 50.24955f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 47.55339f, 26.7922f, 15.9332f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644384f, 136.6854f, 19.40016f, 15.9332f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 13.22373f, 29.89837f, 16.54283f);
		sLocal_17 = "ORANGE_PLANTATION";
		LAW::_CREATE_GUARD_ZONE(sLocal_17);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_17, iLocal_13);
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_17, iLocal_14);
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_17, iLocal_15);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_17, iLocal_16);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_17, 2066.902f, -851.1766f, 43.3946f);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_17, iLocal_13);
	}
	return 1;
}
...
int func_89(int iParam0, bool bParam1)
{
	...
	{
		func_125(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_124(iParam0)));
		if (func_45() == -1)
		{
			if (func_117(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_92(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_92(iParam0)))
	{
...
int func_118(int iParam0, bool bParam1)
{
	...
	func_150(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_92(iParam0));
	func_125(iParam0, 0);
	return 1;
}
...
void func_123(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_161(iParam0, 2))
	{
