...
void __EntryFunction__()
{
	...
	func_5(&Global_26385);
	func_6();
	while ((!SCRIPTS::IS_THREAD_EXIT_REQUESTED() && !func_7(Global_26385)) && !bVar25)
	{
		func_8(&Local_23);
		func_9(&Local_23);
		func_10();
...
struct<4> func_19(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		Var29 = { func_71() };
		if (func_72() && INVENTORY::_INVENTORY_IS_GUID_VALID(&Var29))
		{
			Var0 = { Var29 };
		}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_194(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_194(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_242(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_194(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_255()
{
	...
	while (bVar16 < iVar0)
	{
		if (!INVENTORY::_INVENTORY_GET_ITEM_FROM_COLLECTION_INDEX(iVar1, bVar16, &Var2))
		{
		}
