...
int func_97(var uParam0)
{
	...
	switch (iLocal_59)
	{
		case 0:
			...
			{
				iLocal_59 = 1;
				PED::_GIVE_PED_SCENARIO_PROP(func_9(uParam0, iLocal_15), (uParam0->f_1711[iLocal_21 /*15*/])->f_10, "p_stickFirePoker01x_PH_R_HAND", "WORLD_CAMP_JACK_POKE_GROUND_STICK", 0, 1);
		...
		case 3:
			...
			if (func_209(uParam0))
			{
				...
				(uParam0->f_1711[iLocal_21 /*15*/])->f_10 = PED::_GET_PED_REGISTER_PROP(func_9(uParam0, iLocal_15), "p_stickFirePoker01x_PH_R_HAND", 1);
		...
		case 4:
			if (func_207(uParam0, iLocal_18))
			{
				...
				PED::_GIVE_PED_SCENARIO_PROP(func_9(uParam0, iLocal_15), func_210(uParam0, iLocal_21), "p_stickFirePoker01x_PH_R_HAND", "WORLD_CAMP_JACK_POKE_GROUND_STICK", 0, 1);
...
int func_368(int iParam0, bool bParam1)
{
	...
	{
		func_255(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_137(iParam0)));
		if (func_243() == -1)
		{
