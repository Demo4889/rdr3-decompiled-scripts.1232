...
int func_48(int iParam0, bool bParam1)
{
	...
	{
		func_96(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_95(iParam0)));
		if (func_24() == -1)
		{
			if (func_94(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_97(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_97(iParam0)))
	{
		func_98(iParam0, 128);
		return 1;
	}
...
int func_188(int iParam0, bool bParam1)
{
	...
	func_98(iParam0, 129);
	func_186(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_97(iParam0));
	func_96(iParam0, 0);
	return 1;
}
