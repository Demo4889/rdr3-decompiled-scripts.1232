...
void func_9(var uParam0)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_19))
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_19);
	}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_125(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_125(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_126(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_126(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_82(uParam0);
...
int func_55(var uParam0)
{
	...
	if (((((((((((((((((((((((*uParam0 == -777592153 || *uParam0 == 2072069278) || *uParam0 == 1342653896) || *uParam0 == 425000526) || *uParam0 == 1937333853) || *uParam0 == -1300082860) || *uParam0 == -1636964661) || *uParam0 == 149709049) || *uParam0 == -1568839185) || *uParam0 == -641229542) || *uParam0 == 1673499939) || *uParam0 == -1177787273) || *uParam0 == -1841331114) || *uParam0 == 949011950) || *uParam0 == -1287911066) || *uParam0 == 429544447) || *uParam0 == -2060865802) || *uParam0 == -739986731) || *uParam0 == -2108030724) || *uParam0 == 1187917501) || *uParam0 == -1887999095) || *uParam0 == -2009137002) || *uParam0 == -1829339703) || *uParam0 == -1240932004)
	{
		...
		else if (*uParam0 == 429544447)
		{
			...
			{
				iLocal_22 = MAP::BLIP_ADD_FOR_COORDS(-773443467, func_80(uParam0, 0));
			}
		}
		else if (!ENTITY::IS_ENTITY_DEAD(&(uLocal_67[0])))
		{
	...
	while (iVar0 <= (10 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(Local_44.f_1[iVar0])))
		{
			...
			PED::SET_PED_LASSO_HOGTIE_FLAG(&(Local_44.f_1[iVar0]), 1, 0);
		}
		iVar0++;
	}
...
int func_68(var uParam0)
{
	...
	switch (iLocal_80)
	{
		...
		case 3:
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_27[1])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_27[1]), 1, 0))
			{
...
void func_71(var uParam0)
{
	...
	if ((((*uParam0 == -1824429070 || *uParam0 == -1841331114) || *uParam0 == 949011950) || *uParam0 == 1187917501) || *uParam0 == -1829339703)
	{
		if (!func_48(*uParam0))
		{
			...
			_NAMESPACE49::PERSISTENCE_REMOVE_ALL_ENTITIES_IN_AREA(func_80(uParam0, 0), 10f);
		}
	}
}
...
void func_82(var uParam0)
{
	...
	if (func_284(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_284(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_87(var uParam0)
{
	...
	switch (iLocal_80)
	{
		...
		case 3:
			...
			{
				func_96(&iLocal_22);
				ENTITY::_SET_ENTITY_CARRYING_FLAG(&(Local_44.f_1[0]), 10, 1);
...
int func_203(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_327(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_389(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_327(bParam1), iParam0, 0);
}
...
int func_391(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_327(bParam4), iParam0, 0);
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_327(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_556(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_327(bParam6), &Var0, 0);
	return uVar4;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_327(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_758(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_327(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_327(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_327(0), 1623931083, 0);
	}
	return 0;
}
