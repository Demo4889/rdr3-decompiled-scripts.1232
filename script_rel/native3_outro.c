...
int func_11(var uParam0)
{
	...
	{
		if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(&(iLocal_259[iVar0])))
		{
...
int func_23(var uParam0)
{
	...
	if (!func_26(iLocal_4, 64))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PED::GET_MOUNT(Global_35)))
		{
			...
			{
				PED::_SET_PED_MOTIVATION(PED::GET_MOUNT(Global_35), 0, 0f, 0);
	...
	switch (iLocal_3)
	{
		...
		case 1:
			CLOCK::SET_CLOCK_TIME(5, 40, 0);
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0))
			{
				if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_2, 1, 0))
				{
					if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_2, "pbl_ig19_coughing_exitlt") && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_2, "pbl_ig19_coughing_exitrt"))
					{
		...
		case 2:
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2))
			{
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0))
				{
			...
			break;
		case 3:
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_255) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_255, 1, 0))
			{
				CAM::DO_SCREEN_FADE_OUT(0);
		...
		case 4:
			CLOCK::SET_CLOCK_TIME(9, 0, 0);
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_255) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_255, 0))
			{
		...
		case 8:
			...
			if (!func_26(iLocal_4, 128))
			{
				if (func_56(&Local_13))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_13.f_156, 0) && ANIMSCENE::GET_ANIM_SCENE_PHASE(Local_13.f_156) >= 0.55f)
					{
						func_52(&Local_13, 1);
						MISC::_0x59174F1AFE095B5A(1500834021, true, true, false, 0f, false);
...
int func_58(char* sParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_105(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, 0)) && (ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156) || func_83(uParam4, 512)))
			{
		...
		if ((iParam1 || !func_70(iParam0)) || func_71(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_135(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_137(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_138(iParam0, 0));
...
{
	if ((!func_83(uParam0, 32768) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156)) && ANIMSCENE::_0x95531A4A20CCE7BC(uParam0->f_156, 0))
	{
		func_161(uParam0);
		func_162(uParam0, 0);
...
void func_106(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, 0)) || ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam0->f_156)) || func_83(uParam0, 512))
	{
		if (!func_128(uParam0->f_213, 128))
		{
			func_130();
...
bool func_181()
{
	return func_225(_NAMESPACE71::UI_FEED_GET_CURRENT_MESSAGE(3));
}
...
struct<4> func_278(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_280(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_279(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_280(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_319(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_280(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_339(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_365("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_364(uParam1, 16))) && (!WEAPON::_0x6AD66548840472E5(Var4.f_4) || func_364(uParam1, 4))) && (!func_367(Var4.f_4) || func_364(uParam1, 8)))
				{
...
int func_342(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_280(bParam1), iParam0, 0);
}
...
int func_360(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_280(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_280(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
