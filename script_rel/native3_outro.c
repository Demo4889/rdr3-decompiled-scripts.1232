	...
	switch (iLocal_3)
	{
		...
		case 8:
			...
			if (!func_26(iLocal_4, 128))
			{
				if (func_56(&Local_13))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_13.f_156, 0) && ANIMSCENE::_0x3FBC3F51BF12DFBF(Local_13.f_156) >= 0.55f)
					{
						func_52(&Local_13, 1);
						MISC::_0x59174F1AFE095B5A(1500834021, true, true, false, 0f, false);
...
int func_58(char* sParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_105(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, 0)) && (ANIMSCENE::_0xEF324E9550A394D5(uParam4->f_156) || func_83(uParam4, 512)))
			{
...
void func_106(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, 0)) || ANIMSCENE::_0xEF324E9550A394D5(uParam0->f_156)) || func_83(uParam0, 512))
	{
		if (!func_128(uParam0->f_213, 128))
		{
			func_130();
