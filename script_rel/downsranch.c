...
int func_59(int iParam0)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_56(iParam0)))
	{
		return 0;
	}
	if (NETWORK::NETWORK_IS_IN_SESSION())
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_56(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_56(iParam0));
	...
	_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_56(iParam0));
	return 1;
}
...
int func_95(int iParam0, bool bParam1)
{
	...
	{
		func_139(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_99(iParam0)));
		if (func_20() == -1)
		{
			if (func_136(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_56(iParam0));
...
bool func_96(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_56(iParam0));
}
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_167(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_56(iParam0));
	func_139(iParam0, 0);
	return 1;
}
