...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_71(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_71(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_72(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_72(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_73(uParam0);
...
void func_73(var uParam0)
{
	...
	if (func_111(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_111(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_150(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_116(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_116(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_116(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
