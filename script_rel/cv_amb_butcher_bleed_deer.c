	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_267((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
void func_187(var uParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_49(uParam0, iParam1)))
	{
		...
		ENTITY::_SET_ENTITY_CARRYING_FLAG(func_49(uParam0, iParam1), 7, 0);
...
int func_327(int iParam0, bool bParam1)
{
	...
	{
		func_232(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
		if (func_220() == -1)
		{
