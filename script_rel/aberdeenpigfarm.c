		...
		if (MISC::GET_GAME_TIMER() > iLocal_23)
		{
			...
			switch (iLocal_22)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_24));
				...
				case 6:
					if (func_7(func_6(iLocal_24)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_24 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_24 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_63()
{
	...
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_17))
		{
			TASK::DELETE_SCENARIO_POINT(uLocal_17);
			func_117(0);
		}
		func_118(&uLocal_18);
		iLocal_16 = 0;
...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_164(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_163(iParam0)));
		if (func_20() == -1)
		{
