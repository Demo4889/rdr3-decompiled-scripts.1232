			...
			else if (*uParam0 == 2135153015)
			{
				if (!func_39(Global_40.f_8863.f_149, 1024))
				{
					if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_66[0])) && PED::_0x09B83E68DE004CD4(&(uLocal_66[0])) == Global_35)
					{
						...
						func_73(func_72(uParam0), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						if (TASK::DOES_SCENARIO_POINT_EXIST(&(iLocal_47[0])) && !TASK::_0x0CC36D4156006509(&(iLocal_47[0])))
						{
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_123(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_123(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_124(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_124(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_91(uParam0);
...
void func_91(var uParam0)
{
	...
	if (func_268(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_268(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_182(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_300(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_328(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_300(bParam1), iParam0, 0);
}
...
int func_330(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_300(bParam4), iParam0, 0);
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_300(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_300(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_441(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_300(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_479(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_300(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_655(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_300(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_300(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_300(0), 1623931083, 0);
	}
	return 0;
}
