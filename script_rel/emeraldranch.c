		...
		if (MISC::GET_GAME_TIMER() > iLocal_221)
		{
			...
			switch (iLocal_220)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_222));
				...
				case 6:
					if (func_7(func_6(iLocal_222)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_222 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_222 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_27(int iParam0)
{
	...
	if (func_59())
	{
		_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(1443812975, "EmeraldRanch/Emr_Son1");
...
void func_66()
{
	...
	{
		_NAMESPACE71::UI_FEED_CLEAR_HELP_TEXT_FEED(Global_1415412->f_2, 1);
...
int func_104(int iParam0, bool bParam1)
{
	...
	{
		func_205(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_204(iParam0)));
		if (func_20() == -1)
		{
