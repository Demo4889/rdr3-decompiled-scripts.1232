...
void func_69(int iParam0)
{
	switch (iParam0->f_1)
	{
		...
		case 1:
			...
			PED::SET_PED_LASSO_HOGTIE_FLAG(iParam0->f_3, 0, 0);
...
void func_99(var uParam0)
{
	...
	if (func_159(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_159(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_205(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_164(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_164(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_164(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
