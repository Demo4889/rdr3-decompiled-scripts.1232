...
void func_9(var uParam0)
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_15);
	}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_119(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_119(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_120(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_120(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_69(uParam0);
...
void func_69(var uParam0)
{
	...
	if (func_177(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_177(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
	...
	switch (iLocal_65)
	{
		...
		case 1:
			if (func_48(Global_35, func_76(uParam0, 0), 75f, 1, 1))
			{
				...
				{
					if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_15) && !TASK::_0x0CC36D4156006509(iLocal_15))
					{
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_240(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_240(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
void func_490(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_511(func_510(255), 109029619));
	}
	else if (func_121())
	{
...
int func_506(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_240(bParam6), &Var0, 0);
	return uVar4;
}
...
struct<28> func_514(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_240(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_507(&Var28) };
...
struct<17> func_516(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_240(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_507(&Var17) };
