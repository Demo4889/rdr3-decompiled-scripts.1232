				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					...
					if (*uParam0 == 71)
					{
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
						{
							...
							PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), &(uParam0->f_20[0 /*14*/]), 5, 0, 1);
							PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), &(uParam0->f_20[0 /*14*/]), 27, 0, 1);
							PED::SET_PED_LASSO_HOGTIE_FLAG(&(uParam0->f_20[0 /*14*/]), 0, 0);
						}
					}
