	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if ((uParam0->f_107[iVar0 /*113*/])->f_8 == 3)
			{
				...
				{
					TASK::DELETE_SCENARIO_POINT((uParam0->f_107[iVar0 /*113*/])->f_8.f_23);
				}
			}
			if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_1 == 3)
			{
				...
				{
					TASK::DELETE_SCENARIO_POINT((uParam0->f_107[iVar0 /*113*/])->f_32.f_21);
				}
			}
...
void func_17(var uParam0)
{
	...
	while (iVar0 < uParam0->f_36)
	{
		...
		else
		{
			...
			{
				POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(&(uParam0->f_36[iVar0 /*5*/]));
			}
			if (PED::IS_SCENARIO_BLOCKING_AREA_VALID((uParam0->f_36[iVar0 /*5*/])->f_4))
			{
		...
		else
		{
			if ((uParam0->f_107[iVar1 /*113*/])->f_8 == 3)
			{
				if (TASK::DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iVar1 /*113*/])->f_8.f_23))
				{
					...
					{
						TASK::DELETE_SCENARIO_POINT((uParam0->f_107[iVar1 /*113*/])->f_8.f_23);
					}
					else
					{
						iVar0 = 0;
			...
			if ((uParam0->f_107[iVar1 /*113*/])->f_32.f_1 == 3)
			{
				if (TASK::DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iVar1 /*113*/])->f_32.f_21))
				{
					...
					{
						TASK::DELETE_SCENARIO_POINT((uParam0->f_107[iVar1 /*113*/])->f_32.f_21);
					}
					else
					{
						iVar0 = 0;
...
void func_108(var uParam0, var uParam1)
{
	...
	if (TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1))
	{
		...
		if ((iParam1 || !func_121(iParam0)) || func_59(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_254(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_256(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_257(iParam0, 0));
...
int func_151(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_150(iParam0)))
	{
		return 1;
	}
	...
	func_147(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_150(iParam0));
	func_278(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_314((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_255((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
bool func_189(var uParam0, var uParam1)
{
	...
	if (fVar1 > 0f)
	{
		if (!PED::_0x50F124E6EF188B22(iVar0) || PED::_0x6FB76442469ABD68(iVar0) < (fVar1 - 0.25f))
		{
			...
			{
				if (!TASK::IS_PED_EXITING_SCENARIO(iVar0, 0))
				{
			...
			PED::_SET_PED_DRUNKNESS(iVar0, 1, fVar1);
		}
...
void func_196(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else if (TASK::IS_PED_ACTIVE_IN_SCENARIO((uParam0->f_107[iVar0 /*113*/])->f_5, 1) || TASK::IS_PED_EXITING_SCENARIO((uParam0->f_107[iVar0 /*113*/])->f_5, 1))
		{
			if (TASK::DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iVar0 /*113*/])->f_8.f_23))
			{
				if (PED::IS_PED_USING_THIS_SCENARIO((uParam0->f_107[iVar0 /*113*/])->f_5, (uParam0->f_107[iVar0 /*113*/])->f_8.f_23))
...
int func_198(var uParam0, float fParam1)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				(uParam0->f_107[iVar0 /*113*/])->f_101 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iVar0 /*113*/])->f_5, true, false), 0f, 0f, 0f, fVar1, fVar1, fParam1);
				if (!VOLUME::DOES_VOLUME_EXIST((uParam0->f_107[iVar0 /*113*/])->f_101))
				{
				}
				else
		...
		else
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY((uParam0->f_1711[iVar0 /*15*/])->f_13))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar2))
				{
					...
					{
						(uParam0->f_1711[iVar0 /*15*/])->f_10 = PED::_GET_PED_REGISTER_PROP(iVar2, (uParam0->f_1711[iVar0 /*15*/])->f_13, 1);
					}
				}
			}
...
int func_222(var uParam0, int iParam1)
{
	...
	if (ANIMSCENE::HAS_ANIM_SCENE_EXITED(iVar0, 0))
	{
		return 1;
	}
	return 0;
...
void func_233(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (!func_363())
	{
		func_364(iParam0, iParam1, bParam2, iParam4);
		return;
	}
	bVar0 = false;
	...
	else if (!func_368(iParam0, &Var7, iVar11, iVar10, 0, -401018458))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_371(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
...
void func_247(bool bParam0)
{
	...
	PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iVar0, 50, 2, bParam0);
	PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iVar0, 49, 2, bParam0);
	PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iVar0, 11, 2, bParam0);
	PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iVar0, 5, 2, bParam0);
	PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iVar0, 33, 2, bParam0);
...
int func_309(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1984)
	{
		...
		else if (ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uParam0->f_1984[iVar1]), 1, 0))
		{
		}
		else
		{
...
int func_310(var uParam0)
{
	...
	while (iVar8 < uParam0->f_2051)
	{
		...
		else
		{
			...
			{
				if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iVar6, 1, 0))
				{
					return 0;
				}
				if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iVar6, &Var2))
				{
				}
				else
				{
					iVar0 = 0;
					if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iVar6, &Var2))
					{
					}
...
int func_335(int iParam0, struct<8> Param1, int iParam9)
{
	...
	if (iVar0 != 0 && func_497(iParam0))
	{
		...
		_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(iVar0, &Param1);
...
void func_351(int iParam0, float fParam1)
{
	...
	PED::_SET_PED_DRUNKNESS(iVar0, 1, fParam1);
}
...
void func_352(var uParam0, var uParam1)
{
	...
	else if (TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1))
	{
		TASK::_0x541E5B41DCA45828(Global_35, 1, 1);
	}
	...
	switch (uParam1->f_47.f_1)
	{
		...
		case 1:
			if (func_514(&(uParam1->f_47.f_4)) >= 500)
			{
				...
				{
					if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2046, 0))
					{
...
int func_360(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_528(bParam1), iParam0, 0);
}
...
int func_376(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_528(bParam2), iParam0, 0);
	return iVar2;
}
...
void func_405(int iParam0)
{
	...
	if ((iParam0 == -615217896 && !func_574()) || iParam0 != -615217896)
	{
...
int func_426(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9)
{
	struct<5> Var0;
	int iVar5;
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (iParam8 && iParam1 != &Global_1946804->f_57[func_614(iParam3, 1) /*11*/])
			{
				func_617(31, 0, 0, 0, 0);
			}
			break;
...
void func_447(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == -1623728698 && func_632(81053684, 0) <= 0)
			{
...
void func_452(int iParam0, char* sParam1)
{
	...
	func_372(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_646(iParam0), 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_464()
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) || func_662(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_484(int iParam0, bool bParam1)
{
	...
	{
		func_278(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_148(iParam0)));
		if (func_266() == -1)
		{
			if (func_144(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_150(iParam0));
...
void func_532(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4)
{
	int iVar0;

	if (func_367(iParam0) != -427144552)
	{
		return;
	}
	...
	if (iParam2 || !func_564(iVar0))
	{
		...
		if (iParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_376(iParam0, 0, 0) == 0))
		{
...
int func_535(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_530(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_524(iParam0, &Var4, 1728382685))
			{
				return 0;
			}
			if (func_522(iParam0, 1))
			{
				if (!func_523(iParam0, &Var0, -649335959, 0))
				{
					return 0;
				}
				else if (func_524(iParam0, &Var4, -649335959))
				{
					return 0;
				}
			}
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_528(bParam4), iParam0, 0);
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_528(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_699(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_528(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_701(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	struct<37> Var0;
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_528(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_780(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_873(0);
	if (iParam2 != 0 && func_874(iParam0, uVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_255(iParam0, 1), &sVar4);
				}
...
void func_840(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_931(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_931(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_841(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_150(iParam0));
}
...
int func_904(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_255(iParam0, 1));
...
void func_906(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_272(iParam1), iParam0, 0);
...
int func_936(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_528(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_528(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_528(0), 1623931083, 0);
	}
	return 0;
}
