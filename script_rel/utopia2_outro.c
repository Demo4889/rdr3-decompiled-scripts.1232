...
int func_22(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uLocal_5[0])))
	{
		...
		{
			TASK::_TASK_MOVE_IN_TRAFFIC_4(&(uLocal_5[0]), 1.75f, VOLUME::GET_VOLUME_COORDS(&(iLocal_3[0])), 0);
		}
	}
	func_21();
	return 1;
			...
			switch (iLocal_17)
			{
				case 0:
					if (func_46(&uLocal_14) >= 8f)
					{
						...
						if (VOLUME::DOES_VOLUME_EXIST(&(iLocal_3[0])))
						{
							TASK::_TASK_MOVE_IN_TRAFFIC_4(&(uLocal_5[0]), 2.5f, VOLUME::GET_VOLUME_COORDS(&(iLocal_3[0])), 0);
						}
						func_45(&uLocal_14);
						func_48(&iLocal_17, 1);
					}
...
int func_168(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_171(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_177(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_171(bParam1), iParam0, 0);
}
