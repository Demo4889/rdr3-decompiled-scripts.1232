...
void func_1()
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(Local_14.f_7);
	}
...
int func_11(var uParam0)
{
	...
	if ((((uParam0->f_9 != 854119837 && uParam0->f_9 != -335460405) && uParam0->f_9 != 1809565830) && uParam0->f_9 != -628873767) && !TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_7))
	{
		switch (uParam0->f_9)
		{
			case -1292544588:
		...
		{
			uParam0->f_7 = TASK::_0xF533D68FF970D190(TASK::_GET_SCENARIO_POINT_COORDS(uParam0->f_6, 1), 202274149, 1.5f, 0, 0);
		}
		else
		{
			vVar1 = { TASK::_GET_SCENARIO_POINT_COORDS(uParam0->f_6, 1) };
			uParam0->f_7 = TASK::CREATE_SCENARIO_POINT(iVar18, vVar1, TASK::_GET_SCENARIO_POINT_HEADING(uParam0->f_6, 1), 0f, 0f, 0);
		}
		iVar0 = 0;
	}
	func_14(uParam0, 0);
	...
	else if (uParam0->f_9 == 1809565830 && func_13(uParam0->f_9))
	{
		...
		{
			uParam0->f_8 = func_50(MISC::_CREATE_VAR_STRING(2, "GENERIC_SEARCH"), -473983589, TASK::_GET_SCENARIO_POINT_COORDS(uParam0->f_6, 1), 1070386381, 1, 0, 0, 4, 570, 4000, 10, 1073741824, 0, 1704213876, 0);
			iVar0 = 0;
		}
		...
		else if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_1, "pbl_Action"))
		{
...
int func_18(var uParam0)
{
	switch (uParam0->f_9)
	{
		...
		case 1809565830:
			...
			else if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_1, 0))
			{
...
int func_37(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_89(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_89(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_99(var uParam0)
{
	...
	PED::SET_PED_LASSO_HOGTIE_FLAG(uParam0->f_4, 1, 0);
	ENTITY::_SET_ENTITY_CARRYING_FLAG(uParam0->f_4, 7, 0);
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_89(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_214(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_89(bParam1), iParam0, 0);
}
...
int func_216(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_89(bParam4), iParam0, 0);
	}
...
int func_336(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_89(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_518(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_89(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_89(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_89(0), 1623931083, 0);
	}
	return 0;
}
