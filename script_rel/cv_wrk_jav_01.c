...
int func_1(var uParam0)
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_43);
	}
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_44))
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_44);
	}
	return 1;
}
...
int func_94(var uParam0)
{
	...
	{
		if ((!iLocal_22 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_19))) && TASK::DOES_SCENARIO_POINT_EXIST(iLocal_43))
		{
		...
		if ((!iLocal_23 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20))) && TASK::DOES_SCENARIO_POINT_EXIST(iLocal_44))
		{
		...
		if ((iParam1 || !func_106(iParam0)) || func_52(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_215(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_217(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_218(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_275((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_216((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_334(int iParam0, bool bParam1)
{
	...
	{
		func_239(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
		if (func_227() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_216(iParam0, 1), &sVar4);
				}
...
int func_421(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_216(iParam0, 1));
...
void func_423(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_233(iParam1), iParam0, 0);
