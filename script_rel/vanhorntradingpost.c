		...
		if (MISC::GET_GAME_TIMER() > iLocal_355)
		{
			...
			switch (iLocal_354)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_356));
				...
				case 6:
					if (func_7(func_6(iLocal_356)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_356 /*35*/])->f_11);
							}
							Jump @858; //curOff = 839
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_356 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_117(int iParam0, bool bParam1)
{
	...
	{
		func_226(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_225(iParam0)));
		if (func_20() == -1)
		{
			if (func_201(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_156(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_156(iParam0)))
	{
...
bool func_155(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_156(iParam0));
}
...
int func_202(int iParam0, bool bParam1)
{
	...
	func_295(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_156(iParam0));
	func_226(iParam0, 0);
	return 1;
}
