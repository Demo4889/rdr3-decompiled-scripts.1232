...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else
		{
			...
			if (iLocal_22 == 28 || (((iLocal_22 >= 6 && iLocal_22 <= 27) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_188, 0)) && ANIMSCENE::_0x8D81E7824B7753F7(iLocal_188, "s_base_end", 1)))
			{
				if (bLocal_296)
				{
			...
			switch (iLocal_22)
			{
				case 0:
					...
					{
						if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_188, 1, 0) || !ANIMSCENE::_IS_ANIM_SCENE_LOADING(iLocal_188, 1))
						{
							ANIMSCENE::LOAD_ANIM_SCENE(iLocal_188);
						}
						if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_189, 1, 0) || !ANIMSCENE::_IS_ANIM_SCENE_LOADING(iLocal_189, 1))
						{
				...
				case 1:
					bVar1 = true;
					if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_188, 1, 0))
					{
						bVar1 = false;
					}
					if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_189, 1, 0))
					{
						bVar1 = false;
					}
					...
					if (func_18(iLocal_190, 2) && !func_18(iLocal_190, 4))
					{
						if ((func_18(iLocal_190, 16) || func_18(iLocal_190, 32)) || func_18(iLocal_190, 1024))
						{
							...
							if (func_80(&(uLocal_171[0]), iLocal_189, func_78(), func_79(), 0, 1056964608, 20000))
							{
								if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_188))
								{
									if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_188, 0))
									{
				...
				case 4:
					...
					{
						if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_189, 0))
						{
...
void func_1(bool bParam0, bool bParam1)
{
	...
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(iLocal_184))
	{
	...
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_180);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_180);
		VOLUME::DELETE_VOLUME(iLocal_180);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_178))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_178);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_178);
		VOLUME::DELETE_VOLUME(iLocal_178);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_179))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_179);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_179);
...
int func_5(int iParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		bVar0 = ANIMSCENE::IS_ANIM_SCENE_RUNNING(*iParam0, 0);
		if ((!bVar0 && !ENTITY::_0x083D497D57B7400F(&(uLocal_171[0]))) && !bParam5)
		{
			ANIMSCENE::START_ANIM_SCENE(*iParam0);
		}
		bVar1 = ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(*iParam0, sParam1);
...
void func_31()
{
	...
	{
		iLocal_183 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
...
int func_81(int iParam0)
{
	...
	bVar0 = ANIMSCENE::IS_ANIM_SCENE_LOADED(*iParam0, 1, 0);
	bVar1 = ANIMSCENE::IS_ANIM_SCENE_RUNNING(*iParam0, 0);
	if (bVar0 || bVar1)
	{
		return 1;
	}
...
int func_176(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_369(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_369(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_401(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_369(bParam1), iParam0, 0);
}
...
int func_403(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_369(bParam4), iParam0, 0);
	}
...
int func_567(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void func_568(var uParam0, bool bParam1, int* iParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, var uParam10, int iParam11, int iParam12, int iParam13, bool bParam14)
{
	int iVar0;
	...
	if (bParam1)
	{
		if (!MISC::IS_BIT_SET(*iParam2, 1))
		{
			...
			func_749(*uParam0, uParam4, fParam3, iParam7, iParam8, iParam12, func_313(uParam10, 32), 1, 0);
...
bool func_570(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, var uParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_369(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_615(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_369(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_851(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_369(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_369(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_369(0), 1623931083, 0);
	}
	return 0;
}
