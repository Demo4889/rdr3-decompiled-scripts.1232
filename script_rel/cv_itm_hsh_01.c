...
int func_91(var uParam0)
{
	...
	if (func_197(uParam0))
	{
		iLocal_30 = PED::_GET_PED_REGISTER_PROP(func_9(uParam0, iLocal_14), "p_mortarPestle02x_PH_L_HAND", 1);
		...
		if ((iParam1 || !func_110(iParam0)) || func_55(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_219(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_221(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_222(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_220((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_354(int iParam0, bool bParam1)
{
	...
	{
		func_243(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_137(iParam0)));
		if (func_231() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_220(iParam0, 1), &sVar4);
				}
...
int func_486(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_220(iParam0, 1));
...
void func_488(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_237(iParam1), iParam0, 0);
