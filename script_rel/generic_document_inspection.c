...
void func_353(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	{
		((*Global_1347702)[iParam0 /*49*/])->f_37 = MAP::BLIP_ADD_FOR_RADIUS(((*Global_1347702)[iParam0 /*49*/])->f_38, func_516(iParam0), ((*Global_1347702)[iParam0 /*49*/])->f_18);
		if (!MAP::DOES_BLIP_EXIST(((*Global_1347702)[iParam0 /*49*/])->f_37))
		{
			return;
		}
...
int func_731(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar31 = func_739(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar31) && func_740(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar31), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
