...
int func_22(int iParam0, int iParam1, int iParam2)
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(&(Local_168[iParam0 /*5*/]), 1, 0))
	{
		return 0;
	}
	return 1;
		...
		if ((Local_168[0 /*5*/])->f_2 == 1)
		{
			if (!iLocal_31)
			{
				if (func_91(0) || func_92(0, "A_M_M_ValTownfolk_02", 1))
				{
					...
					AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(iLocal_17, 0, 0);
					iLocal_31 = 1;
				}
				else
				{
					AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(iLocal_17, 0, 1);
				}
			}
		}
	}
		...
		if ((iParam1 || !func_78(iParam0)) || func_79(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_133(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_135(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_136(iParam0, 0));
...
void func_90()
{
	...
	if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(Local_168[iVar0 /*5*/]), 0))
	{
...
int func_91(int iParam0)
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(Local_168[iParam0 /*5*/]), 0))
	{
		return 1;
	}
	return 0;
...
void func_115(int iParam0)
{
	...
	switch (iLocal_159)
	{
		...
		case 5:
			...
			if (func_39(iLocal_15, 0))
			{
				AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(iLocal_15, 0, 1);
...
void func_383(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_432(func_431(255), 109029619));
	}
	else if (func_362())
	{
...
int func_430(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_424(bParam4), iParam0, 0);
	}
