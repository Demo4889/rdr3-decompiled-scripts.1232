...
int func_25(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		if (((func_118() || TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 1)) || !PED::IS_PED_ON_FOOT(Global_35))
		{
			return 0;
		}
		switch (iParam0)
						...
						if (!func_133(Global_1392040->f_1, 1) || func_133(Global_1392040->f_1, 512))
						{
							...
							else if (func_122(-1838434463))
							{
								...
								else
								{
									...
									func_142(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
								}
							}
...
int func_218(int iParam0, int iParam1)
{
	...
	uVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_199(0), &Var5, 0);
	return uVar9;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_199(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_264(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_199(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_273(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_199(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_340(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_199(bParam6), &Var0, 0);
	return uVar4;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_199(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_533(var uParam0, var uParam1)
{
	...
	while (iVar3 < 999)
	{
		if (func_161(uParam0[iVar3], 0))
		{
			if (func_272(Global_1935689->f_10186, 1))
			{
				iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar0), uParam0[iVar3], 0);
			}
			if (func_272(Global_1935689->f_10186, 2))
			{
				iVar4 = (iVar4 + INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar1), uParam0[iVar3], 0));
			}
			if (func_272(Global_1935689->f_10186, 4))
			{
				iVar4 = (iVar4 + INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar2), uParam0[iVar3], 0));
			}
			if (uParam1 && iVar4 > 0)
			{
...
int func_650(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_199(bParam1), iParam0, 0);
}
...
int func_652(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_199(bParam4), iParam0, 0);
	}
...
struct<28> func_721(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_199(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_725(&Var28) };
...
struct<17> func_723(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_199(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_725(&Var17) };
...
{
	*iParam2 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(iParam0, uParam1, uParam3);
	if (*iParam2 >= 0)
	{
		return 1;
	}
...
int func_793(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_199(bParam6), &uParam0, iParam4, &Var0))
	{
		return 0;
	}
...
int func_1097(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_199(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_199(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_199(0), 1623931083, 0);
	}
	return 0;
}
