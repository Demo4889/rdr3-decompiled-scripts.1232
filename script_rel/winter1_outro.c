...
{
	return (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_2, 1, 0) && HUD::TEXT_BLOCK_IS_LOADED("WNT2AUD"));
}
...
{
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0) && !ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_2, 0))
	{
		...
		if ((iParam1 || !func_60(iParam0)) || func_61(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_70(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_72(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_73(iParam0, 0));
