...
bool func_344(int iParam0, int iParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_467(iParam0)))
	{
		return false;
	}
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_467(iParam0));
}
