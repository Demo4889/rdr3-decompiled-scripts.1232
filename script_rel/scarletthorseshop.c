		...
		if (MISC::GET_GAME_TIMER() > iLocal_237)
		{
			...
			switch (iLocal_236)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_238));
				...
				case 6:
					if (func_7(func_6(iLocal_238)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_238 /*35*/])->f_11);
							}
							Jump @791; //curOff = 772
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_238 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_114(int iParam0, bool bParam1)
{
	...
	{
		func_207(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_206(iParam0)));
		if (func_20() == -1)
		{
