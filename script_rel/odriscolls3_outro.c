	...
	while (iVar1 <= 0)
	{
		switch ((Local_25[iVar1 /*2*/])->f_1)
		{
			case 0:
				...
				break;
			case 1:
				if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(&(Local_25[iVar1 /*2*/]), 1, 0))
				{
			...
			case 2:
				...
				{
					if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(Local_25[iVar1 /*2*/]), func_23(iVar1)))
					{
						if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(&(Local_25[iVar1 /*2*/]), func_23(iVar1)))
						{
...
int func_26(var uParam0)
{
	...
	switch (iLocal_16)
	{
		...
		case 6:
			...
			break;
		case 7:
			if (ANIMSCENE::_GET_ANIM_SCENE_TIME(&(Local_25[0 /*2*/])) >= (ANIMSCENE::_0x49F1D143ADE32656(&(Local_25[0 /*2*/])) - 0.5f) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(&(Local_25[0 /*2*/]), 0))
			{
...
int func_67(char* sParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_183(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, 0)) && (ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156) || func_113(uParam4, 512)))
			{
...
{
	if ((!func_113(uParam0, 32768) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156)) && ANIMSCENE::_0x95531A4A20CCE7BC(uParam0->f_156, 0))
	{
		func_257(uParam0);
		func_258(uParam0, 0);
...
void func_184(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, 0)) || ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam0->f_156)) || func_113(uParam0, 512))
	{
...
int func_217(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_218(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_351()
{
	return func_505(_NAMESPACE71::UI_FEED_GET_CURRENT_MESSAGE(3));
}
...
int func_403(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_547("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_546(uParam1, 16))) && (!WEAPON::_0x6AD66548840472E5(Var4.f_4) || func_546(uParam1, 4))) && (!func_549(Var4.f_4) || func_546(uParam1, 8)))
				{
...
int func_525(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_218(bParam1), iParam0, 0);
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_218(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
void func_564(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_650(func_649(255), 109029619));
	}
	else if (func_246())
	{
...
int func_574(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_218(bParam6), &uParam0, uParam4, &Var0))
	{
		return 0;
	}
...
struct<28> func_671(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_218(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_646(&Var28) };
...
struct<17> func_673(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_218(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_646(&Var17) };
