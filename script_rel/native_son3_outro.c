...
int func_6(var uParam0)
{
	...
	switch (iLocal_4)
	{
		case 0:
			...
			else if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_8, 1, 0))
			{
			...
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Cough_A"))
			{
			...
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Cough_B"))
			{
			...
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Labored_Breath"))
			{
			...
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Wipe_Face"))
			{
...
int func_24(var uParam0)
{
	...
	{
		case 0:
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_8, 0))
			{
				func_44(&uLocal_15);
				iLocal_3 = 1;
			}
		...
		if ((iParam1 || !func_58(iParam0)) || func_59(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_72(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_74(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_75(iParam0, 0));
...
{
	if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, sParam0))
	{
