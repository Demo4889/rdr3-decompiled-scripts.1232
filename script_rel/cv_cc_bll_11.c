...
int func_72(var uParam0)
{
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(-1122379099, 1, 0, 0);
...
int func_499(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_502(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_507(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_502(bParam1), iParam0, 0);
}
