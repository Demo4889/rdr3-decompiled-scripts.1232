						...
						if (iLocal_223 >= 3)
						{
							if (func_26(uParam0, uParam1))
							{
								if (!CAM::IS_SCREEN_FADED_OUT())
								{
									...
									if (!PED::IS_SCENARIO_BLOCKING_AREA_VALID(uParam1->f_114))
									{
...
void func_7(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		{
			TASK::DELETE_SCENARIO_POINT(uParam0->f_4);
		}
	}
	...
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(uParam0->f_114))
	{
...
void func_16(var uParam0, var uParam1)
{
	...
	switch (iLocal_144)
	{
		...
		case 3:
			break;
		case 4:
			if ((PED::IS_PED_DEAD_OR_DYING(uParam0->f_6, true) || !PED::IS_PED_USING_THIS_SCENARIO(uParam0->f_6, uParam0->f_9)) || TASK::IS_PED_EXITING_SCENARIO(uParam0->f_6, 0))
			{
				func_73(uParam0);
				func_74(&(uParam0->f_6), 1, 0, 1);
				func_31(5);
		...
		case 5:
			if (func_47(uParam0->f_6, 0))
			{
				...
				{
					TASK::DELETE_SCENARIO_POINT(uParam0->f_9);
				}
			}
			break;
	}
...
void func_68(var uParam0, var uParam1)
{
	if (iLocal_215)
	{
		...
		{
			if (TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_6, 0) && TASK::IS_PED_SCENARIO_REACT_LOOKING(uParam0->f_6, 1))
			{
		...
		else if (TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_6, 0))
		{
			if (!PED::_0x2DC0E8DCBD3546E9(uParam0->f_6))
			{
				if (!TASK::IS_PED_SCENARIO_REACT_LOOKING(uParam0->f_6, 1))
				{
...
int func_99(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_202(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_126(var uParam0, var uParam1)
{
	...
	if (func_67(&uLocal_153) < 5f)
	{
		if (!func_18(1))
		{
			...
			{
				if (!PED::IS_PED_HEADING_TOWARDS_POSITION(Global_35, VOLUME::GET_VOLUME_COORDS(uParam0->f_112), 135f) && !TASK::IS_PED_STILL(Global_35))
				{
...
void func_127(var uParam0, var uParam1)
{
	...
	if ((uParam1->f_2 == 115 && iLocal_17 == 0) && !func_39())
	{
		if (iLocal_145 >= 2 && !func_18(1))
		{
			if (!func_48(Global_35, uParam0->f_112, 1, 0))
			{
				if (!func_49(uParam1->f_2, 0, 0) || !PED::IS_PED_HEADING_TOWARDS_POSITION(Global_35, VOLUME::GET_VOLUME_COORDS(uParam0->f_112), 135f))
				{
...
{
	if (TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_4) && !TASK::_0x0CC36D4156006509(uParam0->f_4))
	{
...
int func_165(var uParam0, var uParam1)
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
	{
		...
		uParam0->f_9 = TASK::CREATE_SCENARIO_POINT(1041923169, TASK::_GET_SCENARIO_POINT_COORDS(iVar0, 1), TASK::_GET_SCENARIO_POINT_HEADING(iVar0, 1), 0f, -1f, 0);
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_6, 0, 1);
	}
	if (TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
	{
...
int func_256(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_255(iParam0)))
	{
		return 1;
	}
	...
	func_252(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_255(iParam0));
	func_368(iParam0, 0);
	return 1;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_202(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_366(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_253(iVar2) != 0 && _NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_255(iVar2)))
		{
...
bool func_388(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_255(iParam0));
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_202(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
