...
void func_4(var uParam0)
{
	if (!func_16(uParam0, 4))
	{
		if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0)) && !CAM::IS_GAMEPLAY_CAM_RENDERING())
		{
			MISC::SET_BIT(&(Global_1956578->f_1), 5);
			func_18(uParam0, 4);
		}
	}
	else if ((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0)) || CAM::IS_GAMEPLAY_CAM_RENDERING())
	{
		MISC::CLEAR_BIT(&(Global_1956578->f_1), 5);
		func_17(uParam0, 4);
	}
...
void func_11(var uParam0)
{
	...
	func_39(1);
	func_40(537, 0);
	HUD::_DISABLE_HUD_CONTEXT(1331687942);
	func_30(&iVar1, 0);
}
...
{
	if ((!func_60(uParam0, 32768) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156)) && ANIMSCENE::_0x95531A4A20CCE7BC(uParam0->f_156, 0))
	{
		func_265(uParam0);
		func_266(uParam0, 0);
...
int func_118(char* sParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_341(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, 0)) && (ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156) || func_60(uParam4, 512)))
			{
...
int func_143(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_373(bParam2), iParam0, 0);
	return iVar2;
}
	...
	if (func_628(iParam0, 1, 0))
	{
		if (func_629(iParam0))
		{
			...
			if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if (uParam3 && !PED::IS_PED_READY_TO_RENDER(func_130(iParam0)))
				{
					return 0;
				}
...
void func_342(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, 0)) || ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam0->f_156)) || func_60(uParam0, 512))
	{
...
int func_372(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_373(bParam6), &Var0, 0);
	return uVar4;
}
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1835011)[iParam0 /*74*/])->f_27))
	{
		...
		if (func_383(iParam0, iVar0) && !bVar3)
		{
			if (iParam3 || func_688((*Global_1835011)[iParam0 /*74*/], 2))
			{
				if (func_684(iParam0))
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_689(iParam0));
					iVar2 = 1;
				}
				else
				{
			...
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::BLIP_ADD_FOR_RADIUS(1673015813, func_693(iParam0), func_694(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_684(iParam0))
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_695(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_689(iParam0));
		...
		else if (func_696(iParam0))
		{
			if (iParam0 == 7)
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::BLIP_ADD_FOR_COORDS(-1337945352, func_690(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_690(iParam0));
...
int func_414(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_373(bParam1), iParam0, 0);
}
...
int func_416(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_373(bParam4), iParam0, 0);
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_373(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
bool func_647()
{
	return func_890(_NAMESPACE71::UI_FEED_GET_CURRENT_MESSAGE(3));
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_373(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_826(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_492("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_972(uParam1, 16))) && (!WEAPON::_0x6AD66548840472E5(Var4.f_4) || func_972(uParam1, 4))) && (!func_331(Var4.f_4) || func_972(uParam1, 8)))
				{
...
int func_1052(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_373(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_373(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_373(0), 1623931083, 0);
	}
	return 0;
}
...
void func_1081(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_1129(func_1128(255), 109029619));
	}
	else if (func_552())
	{
...
int func_1091(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_373(bParam6), &uParam0, uParam4, &Var0))
	{
		return 0;
	}
...
struct<28> func_1138(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_373(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<17> func_1140(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_373(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
