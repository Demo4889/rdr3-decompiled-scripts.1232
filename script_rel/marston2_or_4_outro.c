...
int func_23(var uParam0)
{
	...
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADING(uParam0->f_2, 1) && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_2, 1, 0))
	{
	...
	if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(uParam0->f_2, "MAR24_PTL") && !ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_2, "MAR24_PTL"))
	{
		ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_2, "MAR24_PTL");
	}
	if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_2, "MAR24_PTL"))
	{
		return 0;
	}
	return 1;
...
bool func_26(var uParam0)
{
	...
	switch (iLocal_16)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2) || ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_2, 0))
			{
