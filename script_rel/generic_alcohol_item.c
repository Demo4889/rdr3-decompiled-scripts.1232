			...
			case 2:
				if (!Var0.f_180)
				{
					...
					else if (iVar184 != 1587785400)
					{
						...
						{
							PED::_GIVE_PED_HASH_COMMAND(Global_35, -1268666326, 1.5f);
					...
					else
					{
						...
						{
							PED::_GIVE_PED_HASH_COMMAND(Global_35, 1114994170, 1.5f);
							PED::_ADD_SCENARIO_TRANSITION(Global_35);
						}
						func_12(&Var0, 4);
					}
...
int func_55(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_110(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_110(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_110(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_196(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_110(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_110(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_110(0), 1623931083, 0);
	}
	return 0;
}
