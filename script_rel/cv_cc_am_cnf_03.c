...
int func_347(var uParam0, var uParam1)
{
	...
	if (uParam1->f_21)
	{
		...
		while (iVar0 <= iVar1)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_349(uParam0, uParam1->f_4), func_364(uParam0, iVar0)) && !func_366(uParam0, iVar0))
			{
				return 0;
			}
			iVar0++;
	...
	if (uParam1->f_20)
	{
		...
		while (iVar2 <= iVar3)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_349(uParam0, uParam1->f_5), func_364(uParam0, iVar2)) && !func_366(uParam0, iVar2))
			{
				return 0;
			}
			iVar2++;
	...
	if (uParam1->f_22)
	{
		...
		while (iVar4 <= iVar5)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_349(uParam0, uParam1->f_6), func_364(uParam0, iVar4)) && !func_366(uParam0, iVar4))
			{
				return 0;
			}
			iVar4++;
...
int func_398(int iParam0, bool bParam1)
{
	...
	{
		func_271(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_140(iParam0)));
		if (func_259() == -1)
		{
