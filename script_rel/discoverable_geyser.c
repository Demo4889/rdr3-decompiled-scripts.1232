...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_87(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_87(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_88(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_88(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_89(uParam0);
...
void func_89(var uParam0)
{
	...
	if (func_129(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_129(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_169(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_134(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_134(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_134(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
