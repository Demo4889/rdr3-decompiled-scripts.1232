...
int func_175(int iParam0)
{
	...
	bVar0 = iParam0 > 0;
	if (Global_40.f_11957 == 0 && LAW::GET_BOUNTY(PLAYER::PLAYER_ID()) == 0)
	{
		return -2;
	}
	LAW::_0x093A9D1F72DF0D19(PLAYER::PLAYER_ID(), 0);
...
void func_263(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1)
	{
		...
		PED::SET_PED_MODEL_IS_SUPPRESSED(_NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_494(iParam0, 1)), true);
		if (bParam2)
		{
...
int func_264(int iParam0, int iParam1)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_446(iParam0)) && !ENTITY::DOES_THREAD_OWN_THIS_ENTITY(func_446(iParam0)))
		{
...
int func_265(int iParam0, int iParam1)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(iVar1)) && !ENTITY::DOES_THREAD_OWN_THIS_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(iVar1)))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(iVar1), true, true);
		}
	...
	if (func_383("ALL", &iVar0, &iVar1, -1591664384, 0))
	{
		...
		while (iVar2 < iVar1)
		{
			...
			else if (func_297(Var3.f_4, 173360570) && Var3.f_9 != -1360128126)
			{
				...
				INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(1, &Var3, Var3.f_11, -142743235);
			}
			else
			{
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_738(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_407(int iParam0)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_761(iParam0)))
	{
		return 0;
	}
	if (NETWORK::NETWORK_IS_IN_SESSION())
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_761(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_761(iParam0));
	...
	_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_761(iParam0));
	return 1;
}
...
int func_537(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(bParam2), iParam0, 0);
	return iVar2;
}
...
void func_724()
{
	...
	switch (func_1132())
	{
		...
		case 2:
			...
			break;
		case 3:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(Global_0.f_8, 1, 0))
			{
...
int func_924(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(bParam1), iParam0, 0);
}
...
int func_925(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(bParam4), iParam0, 0);
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_738(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_1024(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_738(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_1245(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_738(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_1336(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_738(bParam6), &uParam0, uParam4, &Var0))
	{
		return 0;
	}
...
int func_1416(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar1 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(bParam3), iParam0, 0);
	}
	if (iVar0 > iVar1)
	{
		return (iVar0 - iVar1);
...
int func_1538(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_738(0), 1623931083, 0);
	}
	return 0;
}
...
struct<28> func_1563(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_738(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<17> func_1565(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	Var17.f_9 = -1591664384;
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_738(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
