		...
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_33));
				...
				case 6:
					if (func_7(func_6(iLocal_33)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_33 /*35*/])->f_11);
							}
							Jump @807; //curOff = 788
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_33 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_28(int iParam0)
{
	...
	if (!func_53(iVar1, 0))
	{
		...
		PED::SET_PED_OWNS_ANIMAL(func_52(iVar0), func_52(735), 0);
	}
}
...
int func_98(int iParam0, bool bParam1)
{
	...
	{
		func_144(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_143(iParam0)));
		if (func_20() == -1)
		{
			if (func_140(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_55(iParam0));
