			...
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					switch (uParam0->f_489)
					{
						case 0:
						case 1:
							PED::_GIVE_PED_HASH_COMMAND(&(uParam0->f_20[1 /*14*/]), 281391541, 10f);
							break;
						case 2:
							PED::_GIVE_PED_HASH_COMMAND(&(uParam0->f_20[1 /*14*/]), -953151892, 10f);
							break;
						case 3:
							PED::_GIVE_PED_HASH_COMMAND(&(uParam0->f_20[1 /*14*/]), 290320544, 10f);
							break;
					}
				}
				func_68(&uLocal_40);
