						...
						if (func_33(&(uLocal_48[0])))
						{
							...
							if (func_78(&(uLocal_48[0]), 1))
							{
								...
								else
								{
									...
									{
										PATHFIND::REMOVE_NAVMESH_BLOCKING_VOLUME(iLocal_43);
										POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_43);
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_107(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_107(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_108(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_108(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_70(uParam0);
...
int func_59(var uParam0)
{
	...
	if (*uParam0 == -415839138)
	{
		...
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_41))
		{
			if (!PED::IS_SCENARIO_BLOCKING_AREA_VALID(iLocal_46))
			{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(Local_63.f_1[0])))
	{
		...
		switch (&Local_87[0 /*4*/])
		{
			...
			case 1:
				...
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_31[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_31[0]), 1, 0))
					{
						if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(&(uLocal_31[0]), "pb_mid_a") && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uLocal_31[0]), "pb_mid_a"))
						{
							iLocal_38 = 0;
			...
			case 2:
				...
				else if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_31[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_31[0]), 1, 0))
				{
			...
			case 19:
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_31[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_31[0]), 1, 0))
				{
					if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uLocal_31[0]), "pb_intial_visit_b"))
					{
						func_171(uLocal_31[0], "pb_intial_visit_b");
					}
					if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(&(uLocal_31[0]), "pb_intial_visit_b") && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uLocal_31[0]), "pb_intial_visit_b"))
					{
						func_170(uLocal_31[0], "base_bool", 0);
			...
			case 8:
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_31[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_31[0]), 1, 0))
				{
					if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(&(uLocal_31[0]), &vLocal_25) && ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(&(uLocal_31[0]), &vLocal_25))
					{
						if (!&iLocal_14[3])
						{
			...
			case 17:
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_31[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_31[0]), 1, 0))
				{
					if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(&(uLocal_31[0]), "pb_scream") && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uLocal_31[0]), "pb_scream"))
					{
						iLocal_14[2] = 1;
						func_79(uLocal_48[0], 1, 1);
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(Local_63.f_1[0])))
	{
		...
		switch (&Local_87[0 /*4*/])
		{
			...
			case 14:
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(uLocal_31[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uLocal_31[0]), 1, 0))
				{
					if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(&(uLocal_31[0]), &vLocal_25) && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uLocal_31[0]), &vLocal_25))
					{
						func_173(uLocal_31[0], &vLocal_25);
						func_167(Local_87[0 /*4*/], 13, 1);
					}
...
void func_68(var uParam0)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_45))
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_45);
	}
	iVar0 = 0;
	while (iVar0 <= (2 - 1))
	{
...
void func_70(var uParam0)
{
	...
	if (func_198(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_198(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_146(var uParam0, var uParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(func_284(uParam0, iVar0, 2, 0)))
		{
			if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam1[iVar0], 1, 0))
			{
				return 0;
			}
		}
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(*uParam0))
	{
		if (ANIMSCENE::IS_ANIM_SCENE_LOADED(*uParam0, 1, 0))
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
			{
				if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(*uParam0, sParam1))
				{
					if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(*uParam0, sParam1) && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(*uParam0, sParam1))
					{
...
int func_205(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_307(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_386(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_307(bParam1), iParam0, 0);
}
...
int func_388(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_307(bParam4), iParam0, 0);
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_307(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_578(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_307(bParam6), &Var0, 0);
	return uVar4;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_307(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_776(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_307(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_307(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_307(0), 1623931083, 0);
	}
	return 0;
}
