...
int func_347(int iParam0, bool bParam1)
{
	...
	{
		func_243(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_132(iParam0)));
		if (func_231() == -1)
		{
...
int func_520(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_523(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_528(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_523(bParam1), iParam0, 0);
}
