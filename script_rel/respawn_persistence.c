		...
		switch (func_5())
		{
			...
			case 13:
				if (func_23(Global_40.f_9.f_15))
				{
					...
					if ((!STREAMING::IS_LOAD_SCENE_ACTIVE() || STREAMING::_0x0909F71B5C070797()) || MISC::GET_GAME_TIMER() >= Global_1934266->f_64 + 30000)
					{
...
void func_307(var uParam0)
{
	...
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_359(func_358(255), 109029619));
	}
	else if (func_360())
	{
...
int func_353(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_303(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_369(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_303(bParam2), iParam0, 0);
	return iVar2;
}
...
struct<28> func_382(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_303(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_354(&Var28) };
...
struct<17> func_384(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_303(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_354(&Var17) };
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_303(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_303(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
