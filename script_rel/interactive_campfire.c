	...
	while (!func_3(1) && !bVar255)
	{
		switch (Var0.f_211)
		{
			...
			case 2:
				...
				Var0.f_248 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, Var0.f_249, 0f, 0f, 0f, 0.3f, 0.3f, 2f);
				func_8(&(Var0.f_211), 3);
				break;
			case 3:
				if (func_2(&Var0))
	...
	switch (uParam0->f_153)
	{
		...
		case 3:
			...
			else
			{
				...
				PAD::DISABLE_CONTROL_ACTION(0, -1046962283, false);
				PAD::DISABLE_CONTROL_ACTION(0, -1404316431, false);
				if ((((func_97(uParam0, uParam0->f_155) || !TASK::PED_HAS_USE_SCENARIO_TASK(Global_35)) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1)) || FIRE::IS_ENTITY_ON_FIRE(Global_35)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 0))
				{
				...
				if ((func_16(uParam0->f_151, 1) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(uParam0->f_195, 0)) || CAM::IS_SCREEN_FADED_OUT())
				{
					CAM::_DISABLE_CINEMATIC_MODE_THIS_FRAME();
					func_53(uParam0);
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_193))
					{
						if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_193, 1, 0))
						{
...
int func_51(var uParam0)
{
	...
	{
		if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_195, 0))
		{
			return 0;
		}
	}
...
void func_58(var uParam0)
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_193))
	{
		...
		{
			PED::_GIVE_PED_HASH_COMMAND(Global_35, -1961588683, 3f);
		...
		if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_193, 0))
		{
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				CAM::DO_SCREEN_FADE_IN(500);
...
int func_60(bool bParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		...
		{
			if (((TASK::_PED_IS_IN_SCENARIO_BASE(Global_35) || (bParam0 && TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0))) || (TASK::IS_TASK_MOVE_NETWORK_ACTIVE(Global_35) && TASK::GET_TASK_MOVE_NETWORK_EVENT(Global_35, "SCENARIO_POINT_TRANS_COMPLETE"))) || (func_56(16777216) && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336)))
			{
				return 1;
			}
		}
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		if (((func_197() || TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) || TASK::IS_PED_EXITING_SCENARIO(Global_35, 1)) || !PED::IS_PED_ON_FOOT(Global_35))
		{
			return 0;
		}
		switch (iParam0)
			...
			case -727924611:
				...
				else
				{
					...
					if (bVar36 && !bVar35)
					{
						...
						MAP::BLIP_ADD_MODIFIER(Global_36558, 673950256);
						...
						if (!func_16(Global_1392040->f_1, 1) || func_16(Global_1392040->f_1, 512))
						{
							...
							else if (func_200(-1838434463))
							{
								...
								else
								{
									...
									func_221(_NAMESPACE26::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
								}
							}
...
void func_99(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	STATS::STAT_ID_INCREMENT_INT(&Var1, iParam1);
	...
	STATS::STAT_ID_INCREMENT_INT(&Var1, 1);
	if (func_23() == 0)
	{
...
int func_135(int iParam0, int iParam1)
{
	...
	STATS::STAT_ID_INCREMENT_INT(&Var29, 1);
	return iVar21;
}
...
int func_249(var uParam0)
{
	...
	if (func_56(268435456) && uParam0->f_149 < 13)
	{
		...
		if ((MISC::GET_GAME_TIMER() - uParam0->f_197) > 1000 && func_541(&(uParam0->f_57)))
		{
			...
			if (PED::_GIVE_PED_SCENARIO_PROP(Global_35, uParam0->f_160, "p_meatChunks01x_PH_L_HAND", 0, 0, 1))
			{
			}
	...
	switch (uParam0->f_149)
	{
		...
		case 15:
			...
			{
				if ((((func_165(&(uParam0->f_162[7]), 0) && (func_229(&(uParam0->f_162[7]), 1) || PAD::IS_CONTROL_PRESSED(0, -473983589))) || func_16(uParam0->f_151, 256)) || func_138(Global_35, 0)) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, 1))
				{
					func_48(16);
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_86(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_339(var uParam0)
{
	...
	uParam0->f_155 = func_61();
	iVar0 = func_36(uParam0);
	if ((((uParam0->f_156 == -1 || iVar0 == uParam0->f_156) && (uParam0->f_157 == 0 || func_648(uParam0->f_155, uParam0->f_157))) || (uParam0->f_156 == -1 && func_648(uParam0->f_155, uParam0->f_157))) && !(PED::_IS_PED_DOING_SCENARIO_TRANSITION(Global_35) || PED::_0x2DC0E8DCBD3546E9(Global_35)))
	{
		uParam0->f_154 = iVar0;
		return 1;
	}
...
int func_345(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_86(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_419(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_86(bParam6), &Var0, 0);
	return uVar4;
}
	...
	switch (func_547(uParam0))
	{
		...
		case 12:
			...
			if (iVar9 != -715814988)
			{
				...
				if (((((((((iVar9 == 414472632 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_63, 1, 0)) || (iVar9 == -1136843638 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_66, 1, 0))) || (uParam0->f_88 != 0 && !STREAMING::HAS_MODEL_LOADED(uParam0->f_88))) || (iVar9 == -732326901 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_68, 1, 0))) || (iVar9 == 786205940 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_67, 1, 0))) || (iVar9 == -1141771998 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_69, 1, 0))) || (iVar9 == 364689687 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_70, 1, 0))) || (iVar9 == -842117252 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_71, 1, 0))) || (iVar9 == -1610298873 && !ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_72, 1, 0)))
				{
					return;
				}
			...
			{
				if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_65, 1, 0) || (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0)))
				{
					return;
				}
				else if (uParam0->f_64)
		...
		case 14:
			...
			if ((iVar14 == 0 || (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iVar14) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(iVar14, 0))) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336))
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_85))
				{
					OBJECT::DELETE_OBJECT(&(uParam0->f_85));
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_86(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
void func_634(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	{
		((*Global_1347702)[iParam0 /*49*/])->f_37 = MAP::BLIP_ADD_FOR_RADIUS(((*Global_1347702)[iParam0 /*49*/])->f_38, func_633(iParam0), ((*Global_1347702)[iParam0 /*49*/])->f_18);
		if (!MAP::DOES_BLIP_EXIST(((*Global_1347702)[iParam0 /*49*/])->f_37))
		{
			return;
		}
...
void func_664(int iParam0)
{
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || func_952(Global_35, 1369124074))
	{
...
int func_698()
{
	...
	if (iVar1 == joaat("weapon_unarmed"))
	{
		...
		else if ((((WEAPON::IS_WEAPON_VALID(iVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(iVar0)) && !func_328(iVar0)) && !PED::_IS_PED_GETTING_INTO_A_MOUNT_SEAT(Global_35, true)) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_35, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
		{
			return 3;
		}
...
int func_943(int iParam0, int iParam1)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(iParam0, &Var0, 0);
	return uVar4;
}
...
int func_1132(int iParam0, int iParam1)
{
	...
	uVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_86(0), &Var5, 0);
	return uVar9;
}
...
struct<28> func_1220(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_86(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<17> func_1222(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_86(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
...
struct<4> func_1237(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(uParam0, &uParam2, iParam1, iParam6, &Var0);
	return Var0;
}
...
int func_1301(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(uParam0, &uParam1, uParam5, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_1307(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iParam0))
		{
			iVar0 = (iVar0 + func_943(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), iParam1));
		}
	}
...
int func_1309(int iParam0, int iParam1)
{
	...
	{
		iVar0 = func_204(func_395(0));
		iVar1 = (iVar1 + func_943(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar0), iParam0));
	}
