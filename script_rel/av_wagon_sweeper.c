			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
					{
						...
						PED::_GIVE_PED_SCENARIO_PROP(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_372[0 /*8*/]), "p_broom02x_PH_R_HAND", "WORLD_HUMAN_BROOM_PUTDOWN", 0, 1);
						vVar0 = { func_73(uParam0) };
						if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vVar0, 0.5f, 1, 0, 0) && !TASK::_DOES_SCENARIO_POINT_HAVE_PROPS(TASK::_0xF533D68FF970D190(vVar0, 704531824, 0.5f, 0, 0)))
						{
