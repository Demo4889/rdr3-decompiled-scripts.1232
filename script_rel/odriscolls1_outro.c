...
bool func_6(var uParam0)
{
	...
	return ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_2, "Intro");
}
...
int func_23(var uParam0)
{
	...
	if (!iLocal_3)
	{
		...
		if (((((func_50(((*Global_1835011)[3 /*74*/])->f_1) && func_52(func_51(((*Global_1835011)[3 /*74*/])->f_1), 4)) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0)) && ((ANIMSCENE::_GET_ANIM_SCENE_TIME(iLocal_10) >= ANIMSCENE::_0x49F1D143ADE32656(iLocal_10) || ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(iLocal_10)) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(iLocal_10, 0))) && iLocal_6) && STREAMING::IS_SRL_LOADED())
		{
			HUD::_0x4CC5F2FC1332577F(-1679307491);
	...
	else
	{
		...
		{
			case 0:
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0) && ANIMSCENE::_0x8D81E7824B7753F7(uParam0->f_2, "Shot1", 1))
				{
				...
				break;
			case 1:
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0) && ANIMSCENE::_0x8D81E7824B7753F7(uParam0->f_2, "SHOT2", 1))
				{
					MISC::_0x59174F1AFE095B5A(1632247697, true, true, false, 0f, false);
					CLOCK::SET_CLOCK_TIME(9, 0, 0);
					GRAPHICS::SET_TIMECYCLE_MODIFIER("winter4_introCMEmod");
				...
				break;
			case 2:
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_2, 0) && ANIMSCENE::_0x8D81E7824B7753F7(uParam0->f_2, "SHOT3", 1))
				{
		...
		if ((ANIMSCENE::_GET_ANIM_SCENE_TIME(uParam0->f_2) >= ANIMSCENE::_0x49F1D143ADE32656(uParam0->f_2) || ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(uParam0->f_2)) || ANIMSCENE::_0x73616E64696C132E(uParam0->f_2, 1))
		{
		...
		if ((iParam1 || !func_65(iParam0)) || func_66(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_84(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_86(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_87(iParam0, 0));
	...
	if (func_107(iParam0, 1, 0))
	{
		if (func_108(iParam0))
		{
			...
			if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if (uParam3 && !PED::IS_PED_READY_TO_RENDER(func_57(iParam0)))
				{
					return 0;
				}
