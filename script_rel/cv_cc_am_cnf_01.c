...
int func_1(var uParam0)
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_96);
	}
	...
	if (CAM::_IS_CAMERA_AVAILABLE(&Local_64))
	{
		...
		if ((iParam1 || !func_112(iParam0)) || func_57(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_215(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_251(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_252(iParam0, 0));
...
int func_142(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_141(iParam0)))
	{
		return 1;
	}
	...
	func_138(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_141(iParam0));
	func_273(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_313((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_250((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
void func_232()
{
	if (CAM::_IS_CAMERA_AVAILABLE(&Local_64) && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 72439833))
	{
		CAM::_0x0A5A4F1979ABB40E(&Local_64);
		iLocal_60 = 0;
	}
...
int func_353(var uParam0, var uParam1)
{
	...
	if (uParam1->f_21)
	{
		...
		while (iVar0 <= iVar1)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_416(uParam0, uParam1->f_4), func_417(uParam0, iVar0)) && !func_371(uParam0, iVar0))
			{
				return 0;
			}
			iVar0++;
	...
	if (uParam1->f_20)
	{
		...
		while (iVar2 <= iVar3)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_416(uParam0, uParam1->f_5), func_417(uParam0, iVar2)) && !func_371(uParam0, iVar2))
			{
				return 0;
			}
			iVar2++;
	...
	if (uParam1->f_22)
	{
		...
		while (iVar4 <= iVar5)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_416(uParam0, uParam1->f_6), func_417(uParam0, iVar4)) && !func_371(uParam0, iVar4))
			{
				return 0;
			}
			iVar4++;
...
int func_370(var uParam0, int iParam1)
{
	...
	ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iVar5, &Var1);
	return 1;
}
...
int func_372(var uParam0, int iParam1)
{
	...
	iVar0 = &uParam0->f_1984[iParam1];
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iVar0) || ANIMSCENE::_IS_ANIM_SCENE_LOADING(iVar0, 1))
	{
		return 0;
	}
...
int func_403(int iParam0, bool bParam1)
{
	...
	{
		func_273(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_139(iParam0)));
		if (func_261() == -1)
		{
			if (func_135(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_141(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_250(iParam0, 1), &sVar4);
				}
...
bool func_485(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_141(iParam0));
}
...
int func_496(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_250(iParam0, 1));
...
void func_498(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_267(iParam1), iParam0, 0);
...
int func_569(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_572(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_577(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_572(bParam1), iParam0, 0);
}
