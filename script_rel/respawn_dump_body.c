...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(-58462683);
		}
		...
		{
			PED::_SET_PED_MOTIVATION(Local_32.f_98, 3, 0f, 0);
			if (iLocal_29 >= 8)
			{
		...
		switch (iLocal_29)
		{
			case 0:
				...
				POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_141, 8192, 0, 0, -1, -1, 0);
				POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_141, 8192, 0, 0, -1, -1, 0);
			...
			case 4:
				...
				else
				{
					...
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_30) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_30, 1, 0))
					{
...
void func_1(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(Local_32.f_98))
	{
		...
		POPULATION::_SET_PED_SHOULD_IGNORE_AVOIDANCE_VOLUMES(Local_32.f_98, 0);
	}
	...
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_140);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_140);
		VOLUME::DELETE_VOLUME(iLocal_140);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_141))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_141);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_141);
		VOLUME::DELETE_VOLUME(iLocal_141);
	}
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(iLocal_143))
	{
...
int func_24()
{
	...
	if ((!func_17() && !iLocal_31) && !func_20(&Global_1935630, 131072))
	{
		...
		if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_30, 1, 0))
		{
			bVar3 = true;
		}
		if (!bLocal_147)
	...
	if (!PED::IS_INSTANTLY_FILL_PED_POPULATION_FINISHED() || !VEHICLE::_0x2701D01D5E18FC31())
	{
		return 0;
	}
...
void func_46()
{
	...
	if ((!PED::IS_PED_INJURED(Local_32.f_98) && !TASK::IS_PED_IN_WRITHE(Local_32.f_98)) && !func_116(Local_32.f_34))
	{
		...
		POPULATION::_SET_PED_SHOULD_IGNORE_AVOIDANCE_VOLUMES(Local_32.f_98, 2);
	...
	if (func_247(iParam0, 1, 0))
	{
		if (func_248(iParam0))
		{
			...
			if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if (uParam3 && !PED::IS_PED_READY_TO_RENDER(func_250(iParam0)))
				{
					return 0;
				}
...
int func_204(int iParam0)
{
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_342(iParam0)))
	{
		_NAMESPACE48::REVIVE_PERSCHAR(func_342(iParam0));
...
int func_408(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_534(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_409()
{
	...
	if (iVar1 == joaat("weapon_unarmed"))
	{
		...
		else if ((((WEAPON::IS_WEAPON_VALID(iVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(iVar0)) && !func_276(iVar0)) && !PED::_IS_PED_GETTING_INTO_A_MOUNT_SEAT(Global_35, true)) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_35, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
		{
			return 3;
		}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_534(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_534(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
void func_622(var uParam0)
{
	...
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_644(func_643(255), 109029619));
	}
	else if (func_570())
	{
...
int func_633(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_534(bParam6), &uParam0, iParam4, &Var0))
	{
		return 0;
	}
...
int func_639(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_534(bParam6), &Var0, 0);
	return uVar4;
}
...
struct<28> func_649(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_534(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_640(&Var28) };
...
struct<17> func_651(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_534(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_640(&Var17) };
