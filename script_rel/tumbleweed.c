		...
		if (MISC::GET_GAME_TIMER() > iLocal_238)
		{
			...
			switch (iLocal_237)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_239));
				...
				case 6:
					if (func_7(func_6(iLocal_239)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_239 /*35*/])->f_11);
							}
							Jump @791; //curOff = 772
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_239 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_71()
{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iLocal_228))
		{
			iLocal_228 = func_151(348);
			iLocal_229 = 0;
			iLocal_227 = 0;
		}
		else if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iLocal_228))
		{
			iLocal_229 = 0;
			iLocal_227 = 0;
		}
		...
		{
			iLocal_229 = _NAMESPACE48::GET_PERSCHAR_PED_INDEX(iLocal_228);
			iLocal_227 = 0;
		}
...
int func_112(int iParam0, bool bParam1)
{
	...
	{
		func_216(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_205(iParam0)));
		if (func_20() == -1)
		{
			if (func_203(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_151(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_151(iParam0)))
	{
...
bool func_150(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_151(iParam0));
}
...
int func_204(int iParam0, bool bParam1)
{
	...
	func_284(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_151(iParam0));
	func_216(iParam0, 0);
	return 1;
}
