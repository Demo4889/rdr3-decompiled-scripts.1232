...
void func_85(int iParam0)
{
	...
	{
		TXD::_0x8232F37DF762ACB2(-451886707);
		TASK::DELETE_SCENARIO_POINT(iLocal_16);
	}
...
int func_96(int iParam0, bool bParam1)
{
	...
	if (func_171(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_175(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_175(iParam0)))
	{
...
int func_116(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_194(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_172(int iParam0, bool bParam1)
{
	...
	func_221(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_175(iParam0));
	func_174(iParam0, 0);
	return 1;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_194(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_194(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
