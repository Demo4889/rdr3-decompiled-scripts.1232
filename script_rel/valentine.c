		...
		if (MISC::GET_GAME_TIMER() > iLocal_851)
		{
			...
			switch (iLocal_850)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_852));
				...
				case 6:
					if (func_7(func_6(iLocal_852)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_852 /*35*/])->f_11);
							}
							Jump @900; //curOff = 881
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_852 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_2()
{
	if (((!func_43(-515561750) && func_20() == -1) && !STREAMING::_IS_IMAP_ACTIVE(1186533019)) && !STREAMING::IS_LOAD_SCENE_ACTIVE())
	{
		func_44(-892659042);
		func_45();
	}
...
void func_28(int iParam0)
{
	...
	if (func_95(37, iLocal_783, 1))
	{
		...
		if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_96(51)))
		{
...
int func_38(int iParam0)
{
	...
	switch (iLocal_829)
	{
		...
		case 4:
			...
			break;
		case 5:
			if (((!STREAMING::IS_LOAD_SCENE_ACTIVE() && !func_43(-515561750)) && !STREAMING::_IS_IMAP_ACTIVE(1186533019)) && !func_118(-892659042))
			{
...
void func_105()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(Local_14.f_17) && Local_14.f_14 > 1) && Local_14 != 0)
	{
		if (func_270() && func_271(Global_36, Local_14.f_11) < 100f)
		{
			...
			{
				Local_14.f_17 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_GET_PINNED_MAP_ENTITY(Local_14.f_18));
			}
		}
	...
	{
		if (AUDIO::_HAS_SOUND_AUDIO_NAME_FINISHED(Local_14.f_10, "CHURCH_BELL_SOUNDS") && Local_14.f_24 < MISC::GET_GAME_TIMER())
		{
			Local_14.f_24 = MISC::GET_GAME_TIMER() + 1800;
...
void func_113()
{
	if (func_287(func_10(76), 557524588, 1))
	{
		...
		if (PED::GET_PED_CONFIG_FLAG(iLocal_825, 130, false))
		{
			...
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iLocal_825, 3, 1, 0);
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iLocal_825, 4, 1, 1);
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iLocal_825, 7, 1, 1);
		}
	}
}
	...
	if (((!func_293(((*Global_1392194)[1 /*10*/])->f_1, 1) && !func_294(16)) && !func_294(2)) && !func_294(1))
	{
		if (!VOLUME::DOES_VOLUME_EXIST(Global_1898092->f_26.f_5))
		{
			if (func_295(Global_35, iLocal_782, 1, 0))
			{
				...
				Global_1898092->f_26.f_5 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(VOLUME::GET_VOLUME_COORDS(iLocal_782), VOLUME::_0x18675BC914891122(iLocal_782), vVar0, "Event Area - volShutdown");
				func_296(16);
			}
		}
	}
...
void func_130(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(_NAMESPACE48::_0x112DDF56300BC6E5(func_322(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_322(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(_NAMESPACE48::_0x112DDF56300BC6E5(func_322(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
void func_133(var uParam0)
{
	...
	if (uParam0->f_17 > 0)
	{
		...
		if (!VOLUME::IS_POINT_IN_VOLUME(uParam0->f_5, Global_36) && func_337(uParam0, 8, 0, 1))
		{
			uParam0->f_17 = 4;
		}
	...
	switch (uParam0->f_17)
	{
		case 0:
			...
			if (VOLUME::IS_POINT_IN_VOLUME(uParam0->f_5, Global_36))
			{
				...
				if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_96(uParam0->f_3)))
				{
					return;
				}
		...
		case 1:
			bVar2 = false;
			if ((VOLUME::IS_POINT_IN_VOLUME(uParam0->f_6, Global_36) && !func_343(uParam0)) && func_344(uParam0, -1))
			{
		...
		case 3:
			...
			else if ((VOLUME::IS_POINT_IN_VOLUME(uParam0->f_7, Global_36) == 0 && func_339(Global_35, 1, 0, 0) == joaat("weapon_unarmed")) && !func_341(&uVar1))
			{
				bVar3 = false;
...
int func_206(int iParam0, bool bParam1)
{
	...
	{
		func_429(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_322(iParam0)));
		if (func_20() == -1)
		{
			if (func_384(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_96(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_96(iParam0)))
	{
...
bool func_259(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_96(iParam0));
}
...
int func_385(int iParam0, bool bParam1)
{
	...
	func_548(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_96(iParam0));
	func_429(iParam0, 0);
	return 1;
}
...
int func_462(var uParam0)
{
	...
	*uParam0 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(MISC::_GET_ENTITY_FROM_ITEM(ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(0, iVar1)));
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0) && PED::IS_PED_HUMAN(*uParam0))
	{
		ITEMSET::DESTROY_ITEMSET(iVar1);
		return 1;
	}
...
void func_615(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_435(iParam0) == 3 || (func_435(iParam0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_569(iParam0))))
	{
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_761(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_830(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_825("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_ONE_HANDED(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_889(uParam1, 32))) && (!WEAPON::_0xDDC64F5E31EEDAB6(Var4.f_4) || !func_889(uParam1, 8192))) && (!WEAPON::_0xC212F1D05A8232BB(Var4.f_4) || !func_889(uParam1, 16384)))
				{
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_761(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
