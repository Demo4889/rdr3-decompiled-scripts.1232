...
void func_27(bool bParam0)
{
	...
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_15);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_15);
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_16, false);
		PATHFIND::RESET_ROADS_IN_VOLUME(iLocal_15, 0);
...
int func_167(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_170(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_176(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_170(bParam1), iParam0, 0);
}
