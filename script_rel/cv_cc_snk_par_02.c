...
void func_8(bool bParam0, bool bParam1)
{
	...
	if (((func_49() && STREAMING::IS_LOAD_SCENE_ACTIVE() == 0) && func_61(0) == ((*Global_1835011)[4 /*74*/])->f_1 == 0) && func_62())
	{
		...
		{
			if (((((ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(Global_1357549->f_1713[0])) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(Global_1357549->f_1713[0]), 1, 0)) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(Global_1357549->f_1713[1]))) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(Global_1357549->f_1713[1]), 1, 0)) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(&(Global_1357549->f_1713[2]))) && ANIMSCENE::IS_ANIM_SCENE_LOADED(&(Global_1357549->f_1713[2]), 1, 0))
			{
				if (((func_74(16) != 1 && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(Global_1357549->f_1713[0]), 0)) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(Global_1357549->f_1713[1]), 0)) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(Global_1357549->f_1713[2]), 0))
				{
		...
		if ((iParam1 || !func_171(iParam0)) || func_82(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_312(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_314(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_315(iParam0, 0));
...
int func_199(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_198(iParam0)))
	{
		return 1;
	}
	...
	func_195(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_198(iParam0));
	func_333(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_369((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_313((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_293(int iParam0, int iParam1)
{
	...
	uVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_437(0), &Var5, 0);
	return uVar9;
}
...
void func_303()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_1357549->f_1674))
	{
		if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(Global_1357549->f_1674))
		{
...
int func_464(int iParam0, bool bParam1)
{
	...
	{
		func_333(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_196(iParam0)));
		if (func_138() == -1)
		{
			if (func_192(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_198(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_313(iParam0, 1), &sVar4);
				}
...
bool func_565(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_198(iParam0));
}
...
int func_576(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_313(iParam0, 1));
			STREAMING::REQUEST_MODEL(iVar0, false);
			if (STREAMING::HAS_MODEL_LOADED(iVar0))
			{
...
void func_578(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_130(iParam1), iParam0, 0);
