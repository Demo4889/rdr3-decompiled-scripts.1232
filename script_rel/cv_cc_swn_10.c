...
int func_167(var uParam0, vector3 vParam1, int iParam4, var uParam5, char* sParam6, bool bParam7)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
		iLocal_23 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::GET_PROP_FOR_SCENARIO_POINT(*uParam5, sParam6));
	}
...
int func_327(int iParam0, bool bParam1)
{
	...
	{
		func_232(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_132(iParam0)));
		if (func_220() == -1)
		{
