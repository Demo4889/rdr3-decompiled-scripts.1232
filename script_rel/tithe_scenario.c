...
void func_6()
{
	...
	PAD::_SET_CONTROL_CONTEXT(5, -584683016);
	switch (iLocal_73)
	{
		case 0:
		...
		case 1:
			...
			else
			{
				...
				STREAMING::REQUEST_MODEL(iLocal_38, false);
				if ((PED::IS_PED_USING_ANY_SCENARIO(Global_35) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_69, 1, 0)) && func_22())
				{
					func_23();
...
int func_109(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_83(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_83(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_152(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_83(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_83(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_259(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_83(bParam1), iParam0, 0);
}
...
int func_260(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_83(bParam6), &Var0, 0);
	return uVar4;
}
