		...
		if ((iParam1 || !func_60(iParam0)) || func_61(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_82(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_84(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_85(iParam0, 0));
...
int func_166(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_169(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_175(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_169(bParam1), iParam0, 0);
}
