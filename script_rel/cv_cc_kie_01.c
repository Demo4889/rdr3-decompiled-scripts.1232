...
int func_98(var uParam0)
{
	...
	if (bLocal_108)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(func_53(uParam0, iLocal_93)))
		{
			...
			{
				TASK::DELETE_SCENARIO_POINT((uParam0->f_107[iLocal_93 /*113*/])->f_32.f_21);
			}
			_NAMESPACE48::RETASK_PERSISTENT_CHARACTER(_NAMESPACE48::_GET_PERSCHAR_INDEX_FROM_PED_INDEX(func_53(uParam0, iLocal_93)));
			_NAMESPACE48::_0xD4B614179BCD0654(_NAMESPACE48::_GET_PERSCHAR_INDEX_FROM_PED_INDEX(func_53(uParam0, iLocal_93)));
		...
		if ((iParam1 || !func_116(iParam0)) || func_56(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_229(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_231(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_232(iParam0, 0));
...
int func_146(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_145(iParam0)))
	{
		return 1;
	}
	...
	func_142(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_145(iParam0));
	func_253(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_287((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_230((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_359(int iParam0, bool bParam1)
{
	...
	{
		func_253(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_143(iParam0)));
		if (func_241() == -1)
		{
			if (func_139(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_145(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_230(iParam0, 1), &sVar4);
				}
...
bool func_466(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_145(iParam0));
}
...
int func_485(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_230(iParam0, 1));
...
void func_487(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_247(iParam1), iParam0, 0);
...
int func_559(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_562(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_567(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_562(bParam1), iParam0, 0);
}
