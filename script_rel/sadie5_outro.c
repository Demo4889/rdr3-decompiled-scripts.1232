...
int func_47(int iParam0)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_90(iParam0)))
	{
		return 0;
	}
	if (NETWORK::NETWORK_IS_IN_SESSION())
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_90(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_90(iParam0));
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
	...
	_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_90(iParam0));
	return 1;
}
		...
		if ((iParam1 || !func_66(iParam0)) || func_67(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_111(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_113(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_114(iParam0, 0));
