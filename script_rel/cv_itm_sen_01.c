...
int func_91(var uParam0)
{
	...
	{
		iLocal_22[1] = PED::_GET_PED_REGISTER_PROP(func_9(uParam0, iLocal_15), "p_bottleJD01x_ph_r_hand", 1);
...
int func_100(var uParam0)
{
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_37))
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_9(uParam0, iLocal_15)))
		{
			...
			{
				TASK::DELETE_SCENARIO_POINT(iLocal_37);
			}
		}
	}
	return 1;
		...
		if ((iParam1 || !func_110(iParam0)) || func_55(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_223(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_225(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_226(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_278((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_224((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_352(int iParam0, bool bParam1)
{
	...
	{
		func_247(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_137(iParam0)));
		if (func_235() == -1)
		{
...
int func_368(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_419(bParam2), iParam0, 0);
	return iVar2;
}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_224(iParam0, 1), &sVar4);
				}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_419(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_482(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_224(iParam0, 1));
...
void func_484(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_241(iParam1), iParam0, 0);
...
int func_554(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_419(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_559(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_419(bParam1), iParam0, 0);
}
