...
int func_1(var uParam0)
{
	...
	if (!iLocal_31)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23))
		{
			...
			{
				iVar0 = PED::_GET_PED_REGISTER_PROP(func_8(uParam0, iLocal_14), "p_bottleJD01x_ph_r_hand", 0);
		...
		if ((iParam1 || !func_110(iParam0)) || func_55(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_224(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_226(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_227(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_225((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_362(int iParam0, bool bParam1)
{
	...
	{
		func_248(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_137(iParam0)));
		if (func_236() == -1)
		{
...
int func_378(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_428(bParam2), iParam0, 0);
	return iVar2;
}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_225(iParam0, 1), &sVar4);
				}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_428(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_491(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_225(iParam0, 1));
...
int func_563(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_428(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_568(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_428(bParam1), iParam0, 0);
}
