...
int func_175(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, bool bParam9)
{
	...
	while (iVar0 < uParam0->f_67)
	{
		...
		{
			uParam0->f_67[iVar0] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(iParam8, vParam1, 0f, 0f, fParam4, vParam5);
			if (VOLUME::DOES_VOLUME_EXIST(&(uParam0->f_67[iVar0])))
			{
...
int func_381(int iParam0, bool bParam1)
{
	...
	{
		func_270(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_143(iParam0)));
		if (func_258() == -1)
		{
...
int func_583(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_586(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_591(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_586(bParam1), iParam0, 0);
}
