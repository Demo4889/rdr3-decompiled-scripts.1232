...
int func_96(var uParam0)
{
	switch (func_20(uParam0))
	{
		...
		case 350:
			...
			{
				PED::_GIVE_PED_HASH_COMMAND(func_49(uParam0, iLocal_20), -26677487, 10f);
				return 1;
			}
			break;
		case 360:
			...
			{
				PED::_GIVE_PED_HASH_COMMAND(func_49(uParam0, iLocal_17), -26677487, 10f);
				return 1;
			}
			break;
		case 362:
			...
			{
				PED::_GIVE_PED_HASH_COMMAND(func_49(uParam0, iLocal_17), -1654150531, 10f);
				return 1;
			}
			break;
		case 373:
			...
			{
				PED::_GIVE_PED_HASH_COMMAND(func_49(uParam0, iLocal_17), -676094188, 10f);
				return 1;
			}
			break;
		case 379:
		...
		if ((iParam1 || !func_106(iParam0)) || func_52(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_244(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_246(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_247(iParam0, 0));
...
int func_136(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_135(iParam0)))
	{
		return 1;
	}
	...
	func_132(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_135(iParam0));
	func_267(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_304((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_245((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_376(int iParam0, bool bParam1)
{
	...
	{
		func_267(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
		if (func_256() == -1)
		{
			if (func_129(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_135(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_245(iParam0, 1), &sVar4);
				}
...
bool func_482(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_135(iParam0));
}
...
int func_501(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_245(iParam0, 1));
...
void func_503(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_224(iParam1), iParam0, 0);
