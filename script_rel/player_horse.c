...
void func_55()
{
	...
	{
		iVar2 = func_88(0);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar2, 31, 2, iVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar2, 32, 2, iVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar2, 33, 2, iVar1);
	}
	if (func_71(1))
	{
		iVar3 = func_88(1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar3, 31, 2, iVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar3, 32, 2, iVar1);
		PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(iVar0, iVar3, 33, 2, iVar1);
	}
}
...
void func_61(int iParam0)
{
	...
	while (iVar198 < 3)
	{
		...
		if (!bVar199)
		{
			if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(iVar194) && !ENTITY::DOES_THREAD_OWN_THIS_ENTITY(iVar194))
			{
				bVar199 = true;
			}
		}
		...
		else
		{
			...
			if (STREAMING::IS_MODEL_A_PED(Var1))
			{
				...
				if (MISC::_IS_PED_DECOMPOSED(iVar195))
				{
					...
					if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(iVar0, -1))
					{
						bVar203 = false;
					}
					if (bVar203)
...
int func_117(struct<5> Param0, var uParam5, var uParam6, int iParam7, bool bParam8)
{
	...
	uVar0 = func_412();
	iVar1 = 0;
	iVar2 = PED::_GET_ACTIVE_ANIMAL_OWNER(*iParam7);
	if (ENTITY::DOES_ENTITY_EXIST(iVar2))
	{
...
void func_153(int iParam0)
{
	...
	if (Var0.f_4 && func_465(Var0.f_2))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar10))
		{
			if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(iVar10))
			{
	...
	if (Var0.f_4 && func_474(Var0.f_2))
	{
		...
		{
			if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(iVar31))
			{
		...
		{
			ENTITY::_SET_ENTITY_CARRYING_FLAG(iVar7, 9, 1);
		}
...
void func_275(int iParam0, int iParam1)
{
	...
	{
		if (!ENTITY::DOES_THREAD_OWN_THIS_ENTITY(iParam1))
		{
			return;
		}
	}
...
void func_316(var uParam0)
{
	...
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_638(func_637(255), 109029619));
	}
	else if (func_639())
	{
...
int func_332(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_666(bParam6), &Var0, 0);
	return uVar4;
}
...
void func_497(int iParam0)
{
	...
	if (!bVar16)
	{
		...
		if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(iVar11, -1))
		{
			return;
		}
		if (func_389(iVar11))
	...
	if (func_796(iParam0))
	{
		if (func_94() && func_797(4))
		{
			if (!func_799(func_798(iParam0)))
			{
				...
				{
					MAP::MAP_DISCOVER_REGION(func_802(func_800(iParam0)));
...
int func_667(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_666(bParam4), iParam0, 0);
	}
...
int func_735(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_666(bParam2), iParam0, 0);
	return iVar2;
}
...
struct<28> func_911(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_666(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_915(&Var28) };
...
struct<17> func_913(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_666(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_915(&Var17) };
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_666(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_955(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_666(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_1071(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_666(bParam1), iParam0, 0);
}
...
int func_1074(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_666(bParam6), &uParam0, uParam4, &Var0))
	{
		return 0;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_666(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
