		...
		if ((iParam1 || !func_131(iParam0)) || func_70(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_238(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_240(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_241(iParam0, 0));
...
int func_156(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_155(iParam0)))
	{
		return 1;
	}
	...
	func_152(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_155(iParam0));
	func_257(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_234((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_239((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_366(int iParam0, bool bParam1)
{
	...
	{
		func_257(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_153(iParam0)));
		if (func_249() == -1)
		{
			if (func_149(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_155(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_239(iParam0, 1), &sVar4);
				}
...
bool func_466(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_155(iParam0));
}
...
int func_488(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_239(iParam0, 1));
...
void func_490(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_62(iParam1), iParam0, 0);
