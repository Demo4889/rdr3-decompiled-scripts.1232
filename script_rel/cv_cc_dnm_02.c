	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_298((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_369(int iParam0, bool bParam1)
{
	...
	{
		func_264(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_144(iParam0)));
		if (func_252() == -1)
		{
