...
int func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(&(iLocal_4[0]), 1, 0))
	{
		iVar0 = 0;
	}
...
int func_24(var uParam0)
{
	...
	switch (iLocal_3)
	{
		...
		case 1:
			...
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(&(iLocal_4[1]), 1, 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_111))
			{
		...
		case 4:
			...
			if ((ANIMSCENE::_0x005E6F28DD7ED58D(&(iLocal_4[1]), "player") || ANIMSCENE::HAS_ANIM_SCENE_EXITED(&(iLocal_4[1]), 0)) || ANIMSCENE::_0xD8254CB2C586412B(&(iLocal_4[1]), 0))
			{
				if (iLocal_113 == 2)
				{
					iLocal_113 = 3;
		...
		if ((iParam1 || !func_67(iParam0)) || func_68(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_80(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_82(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_83(iParam0, 0));
...
void func_234(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_259(func_258(255), 109029619));
	}
	else if (func_193())
	{
...
int func_254(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_231(bParam6), &Var0, 0);
	return uVar4;
}
...
struct<28> func_263(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_231(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_255(&Var28) };
...
struct<17> func_265(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_231(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_255(&Var17) };
