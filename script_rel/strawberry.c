		...
		if (MISC::GET_GAME_TIMER() > iLocal_448)
		{
			...
			switch (iLocal_447)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_449));
				...
				case 6:
					if (func_7(func_6(iLocal_449)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_449 /*35*/])->f_11);
							}
							Jump @878; //curOff = 859
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_449 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_98(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(_NAMESPACE48::_0x112DDF56300BC6E5(func_251(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_251(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(_NAMESPACE48::_0x112DDF56300BC6E5(func_251(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
int func_152(int iParam0, bool bParam1)
{
	...
	{
		func_318(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_251(iParam0)));
		if (func_20() == -1)
		{
			if (func_297(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_197(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_197(iParam0)))
	{
...
bool func_196(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_197(iParam0));
}
...
void func_238(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_387(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_387(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_298(int iParam0, bool bParam1)
{
	...
	func_418(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_197(iParam0));
	func_318(iParam0, 0);
	return 1;
}
...
void func_327(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_435(iParam0)))
		{
		...
		if ((iParam1 || !func_456(iParam0)) || func_457(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_428(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_517(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_518(iParam0, 0));
...
int func_572(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_575(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_588(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_575(bParam1), iParam0, 0);
}
