		...
		if (MISC::GET_GAME_TIMER() > iLocal_22)
		{
			...
			switch (iLocal_21)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_23));
				...
				case 6:
					if (func_7(func_6(iLocal_23)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_23 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_23 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_28(int iParam0)
{
	...
	PED::SET_PED_OWNS_ANIMAL(func_52(745), func_52(748), 0);
}
