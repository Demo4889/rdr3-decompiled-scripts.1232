...
int func_56(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_104(iParam0)))
	{
		func_107(iParam0, 0);
		return 0;
	}
...
void func_66(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[1 /*14*/])))
	{
		...
		ENTITY::_SET_ENTITY_CARRYING_FLAG(&(uParam0->f_20[1 /*14*/]), 7, 0);
...
int func_107(int iParam0, bool bParam1)
{
	...
	{
		func_156(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_99(iParam0)));
		if (func_96() == -1)
		{
			if (func_48(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_104(iParam0));
...
bool func_108(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_104(iParam0));
}
...
int func_147(int iParam0, bool bParam1)
{
	...
	func_146(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_104(iParam0));
	func_156(iParam0, 0);
	return 1;
}
