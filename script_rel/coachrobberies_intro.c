...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_16)
		{
			if ((iLocal_15 && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, Local_73.f_162)) && func_19(func_18(iLocal_62), 1, 0))
			{
				iLocal_16 = 1;
			}
		}
...
void func_1()
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(Local_73.f_168);
	}
	func_25(0);
...
void func_12()
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_73.f_162, 0))
	{
		return;
	}
	if (iLocal_62 != 0)
...
void func_16()
{
	...
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(Local_73.f_155))
	{
...
int func_73(int iParam0, bool bParam1)
{
	...
	{
		func_206(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
		if (func_127() == -1)
		{
...
void func_101()
{
	...
	if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Local_73, true, false), Global_36) >= 2f && !PED::IS_PED_FACING_PED(Global_35, Local_73, 70f))
	{
		...
		PED::_ADD_SCENARIO_TRANSITION(Local_73);
		PED::_GIVE_PED_HASH_COMMAND(Local_73, 772225515, 3f);
		iLocal_21 = 1;
	}
}
...
int func_117()
{
	...
	switch (iLocal_70)
	{
		...
		case 8:
			...
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_73.f_162, 0) || ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(Local_73.f_162))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_73.f_160))
				{
...
void func_242()
{
	...
	switch (iLocal_71)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(Local_73.f_162, 1, 0) && func_426())
			{
			...
			break;
		case 3:
			if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(Local_73.f_162, sVar1))
			{
				if (iLocal_62 == 0)
				{
					if (func_199())
...
int func_525(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_253(bParam4), iParam0, 0);
	}
...
int func_668(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_253(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_851(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_253(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_253(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_253(0), 1623931083, 0);
	}
	return 0;
}
