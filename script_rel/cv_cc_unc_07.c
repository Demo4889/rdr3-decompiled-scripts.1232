...
int func_1(var uParam0)
{
	...
	else if ((MISC::GET_GAME_TIMER() > iLocal_18 && ENTITY::IS_ENTITY_OCCLUDED(func_9(uParam0, iLocal_14))) && func_10(Global_35, func_9(uParam0, iLocal_14), 1) > 225f)
	{
		...
		_NAMESPACE48::RETASK_PERSISTENT_CHARACTER(_NAMESPACE48::_GET_PERSCHAR_INDEX_FROM_PED_INDEX(func_9(uParam0, iLocal_14)));
		_NAMESPACE48::_0xD4B614179BCD0654(_NAMESPACE48::_GET_PERSCHAR_INDEX_FROM_PED_INDEX(func_9(uParam0, iLocal_14)));
		return 1;
	}
	return 0;
}
		...
		if ((iParam1 || !func_107(iParam0)) || func_53(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_10(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_210(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_211(iParam0, 0));
...
int func_137(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_136(iParam0)))
	{
		return 1;
	}
	...
	func_133(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_136(iParam0));
	func_232(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_271((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_209((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_331(int iParam0, bool bParam1)
{
	...
	{
		func_232(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_134(iParam0)));
		if (func_220() == -1)
		{
			if (func_130(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_136(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_209(iParam0, 1), &sVar4);
				}
...
bool func_402(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_136(iParam0));
}
...
int func_417(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_209(iParam0, 1));
...
void func_419(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_226(iParam1), iParam0, 0);
