...
int func_21(var uParam0)
{
	if (!bLocal_14)
	{
		...
		PED::_SET_PED_DRUNKNESS(Global_35, 1, 0.75f);
...
int func_23(var uParam0)
{
	...
	if (!bLocal_14)
	{
		...
		{
			AUDIO::SET_PED_IS_DRUNK(Global_35, true);
			PED::_SET_PED_DRUNKNESS(Global_35, 1, fLocal_13);
	...
	else
	{
		...
		switch (iLocal_9)
		{
			case 0:
				CAM::_0x8370D34BD2E60B73();
				CAM::_DISABLE_FIRST_PERSON_CAM_THIS_FRAME();
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_15, 0) && func_52(iLocal_15, "pl_getup"))
				{
					iLocal_9++;
				}
				break;
		...
		if ((iParam1 || !func_65(iParam0)) || func_66(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_79(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_81(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_82(iParam0, 0));
