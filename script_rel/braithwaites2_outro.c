...
void func_11(var uParam0)
{
	...
	{
		PED::_UNRESERVE_AMBIENT_PEDS((PED::_0x5C16855277819BBF() + iLocal_845));
	}
...
void func_19(var uParam0)
{
	...
	*(vLocal_840[0 /*3*/]) = { 668.77f, -1233.93f, 44.16f };
	...
	if (PED::_0x5C16855277819BBF() <= iLocal_845)
	{
		PED::_RESERVE_AMBIENT_PEDS((PED::_0x5C16855277819BBF() + iLocal_845));
	}
	func_52(&uLocal_846);
	func_34(0);
	func_54();
		...
		if ((iParam1 || !func_82(iParam0)) || func_83(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_59(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_142(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_143(iParam0, 0));
...
int func_330(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_333(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_341(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_333(bParam1), iParam0, 0);
}
