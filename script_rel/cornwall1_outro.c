...
int func_44()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(&(Local_5[iVar0 /*6*/])) && !func_62((Local_5[iVar0 /*6*/])->f_5, 1))
		{
			...
			ENTITY::_SET_ENTITY_CARRYING_FLAG(&(Local_5[iVar0 /*6*/]), 0, 0);
			PED::SET_PED_LASSO_HOGTIE_FLAG(&(Local_5[iVar0 /*6*/]), 0, 0);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(&(Local_5[iVar0 /*6*/]), 1, 0);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(&(Local_5[iVar0 /*6*/]), 2, 0);
...
bool func_45()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(Local_5[iVar0 /*6*/])))
		{
			...
			{
				(Local_5[iVar0 /*6*/])->f_1 = MAP::BLIP_ADD_FOR_ENTITY(831283580, &(Local_5[iVar0 /*6*/]));
		...
		if ((iParam1 || !func_58(iParam0)) || func_59(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_76(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_78(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_79(iParam0, 0));
...
int func_201(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_204(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_227(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_204(bParam1), iParam0, 0);
}
