...
int func_1(var uParam0)
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_94);
	}
...
void func_9()
{
	if (CAM::_IS_CAMERA_AVAILABLE(&Local_62) && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 72439833))
	{
		...
		if ((iParam1 || !func_113(iParam0)) || func_58(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_213(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_247(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_248(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_305((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_246((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_342(var uParam0, var uParam1)
{
	...
	if (uParam1->f_21)
	{
		...
		while (iVar0 <= iVar1)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_344(uParam0, uParam1->f_4), func_359(uParam0, iVar0)) && !func_361(uParam0, iVar0))
			{
				return 0;
			}
			iVar0++;
	...
	if (uParam1->f_20)
	{
		...
		while (iVar2 <= iVar3)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_344(uParam0, uParam1->f_5), func_359(uParam0, iVar2)) && !func_361(uParam0, iVar2))
			{
				return 0;
			}
			iVar2++;
	...
	if (uParam1->f_22)
	{
		...
		while (iVar4 <= iVar5)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_344(uParam0, uParam1->f_6), func_359(uParam0, iVar4)) && !func_361(uParam0, iVar4))
			{
				return 0;
			}
			iVar4++;
...
void func_355()
{
	if (!iLocal_58)
	{
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1))
		{
			if (!CAM::_IS_CAMERA_AVAILABLE(&Local_62))
			{
...
int func_391(int iParam0, bool bParam1)
{
	...
	{
		func_269(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_140(iParam0)));
		if (func_257() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_246(iParam0, 1), &sVar4);
				}
...
int func_485(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_246(iParam0, 1));
