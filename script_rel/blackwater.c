		...
		if (MISC::GET_GAME_TIMER() > iLocal_575)
		{
			...
			switch (iLocal_574)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_576));
				...
				case 6:
					if (func_7(func_6(iLocal_576)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_576 /*35*/])->f_11);
							}
							Jump @854; //curOff = 835
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_576 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_58(int iParam0)
{
	...
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_155(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_155(iParam0));
	...
	_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_155(iParam0));
	return 1;
}
...
void func_103(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(_NAMESPACE48::_0x112DDF56300BC6E5(func_153(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
	...
	switch (uParam0->f_17)
	{
		case 0:
			...
			if (VOLUME::IS_POINT_IN_VOLUME(uParam0->f_5, Global_36))
			{
				...
				if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_155(uParam0->f_3)))
				{
					return;
				}
...
void func_127(int iParam0)
{
	...
	{
		PATHFIND::REMOVE_NAVMESH_BLOCKING_VOLUME(iLocal_530);
...
int func_171(int iParam0, bool bParam1)
{
	...
	{
		func_330(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_153(iParam0)));
		if (func_20() == -1)
		{
