		...
		if ((iParam1 || !func_105(iParam0)) || func_51(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_214(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_216(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_217(iParam0, 0));
...
int func_135(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_134(iParam0)))
	{
		return 1;
	}
	...
	func_131(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_134(iParam0));
	func_238(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_274((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_215((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_347(int iParam0, bool bParam1)
{
	...
	{
		func_238(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_132(iParam0)));
		if (func_226() == -1)
		{
			if (func_128(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_134(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_215(iParam0, 1), &sVar4);
				}
...
bool func_452(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_134(iParam0));
}
...
int func_475(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_215(iParam0, 1));
...
int func_551(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_554(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_559(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_554(bParam1), iParam0, 0);
}
