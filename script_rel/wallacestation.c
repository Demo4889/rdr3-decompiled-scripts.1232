		...
		if (MISC::GET_GAME_TIMER() > iLocal_217)
		{
			...
			switch (iLocal_216)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_218));
				...
				case 6:
					if (func_7(func_6(iLocal_218)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_218 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_218 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_92(int iParam0, bool bParam1)
{
	...
	{
		func_158(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_157(iParam0)));
		if (func_20() == -1)
		{
			if (func_151(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_114(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_114(iParam0)))
	{
...
bool func_113(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_114(iParam0));
}
...
int func_152(int iParam0, bool bParam1)
{
	...
	func_206(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_114(iParam0));
	func_158(iParam0, 0);
	return 1;
}
