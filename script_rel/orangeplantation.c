		...
		if (MISC::GET_GAME_TIMER() > iLocal_85)
		{
			...
			switch (iLocal_84)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_86));
				...
				case 6:
					if (func_7(func_6(iLocal_86)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_86 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_86 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_55(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(_NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_92(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(_NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_138(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_92(iParam0)));
		if (func_20() == -1)
		{
			if (func_136(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_90(iParam0));
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_170(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_90(iParam0));
	func_138(iParam0, 0);
	return 1;
}
