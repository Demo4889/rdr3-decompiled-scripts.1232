...
int func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_16, 1, 0))
	{
		iVar0 = 0;
	}
...
int func_21(var uParam0)
{
	...
	func_53(0, 0);
	func_54(1);
	if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_16, 1, 0) && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_16, "PBL_1"))
	{
		...
		if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_16, 0) && !ANIMSCENE::_0xD8254CB2C586412B(iLocal_16, 0))
		{
			func_55();
			func_56(100f, 0, 0, 1);
			func_57(100f, 0, 0, 1);
...
int func_23(var uParam0)
{
	...
	if (!iLocal_18)
	{
		if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_16, 0) && !CAM::IS_SCREEN_FADING_IN())
		{
		...
		if ((iParam1 || !func_84(iParam0)) || func_85(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_161(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_163(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_164(iParam0, 0));
	...
	if (func_186(iParam0, 1, 0))
	{
		if (func_187(iParam0))
		{
			...
			if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if (uParam3 && !PED::IS_PED_READY_TO_RENDER(func_80(iParam0)))
				{
					return 0;
				}
...
int func_303(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_424("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_423(uParam1, 16))) && (!WEAPON::_0x6AD66548840472E5(Var4.f_4) || func_423(uParam1, 4))) && (!func_426(Var4.f_4) || func_423(uParam1, 8)))
				{
...
void func_379(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_468(iParam0)))
		{
...
void func_409(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_494(func_493(255), 109029619));
	}
	else if (func_177())
	{
