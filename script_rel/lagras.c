...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_146(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_145(iParam0)));
		if (func_20() == -1)
		{
			if (func_143(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_108(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_108(iParam0)))
	{
...
bool func_107(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_108(iParam0));
}
...
int func_144(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_108(iParam0));
	func_146(iParam0, 0);
	return 1;
}
