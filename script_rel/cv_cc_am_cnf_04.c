...
int func_345(var uParam0, var uParam1)
{
	...
	if (uParam1->f_21)
	{
		...
		while (iVar0 <= iVar1)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_347(uParam0, uParam1->f_4), func_362(uParam0, iVar0)) && !func_364(uParam0, iVar0))
			{
				return 0;
			}
			iVar0++;
	...
	if (uParam1->f_20)
	{
		...
		while (iVar2 <= iVar3)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_347(uParam0, uParam1->f_5), func_362(uParam0, iVar2)) && !func_364(uParam0, iVar2))
			{
				return 0;
			}
			iVar2++;
	...
	if (uParam1->f_22)
	{
		...
		while (iVar4 <= iVar5)
		{
			if (!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(func_347(uParam0, uParam1->f_6), func_362(uParam0, iVar4)) && !func_364(uParam0, iVar4))
			{
				return 0;
			}
			iVar4++;
