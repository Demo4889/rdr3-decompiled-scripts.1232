...
int func_96(var uParam0)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_65))
	{
		...
		{
			TASK::DELETE_SCENARIO_POINT(iLocal_65);
		}
		iVar0 = 0;
	}
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_66))
	{
		...
		{
			TASK::DELETE_SCENARIO_POINT(iLocal_66);
		}
		iVar0 = 0;
	}
	return iVar0;
...
void func_429(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_213(iParam1), iParam0, 0);
...
int func_500(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_503(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_508(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_503(bParam1), iParam0, 0);
}
