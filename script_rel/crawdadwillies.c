...
int func_106(int iParam0, bool bParam1)
{
	...
	{
		func_160(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_159(iParam0)));
		if (func_20() == -1)
		{
			if (func_142(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_161(iParam0));
	...
	if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_161(iParam0)))
	{
...
int func_143(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_161(iParam0));
	func_160(iParam0, 0);
	return 1;
}
