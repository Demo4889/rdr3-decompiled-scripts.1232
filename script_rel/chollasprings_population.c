...
void func_4()
{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar3) && func_10(-154581735))
		{
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar2) && func_10(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_11(-154581735);
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar1) && func_10(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_11(-154581735);
	...
	{
		if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar0) && func_10(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_11(-154581735);
		...
		else if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(iVar0) && !func_10(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-262371610, Global_36))
			{
				func_12(-154581735);
