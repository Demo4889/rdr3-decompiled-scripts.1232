...
int func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[4 /*14*/])))
	{
		...
		MISC::SET_PED_DECOMPOSED(&(uParam0->f_20[4 /*14*/]), 1);
	...
	while (iVar0 <= 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), &(uParam0->f_20[iVar0 /*14*/]), 26, 0, 1);
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[iVar0 /*14*/])))
		{
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), &(uParam0->f_20[iVar0 /*14*/]), 26, 0, 0);
			}
		}
		iVar0++;
	}
