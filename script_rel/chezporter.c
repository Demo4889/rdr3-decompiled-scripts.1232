...
void func_25()
{
	...
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_15, 192, 16384, 0, -1, -1, 0);
	POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_15, 192, 16384, 0, -1, -1, 0);
}
...
int func_89(int iParam0, bool bParam1)
{
	...
	{
		func_154(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_153(iParam0)));
		if (func_20() == -1)
		{
