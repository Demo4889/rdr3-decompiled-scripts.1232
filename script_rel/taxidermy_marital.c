...
int func_7(var uParam0)
{
	switch (func_12(uParam0))
	{
		...
		case 16:
			iLocal_19 = 4;
			iLocal_18 = ENTITY::PIN_CLOSEST_MAP_ENTITY(-1093147928, -1638f, -1360.66f, 85.35f, 1 | iLocal_19);
			func_19(uParam0, 17);
			break;
		case 17:
...
{
	_NAMESPACE49::PERSISTENCE_REMOVE_ALL_ENTITIES_IN_AREA(func_54(iLocal_14), 10f);
...
int func_31(var uParam0, int iParam1)
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(&(uParam0->f_2[iParam1]), 1, 0))
	{
...
{
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(&(uParam0->f_2[iParam1]), 0))
	{
...
int func_33(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(&(uParam0->f_2[iParam1]), func_89(iParam2)) && !ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uParam0->f_2[iParam1]), func_89(iParam2)))
		{
	...
	if (bParam4)
	{
		if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(&(uParam0->f_2[iParam1]), func_89(iParam2)))
		{
...
int func_51(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_115(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_115(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_115(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_161(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_115(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_184(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_115(0), -1845241476, 0);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_115(0), 1654063339, 0);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_115(0), 1623931083, 0);
	}
	return 0;
}
...
int func_222(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_115(bParam1), iParam0, 0);
}
...
int func_223(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_115(bParam6), &Var0, 0);
	return uVar4;
}
