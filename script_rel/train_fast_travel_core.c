...
{
	LAW::_0xE94B5E938619712E();
	if ((((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_105) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_105, 0)) && CAM::IS_SCREEN_FADED_OUT()) && !CAM::IS_SCREEN_FADING_IN()) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_105, 1, 0))
	{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_105))
	{
		if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_105, 0) && CAM::IS_SCREEN_FADED_OUT())
		{
			CAM::DO_SCREEN_FADE_IN(500);
			func_53(func_35());
			func_57(ENTITY::GET_ENTITY_COORDS(Global_35, true, false), 40f, 1, 0, 0, 0, 0);
		}
		if (ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(iLocal_105) || ANIMSCENE::_0xD8254CB2C586412B(iLocal_105, 0))
		{
...
int func_41(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_78(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_80(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_78(bParam4), iParam0, iParam1, uParam2))
	{
		return 0;
	}
	return 1;
...
int func_134(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_78(bParam1), iParam0, 0);
}
