	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
			{
				...
				MISC::SET_PED_DECOMPOSED(&(uParam0->f_20[2 /*14*/]), 1);
			...
			POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_75, 2016, 16384, 0, -1, -1, 0);
			POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_75, 2016, 16384, 0, -1, -1, 0);
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		...
		{
			TASK::DELETE_SCENARIO_POINT(&(uLocal_14[iVar0]));
		}
		iVar0++;
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_75))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_75);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_75);
