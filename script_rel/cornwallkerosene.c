		...
		if (MISC::GET_GAME_TIMER() > iLocal_63)
		{
			...
			switch (iLocal_62)
			{
				...
				case 1:
					...
					LAW::SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_64));
				...
				case 6:
					if (func_7(func_6(iLocal_64)))
					{
						...
						else
						{
							...
							{
								PED::SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_64 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						...
						{
							PED::SET_SCENARIO_PED_DENSITY_THIS_FRAME(((*Global_1888801)[iLocal_64 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_11()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_14);
			POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_14);
		}
	}
	return 1;
}
...
void func_58(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(_NAMESPACE48::_0x112DDF56300BC6E5(func_98(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_98(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(_NAMESPACE48::_0x112DDF56300BC6E5(func_98(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_144(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_98(iParam0)));
		if (func_20() == -1)
		{
