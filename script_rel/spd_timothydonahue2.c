		...
		else
		{
			...
			switch (iLocal_22)
			{
				...
				case 3:
					...
					{
						if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_188, 0) && ENTITY::HAS_ANIM_EVENT_FIRED(&(uLocal_173[0]), -1527527524))
						{
				...
				case 33:
					if (!ENTITY::IS_ENTITY_DEAD(&(uLocal_173[0])) && !ENTITY::IS_ENTITY_DEAD(Global_35))
					{
						...
						if (!func_19(iLocal_190, 128))
						{
							...
							{
								TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(&(uLocal_173[0]), 2.1f, 0, -1f, 0);
...
void func_1(bool bParam0, bool bParam1)
{
	...
	if (PED::IS_SCENARIO_BLOCKING_AREA_VALID(iLocal_185))
	{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_181))
	{
		...
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_181);
...
int func_5(int iParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		if ((!ANIMSCENE::IS_ANIM_SCENE_RUNNING(*iParam0, 0) && !ENTITY::_0x083D497D57B7400F(&(uLocal_173[0]))) && !bParam5)
		{
			ANIMSCENE::START_ANIM_SCENE(*iParam0);
		}
		if (bParam5 && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(*iParam0, 0))
		{
			if ((!ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(*iParam0, sParam1) && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(*iParam0, sParam1)) && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(*iParam0, sParam1))
			{
				ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(*iParam0, sParam1);
			}
			if ((!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(*iParam0, sParam1) && ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(*iParam0, sParam1)) && !ENTITY::_0x083D497D57B7400F(&(uLocal_173[0])))
			{
...
void func_30()
{
	...
	{
		iLocal_184 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
...
void func_334(var uParam0, bool bParam1, int* iParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, var uParam10, int iParam11, int iParam12, int iParam13, bool bParam14)
{
	int iVar0;
	...
	if (bParam1)
	{
		if (!MISC::IS_BIT_SET(*iParam2, 1))
		{
			...
			func_392(*uParam0, uParam4, fParam3, iParam7, iParam8, iParam12, func_209(uParam10, 32), 1, 0);
...
bool func_336(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, var uParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	int iVar1;
	bool bVar2;
