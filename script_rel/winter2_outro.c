...
int func_6(var uParam0)
{
	...
	if (((STREAMING::IS_LOAD_SCENE_ACTIVE() && STREAMING::_0x0909F71B5C070797()) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_4, 1, 0)) || func_23(&uLocal_8) > 15f)
	{
		func_22(&uLocal_5, 0);
		return 1;
	}
...
int func_24(var uParam0)
{
	...
	{
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_4) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_4, 1, 0))
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(Global_35, 1, 1);
			WEAPON::_HIDE_PED_WEAPONS(Global_35, 2, 1);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(Global_35, 1, 1);
...
bool func_26(var uParam0)
{
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_4))
	{
		if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_4, 0))
		{
			if (!PED::IS_PED_INJURED(Global_35))
			{
		...
		{
			if (ANIMSCENE::HAS_ANIM_SCENE_EXITED(iLocal_4, 0) || ANIMSCENE::_0xD8254CB2C586412B(iLocal_4, 0))
			{
				func_62(1);
		...
		if ((iParam1 || !func_83(iParam0)) || func_84(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_151(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_153(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_154(iParam0, 0));
	...
	if (func_184(iParam0, 1, 0))
	{
		if (func_185(iParam0))
		{
			...
			if (_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if (uParam3 && !PED::IS_PED_READY_TO_RENDER(func_79(iParam0)))
				{
					return 0;
				}
...
int func_132(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_133(bParam6), &Var0, 0);
	return uVar4;
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_193(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_258(0))
				{
					...
					func_259(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
int func_233(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_262("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_261(uParam1, 16))) && (!WEAPON::_0x6AD66548840472E5(Var4.f_4) || func_261(uParam1, 4))) && (!func_264(Var4.f_4) || func_261(uParam1, 8)))
				{
...
int func_238(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_133(bParam1), iParam0, 0);
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_133(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
