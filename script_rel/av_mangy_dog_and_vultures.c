...
int func_31(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])) && ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		{
			MISC::SET_PED_DECOMPOSED(&(uParam0->f_20[0 /*14*/]), 1);
		}
	}
	if (!&uParam0->f_469[1])
	{
...
int func_32(var uParam0, var uParam1)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_12))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_12);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_12);
		func_5(iLocal_12);
	}
	return 1;
}
