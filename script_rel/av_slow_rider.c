		...
		case 0:
			...
			if (*uParam0 == 52)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
				{
					...
					PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), &(uParam0->f_20[2 /*14*/]), 5, 0, 1);
					PLAYER::MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), &(uParam0->f_20[2 /*14*/]), 27, 0, 1);
					...
					PED::SET_PED_LASSO_HOGTIE_FLAG(&(uParam0->f_20[2 /*14*/]), 0, 0);
					if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
					{
