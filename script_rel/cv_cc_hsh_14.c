...
int func_1(var uParam0)
{
	...
	{
		TASK::DELETE_SCENARIO_POINT(iLocal_124);
	}
	if (!iLocal_121)
	{
		func_8(uParam0);
...
int func_81(var uParam0)
{
	...
	iLocal_107 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, -96.7767f, -15.1897f, 95.8847f, 0f, 0f, 0f, 3.5f, 3.5f, 2.5f);
		...
		if ((iParam1 || !func_120(iParam0)) || func_60(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_211(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_249(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_250(iParam0, 0));
...
int func_150(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_149(iParam0)))
	{
		return 1;
	}
	...
	func_146(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_149(iParam0));
	func_271(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_306((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_248((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_383(int iParam0, bool bParam1)
{
	...
	{
		func_271(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_147(iParam0)));
		if (func_259() == -1)
		{
			if (func_143(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_149(iParam0));
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_248(iParam0, 1), &sVar4);
				}
...
bool func_493(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_149(iParam0));
}
...
int func_508(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_248(iParam0, 1));
...
void func_510(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_265(iParam1), iParam0, 0);
...
int func_582(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_585(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_590(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_585(bParam1), iParam0, 0);
}
