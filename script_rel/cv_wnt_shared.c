		...
		if ((iParam1 || !func_117(iParam0)) || func_57(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_243(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_245(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_246(iParam0, 0));
...
int func_147(int iParam0, bool bParam1)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_146(iParam0)))
	{
		return 1;
	}
	...
	func_143(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_146(iParam0));
	func_266(iParam0, 0);
	return 1;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_323((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_244((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_434(int iParam0, bool bParam1)
{
	...
	{
		func_266(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_144(iParam0)));
		if (func_255() == -1)
		{
			if (func_140(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_146(iParam0));
...
int func_485(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_573(bParam2), iParam0, 0);
	return iVar2;
}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_244(iParam0, 1), &sVar4);
				}
...
bool func_623(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::IS_PERSISTENT_CHARACTER_DEAD(func_146(iParam0));
}
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_573(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_660(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_244(iParam0, 1));
...
void func_662(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_180(iParam1), iParam0, 0);
...
int func_736(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_573(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_741(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_573(bParam1), iParam0, 0);
}
