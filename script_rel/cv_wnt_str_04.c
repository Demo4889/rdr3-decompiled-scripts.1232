		...
		if ((iParam1 || !func_116(iParam0)) || func_56(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_215(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_234(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_235(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_233((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_368(int iParam0, bool bParam1)
{
	...
	{
		func_256(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_143(iParam0)));
		if (func_244() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_SET_PERSCHAR_SCHEDULE(func_233(iParam0, 1), &sVar4);
				}
...
int func_501(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_GET_PERSCHAR_MODEL_NAME(func_233(iParam0, 1));
...
void func_503(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_250(iParam1), iParam0, 0);
...
int func_577(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_580(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_585(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_580(bParam1), iParam0, 0);
}
