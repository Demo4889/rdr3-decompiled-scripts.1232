...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!func_10(iLocal_139, 8192))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_183))
			{
				if (!PED::_IS_PED_VISIBILITY_TRACKED(iLocal_183))
				{
			...
			case 6:
				...
				if (iLocal_200 == 5)
				{
					if (!func_10(iLocal_139, 2097152))
					{
						...
						if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_138, "pbl_IG2_Hanging_Rope"))
						{
					...
					{
						if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_138, 0) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_138) > 0.9f)
						{
...
void func_1()
{
	...
	{
		func_28(iLocal_186);
		PATHFIND::RESET_ROADS_IN_VOLUME(iLocal_186, 0);
		VOLUME::DELETE_VOLUME(iLocal_186);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_188))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_188);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_188);
		VOLUME::DELETE_VOLUME(iLocal_188);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_187))
	{
		POPULATION::REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_187);
		POPULATION::REMOVE_AMBIENT_SPAWN_RESTRICTION(iLocal_187);
...
int func_17()
{
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_138, 1, 0))
	{
		return 0;
	}
...
void func_20()
{
	...
	switch (iLocal_116)
	{
		case 0:
			...
			break;
		case 1:
			if (ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_138, sVar0))
			{
...
int func_37(int iParam0, int iParam1, var uParam2, int iParam3)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 30) == 0)
	{
		...
		if (uParam2->f_8)
		{
			...
			{
				if (func_110(&iParam3, &(uParam2->f_18), uParam2->f_11, uParam2->f_12) || func_111(&iParam3, &(uParam2->f_20), &(uParam2->f_19), uParam2->f_11, uParam2->f_12, 2048))
				{
...
int func_78(var uParam0, int iParam1, vector3 vParam2)
{
