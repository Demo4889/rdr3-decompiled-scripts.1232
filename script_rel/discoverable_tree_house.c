...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_91(uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_91(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		if (func_92(*uParam0, uParam0->f_4) != 0)
		{
			...
			{
				MAP::MAP_DISCOVER_REGION(func_92(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_93(uParam0);
...
int func_67(var uParam0)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 6:
			...
			PED::SET_PED_LASSO_HOGTIE_FLAG(&(uParam0->f_103[0]), 1, 0);
...
void func_93(var uParam0)
{
	...
	if (func_153(*uParam0) != 0)
	{
		...
		{
			MAP::MAP_DISCOVER_REGION(func_153(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
