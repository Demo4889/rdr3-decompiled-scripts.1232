...
int func_53(int iParam0)
{
	...
	if (!_NAMESPACE48::IS_PERSISTENT_CHARACTER_VALID(func_105(iParam0)))
	{
		return 0;
	}
	if (NETWORK::NETWORK_IS_IN_SESSION())
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(_NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_105(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _NAMESPACE48::GET_PERSCHAR_PED_INDEX(func_105(iParam0));
	...
	_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_105(iParam0));
	return 1;
}
...
int func_96(int iParam0, bool bParam1)
{
	...
	{
		func_172(iParam0, _NAMESPACE48::CREATE_PERSISTENT_CHARACTER(func_103(iParam0)));
		if (func_20() == -1)
		{
			if (func_170(iParam0, 2048))
			{
				_NAMESPACE48::REVIVE_PERSCHAR(func_105(iParam0));
...
int func_171(int iParam0, bool bParam1)
{
	...
	func_215(iParam0);
	_NAMESPACE48::DELETE_PERSCHAR(func_105(iParam0));
	func_172(iParam0, 0);
	return 1;
}
