...
int func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_9, 1, 0))
	{
		iVar0 = 0;
	}
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_10, 1, 0))
	{
		iVar0 = 0;
	}
...
void func_19(var uParam0)
{
	...
	iLocal_58[0] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, -1555.683f, -1417.174f, 90.1822f, 0f, 0f, -19.67098f, 2.626542f, 18.71136f, 3.681293f);
	iLocal_58[1] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, -1558.386f, -1430.378f, 93.68977f, 0f, 0f, -29.25712f, 1.25935f, 3.725714f, 1.587422f);
	iLocal_58[2] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, -1560.36f, -1436.362f, 93.68977f, 0f, 0f, -2.146133f, 1f, 3.464732f, 1.587422f);
	iLocal_58[3] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(665633627, -1572.138f, -1442.667f, 90.88407f, 0f, 0f, 126.3318f, 3.18645f, 15.24051f, 4.382712f);
...
int func_25(var uParam0)
{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			else if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_10, 0) && CAM::GET_LETTER_BOX_RATIO() == 0f)
			{
				func_72(&sLocal_42);
				iLocal_63 = 1;
			}
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_10, 0) && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0, 0);
			}
			if ((!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_9, 0) && !ANIMSCENE::_0xD8254CB2C586412B(iLocal_9, 0)) && func_73(&uLocal_64) >= 2f)
			{
		...
		if ((iParam1 || !func_85(iParam0)) || func_86(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_124(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_126(iParam0);
					_NAMESPACE48::FORCE_DESPAWN_PERSCHAR(func_127(iParam0, 0));
...
int func_184(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_187(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_193(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_187(bParam1), iParam0, 0);
}
