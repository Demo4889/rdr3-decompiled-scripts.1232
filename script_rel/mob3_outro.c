...
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_19) && ENTITY::DOES_THREAD_OWN_THIS_ENTITY(iLocal_19))
	{
	...
	{
		PED::_UNRESERVE_AMBIENT_PEDS((PED::_0x5C16855277819BBF() + iLocal_24));
	}
}
...
void func_19(var uParam0)
{
	...
	*(vLocal_12[1 /*3*/]) = { 2002.926f, -980.459f, 43.5959f };
	...
	if (PED::_0x5C16855277819BBF() <= iLocal_24)
	{
		PED::_RESERVE_AMBIENT_PEDS((PED::_0x5C16855277819BBF() + iLocal_24));
	}
	func_48(&uLocal_21);
}
...
int func_186(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_189(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_195(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_189(bParam1), iParam0, 0);
}
